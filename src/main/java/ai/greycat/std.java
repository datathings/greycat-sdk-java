...
public final class std extends ai.greycat.GreyCat.Library {
	...
	public static final class core {
		public static final class tf2d extends ai.greycat.std_n.core.tf2d {
			...
			public static tf2d create(ai.greycat.GreyCat greycat){
				return new tf2d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[0]);
			}
		}
		...
		public static final class ti6d extends ai.greycat.std_n.core.ti6d {
			...
			public static ti6d create(ai.greycat.GreyCat greycat){
				return new ti6d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[3]);
			}
		}
		public static final class nodeTimeSingleton extends GreyCat.Object {
			...
			public static nodeTimeSingleton create(ai.greycat.GreyCat greycat, ai.greycat.std.core.time t, java.lang.Object v){
				return new nodeTimeSingleton(greycat.libs_by_name.get(ai.greycat.std.name).mapped[4], t, v);
			}
		}
		public static final class time extends ai.greycat.std_n.core.time {
			...
			public static time create(ai.greycat.GreyCat greycat){
				return new time(greycat.libs_by_name.get(ai.greycat.std.name).mapped[5]);
			}
		}
		public static final class nodeTime<T> extends ai.greycat.std_n.core.nodeTime<T> {
			...
			public static <T>nodeTime<T> create(ai.greycat.GreyCat greycat){
				return new nodeTime<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[6]);
			}
		}
		public static final class DurationUnit extends GreyCat.Enum {
			...
			public static DurationUnit create(ai.greycat.GreyCat greycat){
				return new DurationUnit(greycat.libs_by_name.get(ai.greycat.std.name).mapped[7]);
			}
		}
		public static final class NodeTimeInfo extends GreyCat.Object {
			...
			public static NodeTimeInfo create(ai.greycat.GreyCat greycat, java.lang.Long size, ai.greycat.std.core.time from, ai.greycat.std.core.time to){
				return new NodeTimeInfo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[8], size, from, to);
			}
		}
		public static final class function extends ai.greycat.std_n.core.function {
			...
			public static function create(ai.greycat.GreyCat greycat){
				return new function(greycat.libs_by_name.get(ai.greycat.std.name).mapped[9]);
			}
		}
		...
		public static final class GeoPoly extends GreyCat.Object {
			...
			public static GeoPoly create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array<ai.greycat.std.core.geo> points){
				return new GeoPoly(greycat.libs_by_name.get(ai.greycat.std.name).mapped[11], points);
			}
		}
		...
		public static final class ti2d extends ai.greycat.std_n.core.ti2d {
			...
			public static ti2d create(ai.greycat.GreyCat greycat){
				return new ti2d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[13]);
			}
		}
		...
		public static final class geo extends ai.greycat.std_n.core.geo {
			...
			public static geo create(ai.greycat.GreyCat greycat){
				return new geo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[15]);
			}
		}
		public static final class node<T> extends ai.greycat.std_n.core.node<T> {
			...
			public static <T>node<T> create(ai.greycat.GreyCat greycat){
				return new node<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[16]);
			}
		}
		public static final class TableColumnMeta extends GreyCat.Object {
			...
			public static TableColumnMeta create(ai.greycat.GreyCat greycat, java.lang.String type, java.lang.Long size, java.lang.Boolean index, java.lang.Object min, java.lang.Object max, java.lang.Object avg, java.lang.Object std){
				return new TableColumnMeta(greycat.libs_by_name.get(ai.greycat.std.name).mapped[17], type, size, index, min, max, avg, std);
			}
		}
		public static final class Date extends ai.greycat.std_n.core.Date {
			...
			public static Date create(ai.greycat.GreyCat greycat){
				return new Date(greycat.libs_by_name.get(ai.greycat.std.name).mapped[18]);
			}
		}
		...
		public static final class ti4d extends ai.greycat.std_n.core.ti4d {
			...
			public static ti4d create(ai.greycat.GreyCat greycat){
				return new ti4d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[20]);
			}
		}
		public static final class GeoCircle extends GreyCat.Object {
			...
			public static GeoCircle create(ai.greycat.GreyCat greycat, ai.greycat.std.core.geo center, java.lang.Double radius){
				return new GeoCircle(greycat.libs_by_name.get(ai.greycat.std.name).mapped[21], center, radius);
			}
		}
		public static final class nodeGeo<T> extends ai.greycat.std_n.core.nodeGeo<T> {
			...
			public static <T>nodeGeo<T> create(ai.greycat.GreyCat greycat){
				return new nodeGeo<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[22]);
			}
		}
		public static final class ti5d extends ai.greycat.std_n.core.ti5d {
			...
			public static ti5d create(ai.greycat.GreyCat greycat){
				return new ti5d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[23]);
			}
		}
		public static final class String extends ai.greycat.std_n.core.String {
			...
			public static String create(ai.greycat.GreyCat greycat){
				return new String(greycat.libs_by_name.get(ai.greycat.std.name).mapped[24]);
			}
		}
		public static final class Map<K,V> extends ai.greycat.std_n.core.Map<K,V> {
			...
			public static <K,V>Map<K,V> create(ai.greycat.GreyCat greycat){
				return new Map<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[25]);
			}
		}
		public static final class TensorType extends GreyCat.Enum {
			...
			public static TensorType create(ai.greycat.GreyCat greycat){
				return new TensorType(greycat.libs_by_name.get(ai.greycat.std.name).mapped[26]);
			}
		}
		public static final class TimeZone extends GreyCat.Enum {
			...
			public static TimeZone create(ai.greycat.GreyCat greycat){
				return new TimeZone(greycat.libs_by_name.get(ai.greycat.std.name).mapped[27]);
			}
		}
		...
		public static final class Tuple<T,U> extends GreyCat.Object {
			...
			public static <T,U>Tuple<T,U> create(ai.greycat.GreyCat greycat, T x, U y){
				return new Tuple<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[29], x, y);
			}
		}
		public static final class DatePart extends GreyCat.Enum {
			...
			public static ai.greycat.std.core.DatePart years(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[30];
			...
			public static DatePart create(ai.greycat.GreyCat greycat){
				return new DatePart(greycat.libs_by_name.get(ai.greycat.std.name).mapped[30]);
			}
		}
		...
		public static final class nodeList<T> extends ai.greycat.std_n.core.nodeList<T> {
			...
			public static <T>nodeList<T> create(ai.greycat.GreyCat greycat){
				return new nodeList<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[32]);
			}
		}
		public static final class tf3d extends ai.greycat.std_n.core.tf3d {
			...
			public static tf3d create(ai.greycat.GreyCat greycat){
				return new tf3d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[33]);
			}
		}
		public static final class nodeIndexBucket extends ai.greycat.std_n.core.nodeIndexBucket {
			...
			public static nodeIndexBucket create(ai.greycat.GreyCat greycat){
				return new nodeIndexBucket(greycat.libs_by_name.get(ai.greycat.std.name).mapped[34]);
			}
		}
		public static final class ti10d extends ai.greycat.std_n.core.ti10d {
			...
			public static ti10d create(ai.greycat.GreyCat greycat){
				return new ti10d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[35]);
			}
		}
		public static final class Array<T> extends ai.greycat.std_n.core.Array<T> {
			...
			public static <T>Array<T> create(ai.greycat.GreyCat greycat){
				return new Array<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[36]);
			}
		}
		public static final class tf4d extends ai.greycat.std_n.core.tf4d {
			...
			public static tf4d create(ai.greycat.GreyCat greycat){
				return new tf4d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[37]);
			}
		}
	...
	public static final class runtime {
		public static final class UserGroup extends GreyCat.Object {
			...
			public static UserGroup create(ai.greycat.GreyCat greycat, java.lang.Long id, java.lang.String name, java.lang.Boolean activated){
				return new UserGroup(greycat.libs_by_name.get(ai.greycat.std.name).mapped[39], id, name, activated);
			}
		}
		...
		public static final class PeriodicTask extends GreyCat.Object {
			...
			public static PeriodicTask create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Long user_id, java.lang.String args, ai.greycat.std.core.time start, ai.greycat.std.core.duration every){
				return new PeriodicTask(greycat.libs_by_name.get(ai.greycat.std.name).mapped[41], name, user_id, args, start, every);
			}
		}
		public static final class License extends GreyCat.Object {
			...
			public static License create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.time start, ai.greycat.std.core.time end, java.lang.String company, java.lang.Long max_workers, java.lang.Long max_memory, java.lang.Long extra_1, java.lang.Long extra_2, java.lang.Long extra_3, java.lang.Long extra_4){
				return new License(greycat.libs_by_name.get(ai.greycat.std.name).mapped[42], name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4);
			}
		}
		public static final class StoreStat extends GreyCat.Object {
			...
			public static StoreStat create(ai.greycat.GreyCat greycat, java.lang.Long capacity_bytes, java.lang.Long allocated_bytes, java.lang.Double allocated_ratio, java.lang.Long remained_bytes, java.lang.Double remained_ratio, java.lang.Long used_bytes, java.lang.Double used_ratio, java.lang.Long available_bytes, java.lang.Double available_ratio){
				return new StoreStat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[43], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio);
			}
		}
		...
		public static final class Task extends GreyCat.Object {
			...
			public static Task create(ai.greycat.GreyCat greycat, java.lang.Long user_id, java.lang.Long task_id, java.lang.String mod, java.lang.String type, java.lang.String fun, ai.greycat.std.core.time creation, ai.greycat.std.runtime.TaskStatus status){
				return new Task(greycat.libs_by_name.get(ai.greycat.std.name).mapped[45], user_id, task_id, mod, type, fun, creation, status);
			}
		}
		...
		public static final class UserGroupPolicy extends GreyCat.Object {
			...
			public static UserGroupPolicy create(ai.greycat.GreyCat greycat, java.lang.Long group_id, ai.greycat.std.runtime.UserGroupPolicyType type){
				return new UserGroupPolicy(greycat.libs_by_name.get(ai.greycat.std.name).mapped[47], group_id, type);
			}
		}
		public static final class RuntimeInfo extends GreyCat.Object {
			...
			public static RuntimeInfo create(ai.greycat.GreyCat greycat, java.lang.String version, java.lang.String arch, ai.greycat.std.core.TimeZone timezone, ai.greycat.std.runtime.License license, java.lang.Long io_threads, java.lang.Long bg_threads, java.lang.Long fg_threads, java.lang.Long mem_total, java.lang.Long mem_worker, java.lang.Long nb_ctx, ai.greycat.std.runtime.StoreStat store_stats){
				return new RuntimeInfo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[48], version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
			}
		}
		...
		public static final class System extends GreyCat.Object {
			...
			public static System create(ai.greycat.GreyCat greycat){
				return new System(greycat.libs_by_name.get(ai.greycat.std.name).mapped[50]);
			}
		}
		public static final class UserCredential extends GreyCat.Object {
			...
			public static UserCredential create(ai.greycat.GreyCat greycat, java.lang.Long offset, java.lang.String pass){
				return new UserCredential(greycat.libs_by_name.get(ai.greycat.std.name).mapped[51], offset, pass);
			}
		}
		public static final class TaskStatus extends GreyCat.Enum {
			...
			public static TaskStatus create(ai.greycat.GreyCat greycat){
				return new TaskStatus(greycat.libs_by_name.get(ai.greycat.std.name).mapped[52]);
			}
		}
		public static final class UserRole extends GreyCat.Object {
			...
			public static UserRole create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.Array<java.lang.String> permissions){
				return new UserRole(greycat.libs_by_name.get(ai.greycat.std.name).mapped[53], name, permissions);
			}
		}
		public static final class SecurityPolicy extends GreyCat.Object {
			...
			public static SecurityPolicy create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array<ai.greycat.std.runtime.SecurityEntity> entities, ai.greycat.std.core.Map<java.lang.String, ai.greycat.std.runtime.UserCredential> credentials, ai.greycat.std.core.Map<java.lang.String, ai.greycat.std.runtime.UserRole> roles, ai.greycat.std.runtime.SecurityFields fields){
				return new SecurityPolicy(greycat.libs_by_name.get(ai.greycat.std.name).mapped[54], entities, credentials, roles, fields);
			}
		}
		...
		public static final class UserGroupPolicyType extends GreyCat.Enum {
			...
			public static UserGroupPolicyType create(ai.greycat.GreyCat greycat){
				return new UserGroupPolicyType(greycat.libs_by_name.get(ai.greycat.std.name).mapped[57]);
			}
		}
	}
	public static final class io {
		public static final class Email extends GreyCat.Object {
			...
			public static Email create(ai.greycat.GreyCat greycat, java.lang.String from, java.lang.String subject, java.lang.String body, java.lang.Boolean body_is_html, ai.greycat.std.core.Array<java.lang.String> to, ai.greycat.std.core.Array<java.lang.String> cc, ai.greycat.std.core.Array<java.lang.String> bcc){
				return new Email(greycat.libs_by_name.get(ai.greycat.std.name).mapped[58], from, subject, body, body_is_html, to, cc, bcc);
			}
		}
		public static final class Smtp extends GreyCat.Object {
			...
			public static Smtp create(ai.greycat.GreyCat greycat, java.lang.String host, java.lang.Long port, ai.greycat.std.io.SmtpMode mode, ai.greycat.std.io.SmtpAuth authenticate, java.lang.String user, java.lang.String pass){
				return new Smtp(greycat.libs_by_name.get(ai.greycat.std.name).mapped[59], host, port, mode, authenticate, user, pass);
			}
		}
		public static final class CsvFormat extends GreyCat.Object {
			...
			public static CsvFormat create(ai.greycat.GreyCat greycat, java.lang.Long header_lines, java.lang.Boolean infer, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, ai.greycat.std.core.Array<ai.greycat.std.io.CsvColumn> columns){
				return new CsvFormat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[60], header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns);
			}
		}
		public static final class CsvColumnDuration extends GreyCat.Object {
			...
			public static CsvColumnDuration create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, ai.greycat.std.core.DurationUnit unit){
				return new CsvColumnDuration(greycat.libs_by_name.get(ai.greycat.std.name).mapped[61], name, mandatory, unit);
			}
		}
		...
		public static final class HttpHeader extends GreyCat.Object {
			...
			public static HttpHeader create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.String value){
				return new HttpHeader(greycat.libs_by_name.get(ai.greycat.std.name).mapped[63], name, value);
			}
		}
		public static final class SmtpMode extends GreyCat.Enum {
			...
			public static ai.greycat.std.io.SmtpMode plain(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[64];
			...
			public static SmtpMode create(ai.greycat.GreyCat greycat){
				return new SmtpMode(greycat.libs_by_name.get(ai.greycat.std.name).mapped[64]);
			}
		}
		public static final class Url extends GreyCat.Object {
			...
			public static Url create(ai.greycat.GreyCat greycat, java.lang.String protocol, java.lang.String host, java.lang.Long port, java.lang.String path, ai.greycat.std.core.Map<java.lang.String, java.lang.String> params, java.lang.String hash){
				return new Url(greycat.libs_by_name.get(ai.greycat.std.name).mapped[65], protocol, host, port, path, params, hash);
			}
		}
		public static final class CsvColumnFloat extends GreyCat.Object {
			...
			public static CsvColumnFloat create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory){
				return new CsvColumnFloat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[66], name, mandatory);
			}
		}
		public static final class CsvColumn extends GreyCat.Object {
			...
			public static CsvColumn create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory){
				return new CsvColumn(greycat.libs_by_name.get(ai.greycat.std.name).mapped[67], name, mandatory);
			}
		}
		public static final class File extends GreyCat.Object {
			...
			public static File create(ai.greycat.GreyCat greycat, java.lang.String path, java.lang.Long size, ai.greycat.std.core.time last_modification){
				return new File(greycat.libs_by_name.get(ai.greycat.std.name).mapped[68], path, size, last_modification);
			}
		}
		public static final class Http extends GreyCat.Object {
			...
			public static Http create(ai.greycat.GreyCat greycat){
				return new Http(greycat.libs_by_name.get(ai.greycat.std.name).mapped[69]);
			}
		}
		public static final class CsvColumnTime extends GreyCat.Object {
			...
			public static CsvColumnTime create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, ai.greycat.std.core.DurationUnit unit){
				return new CsvColumnTime(greycat.libs_by_name.get(ai.greycat.std.name).mapped[70], name, mandatory, unit);
			}
		}
		...
		public static final class CsvColumnDate extends GreyCat.Object {
			...
			public static CsvColumnDate create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.String format, ai.greycat.std.core.TimeZone tz, java.lang.Boolean as_time){
				return new CsvColumnDate(greycat.libs_by_name.get(ai.greycat.std.name).mapped[72], name, mandatory, format, tz, as_time);
			}
		}
		public static final class CsvColumnString extends GreyCat.Object {
			...
			public static CsvColumnString create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Boolean trim, java.lang.Boolean try_number, java.lang.Boolean try_json, ai.greycat.std.core.Array<java.lang.String> values, ai.greycat.std.io.TextEncoder encoder){
				return new CsvColumnString(greycat.libs_by_name.get(ai.greycat.std.name).mapped[73], name, mandatory, trim, try_number, try_json, values, encoder);
			}
		}
		public static final class CsvColumnBoolean extends GreyCat.Object {
			...
			public static CsvColumnBoolean create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory){
				return new CsvColumnBoolean(greycat.libs_by_name.get(ai.greycat.std.name).mapped[74], name, mandatory);
			}
		}
		public static final class CsvColumnIgnored extends GreyCat.Object {
			...
			public static CsvColumnIgnored create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory){
				return new CsvColumnIgnored(greycat.libs_by_name.get(ai.greycat.std.name).mapped[75], name, mandatory);
			}
		}
		public static final class TextEncoder extends GreyCat.Enum {
			...
			public static ai.greycat.std.io.TextEncoder plain(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[76];
			...
			public static TextEncoder create(ai.greycat.GreyCat greycat){
				return new TextEncoder(greycat.libs_by_name.get(ai.greycat.std.name).mapped[76]);
			}
		}
	}
	public static final class math {
		public static final class MathConstants extends GreyCat.Object {
			...
			public static MathConstants create(ai.greycat.GreyCat greycat){
				return new MathConstants(greycat.libs_by_name.get(ai.greycat.std.name).mapped[77]);
			}
		}
	}
	public static final class util {
		public static final class SlidingWindow extends ai.greycat.std_n.util.SlidingWindow {
			...
			public static SlidingWindow create(ai.greycat.GreyCat greycat){
				return new SlidingWindow(greycat.libs_by_name.get(ai.greycat.std.name).mapped[78]);
			}
		}
		public static final class Assert extends GreyCat.Object {
			...
			public static Assert create(ai.greycat.GreyCat greycat){
				return new Assert(greycat.libs_by_name.get(ai.greycat.std.name).mapped[79]);
			}
		}
		public static final class Iban extends ai.greycat.std_n.util.Iban {
			...
			public static Iban create(ai.greycat.GreyCat greycat){
				return new Iban(greycat.libs_by_name.get(ai.greycat.std.name).mapped[80]);
			}
		}
		public static final class BoxPlotFloat extends GreyCat.Object {
			...
			public static BoxPlotFloat create(ai.greycat.GreyCat greycat, java.lang.Double min, java.lang.Double max, java.lang.Double whiskerLow, java.lang.Double whiskerHigh, java.lang.Double percentile1, java.lang.Double percentile5, java.lang.Double percentile25, java.lang.Double percentile50, java.lang.Double percentile75, java.lang.Double percentile95, java.lang.Double percentile99, java.lang.Long countOutliersLow, java.lang.Long countOutliersHigh, java.lang.Double percentageOutliersLow, java.lang.Double percentageOutliersHigh, java.lang.Double sum, java.lang.Double avg, java.lang.Double std, java.lang.Long size){
				return new BoxPlotFloat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[81], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
			}
		}
		public static final class Random extends GreyCat.Object {
			...
			public static Random create(ai.greycat.GreyCat greycat, java.lang.Long seed, java.lang.Double v){
				return new Random(greycat.libs_by_name.get(ai.greycat.std.name).mapped[82], seed, v);
			}
		}
		...
		public static final class TimeWindow extends ai.greycat.std_n.util.TimeWindow {
			...
			public static TimeWindow create(ai.greycat.GreyCat greycat){
				return new TimeWindow(greycat.libs_by_name.get(ai.greycat.std.name).mapped[84]);
			}
		}
		public static final class ProgressTracker extends GreyCat.Object {
			...
			public static ProgressTracker create(ai.greycat.GreyCat greycat, ai.greycat.std.core.time start, java.lang.Long total, java.lang.Long counter, ai.greycat.std.core.duration duration, java.lang.Double progress, java.lang.Double speed, ai.greycat.std.core.duration remaining){
				return new ProgressTracker(greycat.libs_by_name.get(ai.greycat.std.name).mapped[85], start, total, counter, duration, progress, speed, remaining);
			}
		}
		...
		public static final class Gaussian extends GreyCat.Object {
			...
			public static Gaussian create(ai.greycat.GreyCat greycat, java.lang.Double sum, java.lang.Double sum_sq, java.lang.Long count, java.lang.Double min, java.lang.Double max){
				return new Gaussian(greycat.libs_by_name.get(ai.greycat.std.name).mapped[87], sum, sum_sq, count, min, max);
			}
		}
		public static final class Queue<T> extends ai.greycat.std_n.util.Queue<T> {
			...
			public static <T>Queue<T> create(ai.greycat.GreyCat greycat){
				return new Queue<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[88]);
			}
		}
		public static final class GaussianProfile extends ai.greycat.std_n.util.GaussianProfile {
			...
			public static GaussianProfile create(ai.greycat.GreyCat greycat){
				return new GaussianProfile(greycat.libs_by_name.get(ai.greycat.std.name).mapped[89]);
			}
		}
		public static final class HistogramInt extends ai.greycat.std_n.util.HistogramInt {
			...
			public static HistogramInt create(ai.greycat.GreyCat greycat){
				return new HistogramInt(greycat.libs_by_name.get(ai.greycat.std.name).mapped[90]);
			}
		}
		public static final class Buffer extends ai.greycat.std_n.util.Buffer {
			...
			public static Buffer create(ai.greycat.GreyCat greycat){
				return new Buffer(greycat.libs_by_name.get(ai.greycat.std.name).mapped[91]);
			}
		}
		public static final class BoxPlotInt extends GreyCat.Object {
			...
			public static BoxPlotInt create(ai.greycat.GreyCat greycat, java.lang.Long min, java.lang.Long max, java.lang.Long whiskerLow, java.lang.Long whiskerHigh, java.lang.Long percentile1, java.lang.Long percentile5, java.lang.Long percentile25, java.lang.Long percentile50, java.lang.Long percentile75, java.lang.Long percentile95, java.lang.Long percentile99, java.lang.Long countOutliersLow, java.lang.Long countOutliersHigh, java.lang.Double percentageOutliersLow, java.lang.Double percentageOutliersHigh, java.lang.Double sum, java.lang.Double avg, java.lang.Double std, java.lang.Long size){
				return new BoxPlotInt(greycat.libs_by_name.get(ai.greycat.std.name).mapped[92], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
			}
		}
		public static final class HistogramFloat extends ai.greycat.std_n.util.HistogramFloat {
			...
			public static HistogramFloat create(ai.greycat.GreyCat greycat){
				return new HistogramFloat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[93]);
			}
		}
	}
	@Override
	...
	public void init(ai.greycat.GreyCat greycat) {
		...
		this.mapped[0] = greycat.types_by_name.get(core.tf2d.name);
		...
		this.mapped[3] = greycat.types_by_name.get(core.ti6d.name);
		this.mapped[4] = greycat.types_by_name.get(core.nodeTimeSingleton.name);
		this.mapped[4].resolveGeneratedOffsets("t","v");
		this.mapped[5] = greycat.types_by_name.get(core.time.name);
		this.mapped[5].static_values = new java.lang.Object[]{greycat.createTime(-9223372036854775808L),greycat.createTime(9223372036854775807L)};
		this.mapped[6] = greycat.types_by_name.get(core.nodeTime.name);
		this.mapped[7] = greycat.types_by_name.get(core.DurationUnit.name);
		this.mapped[7].resolveGeneratedOffsetWithValues("microseconds", 1L,"milliseconds", 1000L,"seconds", 1000000L,"minutes", 60000000L,"hours", 3600000000L,"days", 86400000000L,"weeks", 604800000000L,"months", 2628000000000L,"years", 31536000000000L);
		this.mapped[8] = greycat.types_by_name.get(core.NodeTimeInfo.name);
		this.mapped[8].resolveGeneratedOffsets("size","from","to");
		this.mapped[9] = greycat.types_by_name.get(core.function.name);
		this.mapped[10] = greycat.types_by_name.get(core.Error.name);
		this.mapped[11] = greycat.types_by_name.get(core.GeoPoly.name);
		this.mapped[11].resolveGeneratedOffsets("points");
		this.mapped[12] = greycat.types_by_name.get(core.duration.name);
		this.mapped[13] = greycat.types_by_name.get(core.ti2d.name);
		this.mapped[14] = greycat.types_by_name.get(core.ErrorCode.name);
		this.mapped[14].resolveGeneratedOffsetWithValues("none", 0L,"too_deep_workspace", 1L,"too_deep_iterator", 2L,"wrong_operand", 3L,"wrong_params", 4L,"wrong_param_type", 5L,"wrong_numeric", 6L,"wrong_state", 7L,"wrong_null", 8L,"unresolved_ref", 9L,"assign_error", 10L,"interrupted", 11L,"throw", 12L,"wrong_type", 13L,"wrong_dimension", 14L,"unsupported_operation", 15L,"unsupported_type", 16L,"dimensions_mismatch", 17L,"timeout", 18L,"forbidden", 19L,"runtime_error", 20L);
		this.mapped[15] = greycat.types_by_name.get(core.geo.name);
		this.mapped[15].static_values = new java.lang.Object[]{greycat.createGeo(-85.0511287602,-179.9999999581),greycat.createGeo(85.0511287602,179.9999999581)};
		this.mapped[16] = greycat.types_by_name.get(core.node.name);
		this.mapped[17] = greycat.types_by_name.get(core.TableColumnMeta.name);
		this.mapped[17].resolveGeneratedOffsets("type","size","index","min","max","avg","std");
		this.mapped[18] = greycat.types_by_name.get(core.Date.name);
		this.mapped[19] = greycat.types_by_name.get(core.Tensor.name);
		this.mapped[20] = greycat.types_by_name.get(core.ti4d.name);
		this.mapped[21] = greycat.types_by_name.get(core.GeoCircle.name);
		this.mapped[21].resolveGeneratedOffsets("center","radius");
		this.mapped[22] = greycat.types_by_name.get(core.nodeGeo.name);
		this.mapped[23] = greycat.types_by_name.get(core.ti5d.name);
		this.mapped[24] = greycat.types_by_name.get(core.String.name);
		this.mapped[25] = greycat.types_by_name.get(core.Map.name);
		this.mapped[26] = greycat.types_by_name.get(core.TensorType.name);
		this.mapped[26].resolveGeneratedOffsetWithValues("i32", 4L,"i64", 8L,"f32", 4L,"f64", 8L,"c64", 8L,"c128", 16L);
		this.mapped[27] = greycat.types_by_name.get(core.TimeZone.name);
		...
		this.mapped[29] = greycat.types_by_name.get(core.Tuple.name);
		this.mapped[29].resolveGeneratedOffsets("x","y");
		this.mapped[30] = greycat.types_by_name.get(core.DatePart.name);
		this.mapped[30].resolveGeneratedOffsetWithValues("years", 0L,"months", 1L,"days", 2L,"hours", 3L,"minutes", 4L,"seconds", 5L,"microseconds", 6L);
		this.mapped[31] = greycat.types_by_name.get(core.nodeIndex.name);
		this.mapped[32] = greycat.types_by_name.get(core.nodeList.name);
		this.mapped[33] = greycat.types_by_name.get(core.tf3d.name);
		this.mapped[34] = greycat.types_by_name.get(core.nodeIndexBucket.name);
		this.mapped[35] = greycat.types_by_name.get(core.ti10d.name);
		this.mapped[36] = greycat.types_by_name.get(core.Array.name);
		this.mapped[37] = greycat.types_by_name.get(core.tf4d.name);
		this.mapped[38] = greycat.types_by_name.get(core.ti3d.name);
		this.mapped[39] = greycat.types_by_name.get(runtime.UserGroup.name);
		...
		this.mapped[42] = greycat.types_by_name.get(runtime.License.name);
		this.mapped[42].resolveGeneratedOffsets("name","start","end","company","max_workers","max_memory","extra_1","extra_2","extra_3","extra_4");
		this.mapped[43] = greycat.types_by_name.get(runtime.StoreStat.name);
		...
		this.mapped[47] = greycat.types_by_name.get(runtime.UserGroupPolicy.name);
		this.mapped[47].resolveGeneratedOffsets("group_id","type");
		this.mapped[48] = greycat.types_by_name.get(runtime.RuntimeInfo.name);
		...
		this.mapped[50] = greycat.types_by_name.get(runtime.System.name);
		this.mapped[51] = greycat.types_by_name.get(runtime.UserCredential.name);
		this.mapped[51].resolveGeneratedOffsets("offset","pass");
		this.mapped[52] = greycat.types_by_name.get(runtime.TaskStatus.name);
		this.mapped[52].resolveGeneratedOffsetWithValues("empty", 0L,"waiting", 1L,"running", 2L,"cancelled", 3L,"error", 4L,"ended", 5L);
		this.mapped[53] = greycat.types_by_name.get(runtime.UserRole.name);
		this.mapped[53].resolveGeneratedOffsets("name","permissions");
		this.mapped[54] = greycat.types_by_name.get(runtime.SecurityPolicy.name);
		...
		this.mapped[57] = greycat.types_by_name.get(runtime.UserGroupPolicyType.name);
		this.mapped[57].resolveGeneratedOffsetWithValues("read", 0L,"write", 1L,"execute", 2L);
		this.mapped[58] = greycat.types_by_name.get(io.Email.name);
		this.mapped[58].resolveGeneratedOffsets("from","subject","body","body_is_html","to","cc","bcc");
		this.mapped[59] = greycat.types_by_name.get(io.Smtp.name);
		this.mapped[59].resolveGeneratedOffsets("host","port","mode","authenticate","user","pass");
		this.mapped[60] = greycat.types_by_name.get(io.CsvFormat.name);
		...
		this.mapped[61] = greycat.types_by_name.get(io.CsvColumnDuration.name);
		...
		this.mapped[63] = greycat.types_by_name.get(io.HttpHeader.name);
		this.mapped[63].resolveGeneratedOffsets("name","value");
		this.mapped[64] = greycat.types_by_name.get(io.SmtpMode.name);
		this.mapped[64].resolveGeneratedOffsetWithValues("plain", 0L,"ssl_tls", 1L,"starttls", 2L);
		this.mapped[65] = greycat.types_by_name.get(io.Url.name);
		this.mapped[65].resolveGeneratedOffsets("protocol","host","port","path","params","hash");
		this.mapped[66] = greycat.types_by_name.get(io.CsvColumnFloat.name);
		this.mapped[66].resolveGeneratedOffsets("name","mandatory");
		this.mapped[67] = greycat.types_by_name.get(io.CsvColumn.name);
		...
		this.mapped[69] = greycat.types_by_name.get(io.Http.name);
		this.mapped[70] = greycat.types_by_name.get(io.CsvColumnTime.name);
		...
		this.mapped[72] = greycat.types_by_name.get(io.CsvColumnDate.name);
		this.mapped[72].resolveGeneratedOffsets("name","mandatory","format","tz","as_time");
		this.mapped[73] = greycat.types_by_name.get(io.CsvColumnString.name);
		this.mapped[73].resolveGeneratedOffsets("name","mandatory","trim","try_number","try_json","values","encoder");
		this.mapped[74] = greycat.types_by_name.get(io.CsvColumnBoolean.name);
		this.mapped[74].resolveGeneratedOffsets("name","mandatory");
		this.mapped[75] = greycat.types_by_name.get(io.CsvColumnIgnored.name);
		this.mapped[75].resolveGeneratedOffsets("name","mandatory");
		this.mapped[76] = greycat.types_by_name.get(io.TextEncoder.name);
		this.mapped[76].resolveGeneratedOffsetWithValues("plain", null,"base64", null,"base64url", null,"hexadecimal", null);
		this.mapped[77] = greycat.types_by_name.get(math.MathConstants.name);
		this.mapped[77].static_values = new java.lang.Object[]{2.7182818285,1.4426950409,0.4342944819,0.6931471806,2.302585093,3.1415926536,1.5707963268,0.7853981634,0.3183098862,0.6366197724,1.1283791671,1.4142135624,0.7071067812};
		this.mapped[78] = greycat.types_by_name.get(util.SlidingWindow.name);
		this.mapped[79] = greycat.types_by_name.get(util.Assert.name);
		this.mapped[80] = greycat.types_by_name.get(util.Iban.name);
		this.mapped[81] = greycat.types_by_name.get(util.BoxPlotFloat.name);
		...
		this.mapped[82] = greycat.types_by_name.get(util.Random.name);
		this.mapped[82].resolveGeneratedOffsets("seed","v");
		this.mapped[83] = greycat.types_by_name.get(util.Crypto.name);
		this.mapped[84] = greycat.types_by_name.get(util.TimeWindow.name);
		this.mapped[85] = greycat.types_by_name.get(util.ProgressTracker.name);
		...
		this.mapped[87] = greycat.types_by_name.get(util.Gaussian.name);
		this.mapped[87].resolveGeneratedOffsets("sum","sum_sq","count","min","max");
		this.mapped[88] = greycat.types_by_name.get(util.Queue.name);
		this.mapped[89] = greycat.types_by_name.get(util.GaussianProfile.name);
		this.mapped[89].static_values = new java.lang.Object[]{0L,1L,2L,3L,4L,5L,6L};
		this.mapped[90] = greycat.types_by_name.get(util.HistogramInt.name);
		this.mapped[90].static_values = new java.lang.Object[]{0L,1L,2L,3L};
		this.mapped[91] = greycat.types_by_name.get(util.Buffer.name);
		this.mapped[92] = greycat.types_by_name.get(util.BoxPlotInt.name);
		...
		this.mapped[93] = greycat.types_by_name.get(util.HistogramFloat.name);
		this.mapped[93].static_values = new java.lang.Object[]{0L,1L,2L,3L};
	}
}
