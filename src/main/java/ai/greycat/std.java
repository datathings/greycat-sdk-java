...
public final class std extends ai.greycat.GreyCat.Library {
	...
	public static final class core {
		public static final class nodeGeo<T> extends ai.greycat.std_n.core.nodeGeo {
			...
			public static nodeGeo create(ai.greycat.GreyCat greycat){
				return new nodeGeo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[0]);
			}
		}
		...
		public static final class ti3d extends ai.greycat.std_n.core.ti3d {
			...
			public static ti3d create(ai.greycat.GreyCat greycat){
				return new ti3d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[4]);
			}
		}
		public static final class ti2d extends ai.greycat.std_n.core.ti2d {
			...
			public static ti2d create(ai.greycat.GreyCat greycat){
				return new ti2d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[5]);
			}
		}
		...
		public static final class tf2d extends ai.greycat.std_n.core.tf2d {
			...
			public static tf2d create(ai.greycat.GreyCat greycat){
				return new tf2d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[7]);
			}
		}
		public static final class nodeTimeCursor<T> extends ai.greycat.std_n.core.nodeTimeCursor {
			...
			public static nodeTimeCursor create(ai.greycat.GreyCat greycat){
				return new nodeTimeCursor(greycat.libs_by_name.get(ai.greycat.std.name).mapped[8]);
			}
		}
		public static final class TableColumnMeta extends GreyCat.Object {
			...
			public static TableColumnMeta create(ai.greycat.GreyCat greycat, java.lang.String type, java.lang.Long size, java.lang.Boolean index, java.lang.Object min, java.lang.Object max, java.lang.Object avg, java.lang.Object std){
				return new TableColumnMeta(greycat.libs_by_name.get(ai.greycat.std.name).mapped[9], type, size, index, min, max, avg, std);
			}
		}
		public static final class Error extends ai.greycat.std_n.core.Error {
			...
			public static Error create(ai.greycat.GreyCat greycat){
				return new Error(greycat.libs_by_name.get(ai.greycat.std.name).mapped[10]);
			}
		}
		public static final class Map<K,V> extends ai.greycat.std_n.core.Map {
			...
			public static Map create(ai.greycat.GreyCat greycat){
				return new Map(greycat.libs_by_name.get(ai.greycat.std.name).mapped[11]);
			}
		}
		public static final class tf3d extends ai.greycat.std_n.core.tf3d {
			...
			public static tf3d create(ai.greycat.GreyCat greycat){
				return new tf3d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[12]);
			}
		}
		...
		public static final class SamplingMode extends GreyCat.Enum {
			...
			public static SamplingMode create(ai.greycat.GreyCat greycat){
				return new SamplingMode(greycat.libs_by_name.get(ai.greycat.std.name).mapped[15]);
			}
		}
		public static final class ti10d extends ai.greycat.std_n.core.ti10d {
			...
			public static ti10d create(ai.greycat.GreyCat greycat){
				return new ti10d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[16]);
			}
		}
		public static final class DurationUnit extends GreyCat.Enum {
			...
			public static DurationUnit create(ai.greycat.GreyCat greycat){
				return new DurationUnit(greycat.libs_by_name.get(ai.greycat.std.name).mapped[17]);
			}
		}
		public static final class Table<T> extends ai.greycat.std_n.core.Table {
			...
			public static Table create(ai.greycat.GreyCat greycat){
				return new Table(greycat.libs_by_name.get(ai.greycat.std.name).mapped[18]);
			}
		}
		...
		public static final class ti5d extends ai.greycat.std_n.core.ti5d {
			...
			public static ti5d create(ai.greycat.GreyCat greycat){
				return new ti5d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[20]);
			}
		}
		public static final class ti6d extends ai.greycat.std_n.core.ti6d {
			...
			public static ti6d create(ai.greycat.GreyCat greycat){
				return new ti6d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[21]);
			}
		}
		public static final class duration extends ai.greycat.std_n.core.duration {
			...
			public static duration create(ai.greycat.GreyCat greycat){
				return new duration(greycat.libs_by_name.get(ai.greycat.std.name).mapped[22]);
			}
		}
		public static final class nodeTime<T> extends ai.greycat.std_n.core.nodeTime {
			...
			public static nodeTime create(ai.greycat.GreyCat greycat){
				return new nodeTime(greycat.libs_by_name.get(ai.greycat.std.name).mapped[23]);
			}
		}
		public static final class Array<T> extends ai.greycat.std_n.core.Array {
			...
			public static Array create(ai.greycat.GreyCat greycat){
				return new Array(greycat.libs_by_name.get(ai.greycat.std.name).mapped[24]);
			}
		}
		public static final class DatePart extends GreyCat.Enum {
			...
			public static ai.greycat.std.core.DatePart years(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[25];
			...
			public static DatePart create(ai.greycat.GreyCat greycat){
				return new DatePart(greycat.libs_by_name.get(ai.greycat.std.name).mapped[25]);
			}
		}
		public static final class function extends GreyCat.Object {
			...
			public static function create(ai.greycat.GreyCat greycat){
				return new function(greycat.libs_by_name.get(ai.greycat.std.name).mapped[26]);
			}
		}
		public static final class NodeTimeInfo extends GreyCat.Object {
			...
			public static NodeTimeInfo create(ai.greycat.GreyCat greycat, java.lang.Long size, ai.greycat.std_n.core.time from, ai.greycat.std_n.core.time to){
				return new NodeTimeInfo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[27], size, from, to);
			}
		}
		...
		public static final class GeoPoly extends ai.greycat.std_n.core.GeoPoly {
			...
			public static GeoPoly create(ai.greycat.GreyCat greycat){
				return new GeoPoly(greycat.libs_by_name.get(ai.greycat.std.name).mapped[29]);
			}
		}
		public static final class GeoCircle extends GreyCat.Object {
			...
			public static GeoCircle create(ai.greycat.GreyCat greycat, ai.greycat.std_n.core.geo center, java.lang.Double radius){
				return new GeoCircle(greycat.libs_by_name.get(ai.greycat.std.name).mapped[30], center, radius);
			}
		}
		public static final class ti4d extends ai.greycat.std_n.core.ti4d {
			...
			public static ti4d create(ai.greycat.GreyCat greycat){
				return new ti4d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[31]);
			}
		}
		...
		public static final class tf4d extends ai.greycat.std_n.core.tf4d {
			...
			public static tf4d create(ai.greycat.GreyCat greycat){
				return new tf4d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[34]);
			}
		}
		...
		public static final class time extends ai.greycat.std_n.core.time {
			...
			public static time create(ai.greycat.GreyCat greycat){
				return new time(greycat.libs_by_name.get(ai.greycat.std.name).mapped[36]);
			}
		}
		...
		public static final class String extends ai.greycat.std_n.core.String {
			...
			public static String create(ai.greycat.GreyCat greycat){
				return new String(greycat.libs_by_name.get(ai.greycat.std.name).mapped[38]);
			}
		}
	}
	public static final class runtime {
		public static final class Task extends GreyCat.Object {
			...
			public static Task create(ai.greycat.GreyCat greycat, java.lang.Long id, java.lang.Long user, java.lang.Long parent, java.lang.String mod, java.lang.String type, java.lang.String fun, ai.greycat.std_n.core.time creation, ai.greycat.std.runtime.TaskStatus status, ai.greycat.std_n.core.time start, java.lang.Double progress, ai.greycat.std_n.core.duration remaining, ai.greycat.std_n.core.duration duration, java.lang.Long sub_waiting, java.lang.Long sub_tasks_all){
				return new Task(greycat.libs_by_name.get(ai.greycat.std.name).mapped[39], id, user, parent, mod, type, fun, creation, status, start, progress, remaining, duration, sub_waiting, sub_tasks_all);
			}
		}
		...
		public static final class Runtime extends GreyCat.Object {
			...
			public static Runtime create(ai.greycat.GreyCat greycat){
				return new Runtime(greycat.libs_by_name.get(ai.greycat.std.name).mapped[48]);
			}
		}
		...
		public static final class RuntimeInfo extends GreyCat.Object {
			...
			public static RuntimeInfo create(ai.greycat.GreyCat greycat, java.lang.String version, java.lang.String arch, ai.greycat.std.core.TimeZone timezone, ai.greycat.std.runtime.License license, java.lang.Long io_threads, java.lang.Long bg_threads, java.lang.Long fg_threads, java.lang.Long mem_total, java.lang.Long mem_worker, java.lang.Long nb_ctx, ai.greycat.std.runtime.StoreStat store_stats){
				return new RuntimeInfo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[50], version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
			}
		}
		public static final class UserGroupPolicy extends GreyCat.Object {
			...
			public static UserGroupPolicy create(ai.greycat.GreyCat greycat, java.lang.Long group_id, ai.greycat.std.runtime.UserGroupPolicyType type){
				return new UserGroupPolicy(greycat.libs_by_name.get(ai.greycat.std.name).mapped[51], group_id, type);
			}
		}
		public static final class License extends GreyCat.Object {
			...
			public static License create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std_n.core.time start, ai.greycat.std_n.core.time end, java.lang.String company, java.lang.Long max_workers, java.lang.Long max_memory, java.lang.Long max_store, java.lang.Long extra_1, java.lang.Long extra_2, java.lang.Long extra_3, java.lang.Long extra_4){
				return new License(greycat.libs_by_name.get(ai.greycat.std.name).mapped[52], name, start, end, company, max_workers, max_memory, max_store, extra_1, extra_2, extra_3, extra_4);
			}
		}
		public static final class UserGroupPolicyType extends GreyCat.Enum {
			...
			public static ai.greycat.std.runtime.UserGroupPolicyType read(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[53];
			...
			public static UserGroupPolicyType create(ai.greycat.GreyCat greycat){
				return new UserGroupPolicyType(greycat.libs_by_name.get(ai.greycat.std.name).mapped[53]);
			}
		}
		...
		public static final class StoreStat extends GreyCat.Object {
			...
			public static StoreStat create(ai.greycat.GreyCat greycat, java.lang.Long capacity_bytes, java.lang.Long allocated_bytes, java.lang.Double allocated_ratio, java.lang.Long remained_bytes, java.lang.Double remained_ratio, java.lang.Long used_bytes, java.lang.Double used_ratio, java.lang.Long available_bytes, java.lang.Double available_ratio){
				return new StoreStat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[55], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio);
			}
		}
	...
	public static final class io {
		public static final class TextEncoder extends GreyCat.Enum {
			...
			public static TextEncoder create(ai.greycat.GreyCat greycat){
				return new TextEncoder(greycat.libs_by_name.get(ai.greycat.std.name).mapped[57]);
			}
		}
		public static final class CsvColumnString extends GreyCat.Object {
			...
			public static CsvColumnString create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Boolean trim, java.lang.Boolean try_number, java.lang.Boolean try_json, ai.greycat.std.core.Array<java.lang.String> values, ai.greycat.std.io.TextEncoder encoder){
				return new CsvColumnString(greycat.libs_by_name.get(ai.greycat.std.name).mapped[58], name, mandatory, trim, try_number, try_json, values, encoder);
			}
		}
		public static final class CsvColumnBoolean extends GreyCat.Object {
			...
			public static CsvColumnBoolean create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory){
				return new CsvColumnBoolean(greycat.libs_by_name.get(ai.greycat.std.name).mapped[59], name, mandatory);
			}
		}
		public static final class GcbReader extends ai.greycat.std_n.io.GcbReader {
			...
			public static GcbReader create(ai.greycat.GreyCat greycat){
				return new GcbReader(greycat.libs_by_name.get(ai.greycat.std.name).mapped[60]);
			}
		}
		public static final class CsvColumn extends GreyCat.Object {
			...
			public static CsvColumn create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory){
				return new CsvColumn(greycat.libs_by_name.get(ai.greycat.std.name).mapped[61], name, mandatory);
			}
		}
		public static final class JsonReader extends ai.greycat.std_n.io.JsonReader {
			...
			public static JsonReader create(ai.greycat.GreyCat greycat){
				return new JsonReader(greycat.libs_by_name.get(ai.greycat.std.name).mapped[62]);
			}
		}
		public static final class JsonWriter extends ai.greycat.std_n.io.JsonWriter {
			...
			public static JsonWriter create(ai.greycat.GreyCat greycat){
				return new JsonWriter(greycat.libs_by_name.get(ai.greycat.std.name).mapped[63]);
			}
		}
		public static final class FileEntry extends GreyCat.Object {
			...
			public static FileEntry create(ai.greycat.GreyCat greycat){
				return new FileEntry(greycat.libs_by_name.get(ai.greycat.std.name).mapped[64]);
			}
		}
		public static final class File extends ai.greycat.std_n.io.File {
			...
			public static File create(ai.greycat.GreyCat greycat){
				return new File(greycat.libs_by_name.get(ai.greycat.std.name).mapped[65]);
			}
		}
		public static final class Directory extends ai.greycat.std_n.io.Directory {
			...
			public static Directory create(ai.greycat.GreyCat greycat){
				return new Directory(greycat.libs_by_name.get(ai.greycat.std.name).mapped[66]);
			}
		}
		public static final class GcbWriter extends ai.greycat.std_n.io.GcbWriter {
			...
			public static GcbWriter create(ai.greycat.GreyCat greycat){
				return new GcbWriter(greycat.libs_by_name.get(ai.greycat.std.name).mapped[67]);
			}
		}
		public static final class FileDescriptor extends GreyCat.Object {
			...
			public static FileDescriptor create(ai.greycat.GreyCat greycat, java.lang.String uri, java.lang.Long size, ai.greycat.std_n.core.time last_modification){
				return new FileDescriptor(greycat.libs_by_name.get(ai.greycat.std.name).mapped[68], uri, size, last_modification);
			}
		}
		public static final class CsvWriter extends ai.greycat.std_n.io.CsvWriter {
			...
			public static CsvWriter create(ai.greycat.GreyCat greycat){
				return new CsvWriter(greycat.libs_by_name.get(ai.greycat.std.name).mapped[69]);
			}
		}
		public static final class TextWriter extends ai.greycat.std_n.io.TextWriter {
			...
			public static TextWriter create(ai.greycat.GreyCat greycat){
				return new TextWriter(greycat.libs_by_name.get(ai.greycat.std.name).mapped[70]);
			}
		}
		...
		public static final class CsvColumnTime extends GreyCat.Object {
			...
			public static CsvColumnTime create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, ai.greycat.std.core.DurationUnit unit){
				return new CsvColumnTime(greycat.libs_by_name.get(ai.greycat.std.name).mapped[72], name, mandatory, unit);
			}
		}
		public static final class JSON extends GreyCat.Object {
			...
			public static JSON create(ai.greycat.GreyCat greycat){
				return new JSON(greycat.libs_by_name.get(ai.greycat.std.name).mapped[73]);
			}
		}
		public static final class CsvReader extends ai.greycat.std_n.io.CsvReader {
			...
			public static CsvReader create(ai.greycat.GreyCat greycat){
				return new CsvReader(greycat.libs_by_name.get(ai.greycat.std.name).mapped[74]);
			}
		}
		public static final class TextReader extends ai.greycat.std_n.io.TextReader {
			...
			public static TextReader create(ai.greycat.GreyCat greycat){
				return new TextReader(greycat.libs_by_name.get(ai.greycat.std.name).mapped[75]);
			}
		}
		...
		public static final class CsvFormat extends GreyCat.Object {
			...
			public static CsvFormat create(ai.greycat.GreyCat greycat, java.lang.Long header_lines, java.lang.Boolean infer, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, ai.greycat.std.core.Array<ai.greycat.std.io.CsvColumn> columns){
				return new CsvFormat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[77], header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns);
			}
		}
		public static final class CsvColumnIgnored extends GreyCat.Object {
			...
			public static CsvColumnIgnored create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory){
				return new CsvColumnIgnored(greycat.libs_by_name.get(ai.greycat.std.name).mapped[78], name, mandatory);
			}
		}
		public static final class CsvColumnFloat extends GreyCat.Object {
			...
			public static CsvColumnFloat create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory){
				return new CsvColumnFloat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[79], name, mandatory);
			}
		}
	}
	public static final class debug {
		public static final class TypeRef extends GreyCat.Object {
			...
			public static TypeRef create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.String module, ai.greycat.std.core.Array<ai.greycat.std.debug.TypeRef> generics, java.lang.Boolean nullable){
				return new TypeRef(greycat.libs_by_name.get(ai.greycat.std.name).mapped[80], name, module, generics, nullable);
			}
		}
		public static final class TypeDesc extends GreyCat.Object {
			...
			public static TypeDesc create(ai.greycat.GreyCat greycat, java.lang.String module, java.lang.String name, ai.greycat.std.core.Array<ai.greycat.std.debug.FnDesc> methods, ai.greycat.std.core.Array<ai.greycat.std.debug.TypeAttr> attrs, java.lang.Boolean is_abstract, java.lang.Boolean is_enum){
				return new TypeDesc(greycat.libs_by_name.get(ai.greycat.std.name).mapped[81], module, name, methods, attrs, is_abstract, is_enum);
			}
		}
		public static final class FnDesc extends GreyCat.Object {
			...
			public static FnDesc create(ai.greycat.GreyCat greycat, java.lang.String module, java.lang.String name, java.lang.String parent_type, ai.greycat.std.core.Array<ai.greycat.std.debug.FnParam> params, ai.greycat.std.debug.TypeRef return_type, java.lang.Boolean is_static, java.lang.Boolean is_task, java.lang.Boolean is_exclusive, java.lang.Boolean is_reserved, java.lang.Boolean is_exposed, ai.greycat.std.debug.FnMode mode, ai.greycat.std.core.Array<java.lang.String> permissions){
				return new FnDesc(greycat.libs_by_name.get(ai.greycat.std.name).mapped[82], module, name, parent_type, params, return_type, is_static, is_task, is_exclusive, is_reserved, is_exposed, mode, permissions);
			}
		}
		public static final class FnParam extends GreyCat.Object {
			...
			public static FnParam create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.debug.TypeRef type){
				return new FnParam(greycat.libs_by_name.get(ai.greycat.std.name).mapped[83], name, type);
			}
		}
		public static final class ModDesc extends GreyCat.Object {
			...
			public static ModDesc create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.String lib, ai.greycat.std.core.Array<ai.greycat.std.debug.FnDesc> functions, ai.greycat.std.core.Array<ai.greycat.std.debug.TypeDesc> types, ai.greycat.std.core.Array<ai.greycat.std.debug.ModVarDesc> vars){
				return new ModDesc(greycat.libs_by_name.get(ai.greycat.std.name).mapped[84], name, lib, functions, types, vars);
			}
		}
		public static final class TypeAttr extends GreyCat.Object {
			...
			public static TypeAttr create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.debug.TypeRef type, java.lang.Boolean is_static){
				return new TypeAttr(greycat.libs_by_name.get(ai.greycat.std.name).mapped[85], name, type, is_static);
			}
		}
		public static final class FnMode extends GreyCat.Enum {
			...
			public static FnMode create(ai.greycat.GreyCat greycat){
				return new FnMode(greycat.libs_by_name.get(ai.greycat.std.name).mapped[86]);
			}
		}
	...
	public static final class util {
		public static final class SlidingWindow extends ai.greycat.std_n.util.SlidingWindow {
			...
			public static SlidingWindow create(ai.greycat.GreyCat greycat){
				return new SlidingWindow(greycat.libs_by_name.get(ai.greycat.std.name).mapped[89]);
			}
		}
		public static final class TimeWindow extends ai.greycat.std_n.util.TimeWindow {
			...
			public static TimeWindow create(ai.greycat.GreyCat greycat){
				return new TimeWindow(greycat.libs_by_name.get(ai.greycat.std.name).mapped[90]);
			}
		}
		public static final class Iban extends ai.greycat.std_n.util.Iban {
			...
			public static Iban create(ai.greycat.GreyCat greycat){
				return new Iban(greycat.libs_by_name.get(ai.greycat.std.name).mapped[91]);
			}
		}
		public static final class Buffer extends ai.greycat.std_n.util.Buffer {
			...
			public static Buffer create(ai.greycat.GreyCat greycat){
				return new Buffer(greycat.libs_by_name.get(ai.greycat.std.name).mapped[92]);
			}
		}
		public static final class BoxPlot<T> extends GreyCat.Object {
			...
			public static BoxPlot create(ai.greycat.GreyCat greycat, java.lang.Object min, java.lang.Object max, java.lang.Object whiskerLow, java.lang.Object whiskerHigh, java.lang.Object percentile1, java.lang.Object percentile5, java.lang.Object percentile25, java.lang.Object percentile50, java.lang.Object percentile75, java.lang.Object percentile95, java.lang.Object percentile99, java.lang.Long countOutliersLow, java.lang.Long countOutliersHigh, java.lang.Double percentageOutliersLow, java.lang.Double percentageOutliersHigh, java.lang.Double sum, java.lang.Double avg, java.lang.Double std, java.lang.Long size){
				return new BoxPlot(greycat.libs_by_name.get(ai.greycat.std.name).mapped[93], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
			}
		}
		...
		public static final class Queue<T> extends ai.greycat.std_n.util.Queue {
			...
			public static Queue create(ai.greycat.GreyCat greycat){
				return new Queue(greycat.libs_by_name.get(ai.greycat.std.name).mapped[95]);
			}
		}
		...
		public static final class NdEncoding extends GreyCat.Object {
			...
			public static NdEncoding create(ai.greycat.GreyCat greycat){
				return new NdEncoding(greycat.libs_by_name.get(ai.greycat.std.name).mapped[97]);
			}
		}
		...
		public static final class Random extends GreyCat.Object {
			...
			public static Random create(ai.greycat.GreyCat greycat, java.lang.Long seed, java.lang.Double v){
				return new Random(greycat.libs_by_name.get(ai.greycat.std.name).mapped[99], seed, v);
			}
		}
		public static final class Gaussian extends ai.greycat.std_n.util.Gaussian {
			...
			public static Gaussian create(ai.greycat.GreyCat greycat){
				return new Gaussian(greycat.libs_by_name.get(ai.greycat.std.name).mapped[100]);
			}
		}
		...
		public static final class Histogram<T> extends GreyCat.Object {
			...
			public static Histogram create(ai.greycat.GreyCat greycat){
				return new Histogram(greycat.libs_by_name.get(ai.greycat.std.name).mapped[102]);
			}
		}
		public static final class HistogramF64 extends ai.greycat.std_n.util.HistogramF64 {
			...
			public static HistogramF64 create(ai.greycat.GreyCat greycat){
				return new HistogramF64(greycat.libs_by_name.get(ai.greycat.std.name).mapped[103]);
			}
		}
		public static final class HistogramBucket extends GreyCat.Enum {
			...
			public static ai.greycat.std.util.HistogramBucket from(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[104];
			...
			public static HistogramBucket create(ai.greycat.GreyCat greycat){
				return new HistogramBucket(greycat.libs_by_name.get(ai.greycat.std.name).mapped[104]);
			}
		}
		public static final class BoxPlotF64 extends GreyCat.Object {
			...
			public static BoxPlotF64 create(ai.greycat.GreyCat greycat, java.lang.Object min, java.lang.Object max, java.lang.Object whiskerLow, java.lang.Object whiskerHigh, java.lang.Object percentile1, java.lang.Object percentile5, java.lang.Object percentile25, java.lang.Object percentile50, java.lang.Object percentile75, java.lang.Object percentile95, java.lang.Object percentile99, java.lang.Long countOutliersLow, java.lang.Long countOutliersHigh, java.lang.Double percentageOutliersLow, java.lang.Double percentageOutliersHigh, java.lang.Double sum, java.lang.Double avg, java.lang.Double std, java.lang.Long size){
				return new BoxPlotF64(greycat.libs_by_name.get(ai.greycat.std.name).mapped[105], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
			}
		}
		public static final class Quantizer extends ai.greycat.std_n.util.Quantizer {
			...
			public static Quantizer create(ai.greycat.GreyCat greycat){
				return new Quantizer(greycat.libs_by_name.get(ai.greycat.std.name).mapped[106]);
			}
		}
		public static final class HistogramI64 extends ai.greycat.std_n.util.HistogramI64 {
			...
			public static HistogramI64 create(ai.greycat.GreyCat greycat){
				return new HistogramI64(greycat.libs_by_name.get(ai.greycat.std.name).mapped[107]);
			}
		}
		public static final class ByteArray extends ai.greycat.std_n.util.ByteArray {
			...
			public static ByteArray create(ai.greycat.GreyCat greycat){
				return new ByteArray(greycat.libs_by_name.get(ai.greycat.std.name).mapped[108]);
			}
		}
	...
	public void configure(java.util.Map<String, ai.greycat.GreyCat.Loader> loaders, java.util.Map<String, ai.greycat.GreyCat.Factory> factories) {
		...
		loaders.put(io.GcbReader.name, ai.greycat.std_n.io.GcbReader::load);
		...
		loaders.put(io.GcbWriter.name, ai.greycat.std_n.io.GcbWriter::load);
	...
	public void init(ai.greycat.GreyCat greycat) {
		...
		this.mapped[0] = greycat.types_by_name.get(core.nodeGeo.name);
		...
		this.mapped[4] = greycat.types_by_name.get(core.ti3d.name);
		this.mapped[5] = greycat.types_by_name.get(core.ti2d.name);
		this.mapped[6] = greycat.types_by_name.get(core.node.name);
		this.mapped[7] = greycat.types_by_name.get(core.tf2d.name);
		this.mapped[8] = greycat.types_by_name.get(core.nodeTimeCursor.name);
		this.mapped[9] = greycat.types_by_name.get(core.TableColumnMeta.name);
		this.mapped[9].resolveGeneratedOffsets("type","size","index","min","max","avg","std");
		this.mapped[10] = greycat.types_by_name.get(core.Error.name);
		this.mapped[11] = greycat.types_by_name.get(core.Map.name);
		this.mapped[12] = greycat.types_by_name.get(core.tf3d.name);
		...
		this.mapped[15] = greycat.types_by_name.get(core.SamplingMode.name);
		this.mapped[15].resolveGeneratedOffsetWithValues("fixed", 0L,"fixed_reg", 1L,"adaptative", 2L,"dense", 3L);
		this.mapped[16] = greycat.types_by_name.get(core.ti10d.name);
		this.mapped[17] = greycat.types_by_name.get(core.DurationUnit.name);
		this.mapped[17].resolveGeneratedOffsetWithValues("microseconds", 1L,"milliseconds", 1000L,"seconds", 1000000L,"minutes", 60000000L,"hours", 3600000000L,"days", 86400000000L,"weeks", 604800000000L,"months", 2628000000000L,"years", 31536000000000L);
		this.mapped[18] = greycat.types_by_name.get(core.Table.name);
		this.mapped[19] = greycat.types_by_name.get(core.Date.name);
		this.mapped[20] = greycat.types_by_name.get(core.ti5d.name);
		this.mapped[21] = greycat.types_by_name.get(core.ti6d.name);
		this.mapped[22] = greycat.types_by_name.get(core.duration.name);
		this.mapped[23] = greycat.types_by_name.get(core.nodeTime.name);
		this.mapped[24] = greycat.types_by_name.get(core.Array.name);
		this.mapped[25] = greycat.types_by_name.get(core.DatePart.name);
		this.mapped[25].resolveGeneratedOffsetWithValues("years", 0L,"months", 1L,"days", 2L,"hours", 3L,"minutes", 4L,"seconds", 5L,"microseconds", 6L);
		this.mapped[26] = greycat.types_by_name.get(core.function.name);
		this.mapped[27] = greycat.types_by_name.get(core.NodeTimeInfo.name);
		...
		this.mapped[29] = greycat.types_by_name.get(core.GeoPoly.name);
		this.mapped[30] = greycat.types_by_name.get(core.GeoCircle.name);
		this.mapped[30].resolveGeneratedOffsets("center","radius");
		this.mapped[31] = greycat.types_by_name.get(core.ti4d.name);
		...
		this.mapped[34] = greycat.types_by_name.get(core.tf4d.name);
		this.mapped[35] = greycat.types_by_name.get(core.GeoBox.name);
		this.mapped[35].resolveGeneratedOffsets("sw","ne");
		this.mapped[36] = greycat.types_by_name.get(core.time.name);
		this.mapped[36].static_values = new java.lang.Object[]{greycat.createTime(-9223372036854775808L),greycat.createTime(9223372036854775807L)};
		...
		this.mapped[38] = greycat.types_by_name.get(core.String.name);
		...
		this.mapped[48] = greycat.types_by_name.get(runtime.Runtime.name);
		...
		this.mapped[50] = greycat.types_by_name.get(runtime.RuntimeInfo.name);
		...
		this.mapped[51] = greycat.types_by_name.get(runtime.UserGroupPolicy.name);
		this.mapped[51].resolveGeneratedOffsets("group_id","type");
		this.mapped[52] = greycat.types_by_name.get(runtime.License.name);
		...
		this.mapped[53] = greycat.types_by_name.get(runtime.UserGroupPolicyType.name);
		this.mapped[53].resolveGeneratedOffsetWithValues("read", 0L,"write", 1L,"execute", 2L);
		this.mapped[54] = greycat.types_by_name.get(runtime.UserCredential.name);
		this.mapped[54].resolveGeneratedOffsets("offset","pass");
		this.mapped[55] = greycat.types_by_name.get(runtime.StoreStat.name);
		...
		this.mapped[57] = greycat.types_by_name.get(io.TextEncoder.name);
		this.mapped[57].resolveGeneratedOffsetWithValues("plain", null,"base64", null,"base64url", null,"hexadecimal", null);
		this.mapped[58] = greycat.types_by_name.get(io.CsvColumnString.name);
		this.mapped[58].resolveGeneratedOffsets("name","mandatory","trim","try_number","try_json","values","encoder");
		this.mapped[59] = greycat.types_by_name.get(io.CsvColumnBoolean.name);
		this.mapped[59].resolveGeneratedOffsets("name","mandatory");
		this.mapped[60] = greycat.types_by_name.get(io.GcbReader.name);
		this.mapped[61] = greycat.types_by_name.get(io.CsvColumn.name);
		this.mapped[61].resolveGeneratedOffsets("name","mandatory");
		this.mapped[62] = greycat.types_by_name.get(io.JsonReader.name);
		this.mapped[63] = greycat.types_by_name.get(io.JsonWriter.name);
		this.mapped[64] = greycat.types_by_name.get(io.FileEntry.name);
		this.mapped[65] = greycat.types_by_name.get(io.File.name);
		this.mapped[66] = greycat.types_by_name.get(io.Directory.name);
		this.mapped[67] = greycat.types_by_name.get(io.GcbWriter.name);
		this.mapped[68] = greycat.types_by_name.get(io.FileDescriptor.name);
		this.mapped[68].resolveGeneratedOffsets("uri","size","last_modification");
		this.mapped[69] = greycat.types_by_name.get(io.CsvWriter.name);
		this.mapped[70] = greycat.types_by_name.get(io.TextWriter.name);
		this.mapped[71] = greycat.types_by_name.get(io.CsvColumnInteger.name);
		this.mapped[71].resolveGeneratedOffsets("name","mandatory");
		this.mapped[72] = greycat.types_by_name.get(io.CsvColumnTime.name);
		this.mapped[72].resolveGeneratedOffsets("name","mandatory","unit");
		this.mapped[73] = greycat.types_by_name.get(io.JSON.name);
		this.mapped[74] = greycat.types_by_name.get(io.CsvReader.name);
		this.mapped[75] = greycat.types_by_name.get(io.TextReader.name);
		...
		this.mapped[78] = greycat.types_by_name.get(io.CsvColumnIgnored.name);
		this.mapped[78].resolveGeneratedOffsets("name","mandatory");
		this.mapped[79] = greycat.types_by_name.get(io.CsvColumnFloat.name);
		this.mapped[79].resolveGeneratedOffsets("name","mandatory");
		this.mapped[80] = greycat.types_by_name.get(debug.TypeRef.name);
		this.mapped[80].resolveGeneratedOffsets("name","module","generics","nullable");
		this.mapped[81] = greycat.types_by_name.get(debug.TypeDesc.name);
		this.mapped[81].resolveGeneratedOffsets("module","name","methods","attrs","is_abstract","is_enum");
		this.mapped[82] = greycat.types_by_name.get(debug.FnDesc.name);
		...
		this.mapped[83] = greycat.types_by_name.get(debug.FnParam.name);
		this.mapped[83].resolveGeneratedOffsets("name","type");
		this.mapped[84] = greycat.types_by_name.get(debug.ModDesc.name);
		this.mapped[84].resolveGeneratedOffsets("name","lib","functions","types","vars");
		this.mapped[85] = greycat.types_by_name.get(debug.TypeAttr.name);
		this.mapped[85].resolveGeneratedOffsets("name","type","is_static");
		this.mapped[86] = greycat.types_by_name.get(debug.FnMode.name);
		...
		this.mapped[89] = greycat.types_by_name.get(util.SlidingWindow.name);
		this.mapped[90] = greycat.types_by_name.get(util.TimeWindow.name);
		this.mapped[91] = greycat.types_by_name.get(util.Iban.name);
		this.mapped[92] = greycat.types_by_name.get(util.Buffer.name);
		this.mapped[93] = greycat.types_by_name.get(util.BoxPlot.name);
		...
		this.mapped[95] = greycat.types_by_name.get(util.Queue.name);
		this.mapped[96] = greycat.types_by_name.get(util.GaussianProfile.name);
		this.mapped[97] = greycat.types_by_name.get(util.NdEncoding.name);
		...
		this.mapped[99] = greycat.types_by_name.get(util.Random.name);
		this.mapped[99].resolveGeneratedOffsets("seed","v");
		this.mapped[100] = greycat.types_by_name.get(util.Gaussian.name);
		this.mapped[101] = greycat.types_by_name.get(util.Assert.name);
		this.mapped[102] = greycat.types_by_name.get(util.Histogram.name);
		this.mapped[103] = greycat.types_by_name.get(util.HistogramF64.name);
		this.mapped[104] = greycat.types_by_name.get(util.HistogramBucket.name);
		this.mapped[104].resolveGeneratedOffsetWithValues("from", 0L,"to", 1L,"count", 2L,"percentage", 3L);
		this.mapped[105] = greycat.types_by_name.get(util.BoxPlotF64.name);
		...
		this.mapped[106] = greycat.types_by_name.get(util.Quantizer.name);
		this.mapped[107] = greycat.types_by_name.get(util.HistogramI64.name);
		this.mapped[108] = greycat.types_by_name.get(util.ByteArray.name);
