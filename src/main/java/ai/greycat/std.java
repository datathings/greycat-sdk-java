...
public final class std extends ai.greycat.GreyCat.Library {
	...
	public static final class core {
		public static final class String extends ai.greycat.std_n.core.String {
			...
			public static String create(ai.greycat.GreyCat greycat){
				return new String(greycat.libs_by_name.get(ai.greycat.std.name).mapped[0]);
			}
		}
		public static final class Error extends ai.greycat.std_n.core.Error {
			...
			public static Error create(ai.greycat.GreyCat greycat){
				return new Error(greycat.libs_by_name.get(ai.greycat.std.name).mapped[1]);
			}
		}
		public static final class GeoCircle extends GreyCat.Object {
			...
			public static GeoCircle create(ai.greycat.GreyCat greycat, ai.greycat.std.core.geo center, java.lang.Double radius){
				return new GeoCircle(greycat.libs_by_name.get(ai.greycat.std.name).mapped[2], center, radius);
			}
		}
		public static final class Array<T> extends ai.greycat.std_n.core.Array<T> {
			...
			public static <T>Array<T> create(ai.greycat.GreyCat greycat){
				return new Array<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[3]);
			}
		}
		public static final class ErrorCode extends GreyCat.Enum {
			...
			public static ErrorCode create(ai.greycat.GreyCat greycat){
				return new ErrorCode(greycat.libs_by_name.get(ai.greycat.std.name).mapped[4]);
			}
		}
		public static final class geo extends ai.greycat.std_n.core.geo {
			...
			public static geo create(ai.greycat.GreyCat greycat){
				return new geo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[5]);
			}
		}
		public static final class ti4d extends ai.greycat.std_n.core.ti4d {
			...
			public static ti4d create(ai.greycat.GreyCat greycat){
				return new ti4d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[6]);
			}
		}
		public static final class nodeTime<T> extends ai.greycat.std_n.core.nodeTime<T> {
			...
			public static <T>nodeTime<T> create(ai.greycat.GreyCat greycat){
				return new nodeTime<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[7]);
			}
		}
		public static final class Date extends ai.greycat.std_n.core.Date {
			...
			public static Date create(ai.greycat.GreyCat greycat){
				return new Date(greycat.libs_by_name.get(ai.greycat.std.name).mapped[8]);
			}
		}
		public static final class TimeZone extends GreyCat.Enum {
			...
			public static TimeZone create(ai.greycat.GreyCat greycat){
				return new TimeZone(greycat.libs_by_name.get(ai.greycat.std.name).mapped[9]);
			}
		}
		public static final class Table<T> extends ai.greycat.std_n.core.Table<T> {
			...
			public static <T>Table<T> create(ai.greycat.GreyCat greycat){
				return new Table<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[10]);
			}
		}
		public static final class ti6d extends ai.greycat.std_n.core.ti6d {
			...
			public static ti6d create(ai.greycat.GreyCat greycat){
				return new ti6d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[11]);
			}
		}
		public static final class nodeGeo<T> extends ai.greycat.std_n.core.nodeGeo<T> {
			...
			public static <T>nodeGeo<T> create(ai.greycat.GreyCat greycat){
				return new nodeGeo<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[12]);
			}
		}
		public static final class duration extends ai.greycat.std_n.core.duration {
			...
			public static duration create(ai.greycat.GreyCat greycat){
				return new duration(greycat.libs_by_name.get(ai.greycat.std.name).mapped[13]);
			}
		}
		public static final class Date2 extends GreyCat.Object {
			public static final java.lang.String name = "core::Date2";
			private Date2(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			...
			public static Date2 create(ai.greycat.GreyCat greycat, java.lang.Long year, java.lang.Long month, java.lang.Long day, java.lang.Long hour, java.lang.Long minute, java.lang.Long second, java.lang.Long microsecond){
				return new Date2(greycat.libs_by_name.get(ai.greycat.std.name).mapped[14], year, month, day, hour, minute, second, microsecond);
			}
		}
		public static final class DurationUnit extends GreyCat.Enum {
			...
			public static DurationUnit create(ai.greycat.GreyCat greycat){
				return new DurationUnit(greycat.libs_by_name.get(ai.greycat.std.name).mapped[15]);
			}
		}
		...
		public static final class ti2d extends ai.greycat.std_n.core.ti2d {
			...
			public static ti2d create(ai.greycat.GreyCat greycat){
				return new ti2d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[18]);
			}
		}
		public static final class Map<K,V> extends ai.greycat.std_n.core.Map<K,V> {
			...
			public static <K,V>Map<K,V> create(ai.greycat.GreyCat greycat){
				return new Map<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[19]);
			}
		}
		public static final class nodeIndex<K,V> extends ai.greycat.std_n.core.nodeIndex<K,V> {
			...
			public static <K,V>nodeIndex<K,V> create(ai.greycat.GreyCat greycat){
				return new nodeIndex<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[20]);
			}
		}
		public static final class tf4d extends ai.greycat.std_n.core.tf4d {
			...
			public static tf4d create(ai.greycat.GreyCat greycat){
				return new tf4d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[21]);
			}
		}
		public static final class TableColumnMapping extends GreyCat.Object {
			...
			public static TableColumnMapping create(ai.greycat.GreyCat greycat, java.lang.Long column, ai.greycat.std.core.Array<java.lang.Object> extractors){
				return new TableColumnMapping(greycat.libs_by_name.get(ai.greycat.std.name).mapped[22], column, extractors);
			}
		}
		public static final class nodeList<T> extends ai.greycat.std_n.core.nodeList<T> {
			...
			public static <T>nodeList<T> create(ai.greycat.GreyCat greycat){
				return new nodeList<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[23]);
			}
		}
		public static final class TensorType extends GreyCat.Enum {
			...
			public static TensorType create(ai.greycat.GreyCat greycat){
				return new TensorType(greycat.libs_by_name.get(ai.greycat.std.name).mapped[24]);
			}
		}
		public static final class Tuple<T,U> extends GreyCat.Object {
			...
			public static <T,U>Tuple<T,U> create(ai.greycat.GreyCat greycat, T x, U y){
				return new Tuple<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[25], x, y);
			}
		}
		public static final class tf2d extends ai.greycat.std_n.core.tf2d {
			...
			public static tf2d create(ai.greycat.GreyCat greycat){
				return new tf2d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[26]);
			}
		}
		...
		public static final class TableColumnMeta extends GreyCat.Object {
			...
			public void set_header(java.lang.String v){
				super.set(super.type.generated_offsets[3],v);
			}
			...
			public static TableColumnMeta create(ai.greycat.GreyCat greycat, java.lang.String type, java.lang.Long size, java.lang.Boolean index, java.lang.String header, java.lang.Object min, java.lang.Object max, java.lang.Object avg, java.lang.Object std){
				return new TableColumnMeta(greycat.libs_by_name.get(ai.greycat.std.name).mapped[28], type, size, index, header, min, max, avg, std);
			}
		}
		public static final class GeoBox extends GreyCat.Object {
			...
			public static GeoBox create(ai.greycat.GreyCat greycat, ai.greycat.std.core.geo sw, ai.greycat.std.core.geo ne){
				return new GeoBox(greycat.libs_by_name.get(ai.greycat.std.name).mapped[29], sw, ne);
			}
		}
		...
		public static final class GeoPoly extends GreyCat.Object {
			...
			public static GeoPoly create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array<ai.greycat.std.core.geo> points){
				return new GeoPoly(greycat.libs_by_name.get(ai.greycat.std.name).mapped[31], points);
			}
		}
		public static final class nodeIndexBucket extends ai.greycat.std_n.core.nodeIndexBucket {
			...
			public static nodeIndexBucket create(ai.greycat.GreyCat greycat){
				return new nodeIndexBucket(greycat.libs_by_name.get(ai.greycat.std.name).mapped[32]);
			}
		}
		public static final class time extends ai.greycat.std_n.core.time {
			...
			public static time create(ai.greycat.GreyCat greycat){
				return new time(greycat.libs_by_name.get(ai.greycat.std.name).mapped[33]);
			}
		}
		public static final class ti10d extends ai.greycat.std_n.core.ti10d {
			...
			public static ti10d create(ai.greycat.GreyCat greycat){
				return new ti10d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[34]);
			}
		}
		public static final class SamplingMode extends GreyCat.Enum {
			...
			public static SamplingMode create(ai.greycat.GreyCat greycat){
				return new SamplingMode(greycat.libs_by_name.get(ai.greycat.std.name).mapped[35]);
			}
		}
		public static final class ti5d extends ai.greycat.std_n.core.ti5d {
			...
			public static ti5d create(ai.greycat.GreyCat greycat){
				return new ti5d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[36]);
			}
		}
		public static final class DatePart extends GreyCat.Enum {
			...
			public static ai.greycat.std.core.DatePart years(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[37];
			...
			public static DatePart create(ai.greycat.GreyCat greycat){
				return new DatePart(greycat.libs_by_name.get(ai.greycat.std.name).mapped[37]);
			}
		}
		public static final class ti3d extends ai.greycat.std_n.core.ti3d {
			...
			public static ti3d create(ai.greycat.GreyCat greycat){
				return new ti3d(greycat.libs_by_name.get(ai.greycat.std.name).mapped[38]);
			}
		}
		public static final class nodeTimeSingleton extends GreyCat.Object {
			...
			public static nodeTimeSingleton create(ai.greycat.GreyCat greycat, ai.greycat.std.core.time t, java.lang.Object v){
				return new nodeTimeSingleton(greycat.libs_by_name.get(ai.greycat.std.name).mapped[39], t, v);
			}
		}
		public static final class NodeInfo<T> extends GreyCat.Object {
			...
			public static <T>NodeInfo<T> create(ai.greycat.GreyCat greycat, java.lang.Long size, T from, T to){
				return new NodeInfo<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[40], size, from, to);
			}
		}
	}
	public static final class runtime {
		public static final class TaskRequest extends GreyCat.Object {
			...
			public ai.greycat.std.core.Array<java.lang.Object> arguments(){
				return (ai.greycat.std.core.Array<java.lang.Object>)super.get(super.type.generated_offsets[1]);
			}
			public void set_arguments(ai.greycat.std.core.Array<java.lang.Object> v){
				super.set(super.type.generated_offsets[1],v);
			}
			...
			public static TaskRequest create(ai.greycat.GreyCat greycat, ai.greycat.std.core.function function, ai.greycat.std.core.Array<java.lang.Object> arguments, ai.greycat.std.runtime.TaskMode mode){
				return new TaskRequest(greycat.libs_by_name.get(ai.greycat.std.name).mapped[41], function, arguments, mode);
			}
		}
		public static final class System extends GreyCat.Object {
			...
			public static System create(ai.greycat.GreyCat greycat){
				return new System(greycat.libs_by_name.get(ai.greycat.std.name).mapped[42]);
			}
		}
		public static final class License extends GreyCat.Object {
			...
			public static License create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.time start, ai.greycat.std.core.time end, java.lang.String company, java.lang.Long max_memory, java.lang.Long extra_1, java.lang.Long extra_2, ai.greycat.std.runtime.LicenseType type){
				return new License(greycat.libs_by_name.get(ai.greycat.std.name).mapped[43], name, start, end, company, max_memory, extra_1, extra_2, type);
			}
		}
		public static final class Task extends GreyCat.Object {
			...
			public static Task create(ai.greycat.GreyCat greycat, java.lang.Long user_id, java.lang.Long task_id, java.lang.String mod, java.lang.String type, java.lang.String fun, ai.greycat.std.core.time creation, ai.greycat.std.core.time start, ai.greycat.std.core.duration duration, ai.greycat.std.runtime.TaskStatus status){
				return new Task(greycat.libs_by_name.get(ai.greycat.std.name).mapped[44], user_id, task_id, mod, type, fun, creation, start, duration, status);
			}
		}
		public static final class DebugInfo extends GreyCat.Object {
			...
			public static DebugInfo create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array<ai.greycat.std.runtime.DebugFrame> scopes, java.lang.Object root){
				return new DebugInfo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[45], scopes, root);
			}
		}
		public static final class Runtime extends GreyCat.Object {
			...
			public static Runtime create(ai.greycat.GreyCat greycat){
				return new Runtime(greycat.libs_by_name.get(ai.greycat.std.name).mapped[46]);
			}
		}
		public static final class StoreStat extends GreyCat.Object {
			...
			public static StoreStat create(ai.greycat.GreyCat greycat, java.lang.Long capacity_bytes, java.lang.Long allocated_bytes, java.lang.Double allocated_ratio, java.lang.Long remained_bytes, java.lang.Double remained_ratio, java.lang.Long used_bytes, java.lang.Double used_ratio, java.lang.Long available_bytes, java.lang.Double available_ratio){
				return new StoreStat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[47], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio);
			}
		}
		...
		public static final class LicenseType extends GreyCat.Enum {
			...
			public static LicenseType create(ai.greycat.GreyCat greycat){
				return new LicenseType(greycat.libs_by_name.get(ai.greycat.std.name).mapped[49]);
			}
		}
		public static final class TaskStatus extends GreyCat.Enum {
			...
			public static ai.greycat.std.runtime.TaskStatus empty(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[50];
			...
			public static TaskStatus create(ai.greycat.GreyCat greycat){
				return new TaskStatus(greycat.libs_by_name.get(ai.greycat.std.name).mapped[50]);
			}
		}
		public static final class SecurityFields extends GreyCat.Object {
			...
			public static SecurityFields create(ai.greycat.GreyCat greycat, java.lang.String email, java.lang.String name, java.lang.String first_name, java.lang.String last_name, ai.greycat.std.core.Map<java.lang.String, java.lang.String> roles, ai.greycat.std.core.Map<java.lang.String, java.lang.String> groups){
				return new SecurityFields(greycat.libs_by_name.get(ai.greycat.std.name).mapped[51], email, name, first_name, last_name, roles, groups);
			}
		}
		public static final class OpenIDConnect extends GreyCat.Object {
			...
			public static OpenIDConnect create(ai.greycat.GreyCat greycat, java.lang.String url, java.lang.String clientId){
				return new OpenIDConnect(greycat.libs_by_name.get(ai.greycat.std.name).mapped[52], url, clientId);
			}
		}
		...
		public static final class Debug extends GreyCat.Object {
			...
			public static Debug create(ai.greycat.GreyCat greycat){
				return new Debug(greycat.libs_by_name.get(ai.greycat.std.name).mapped[54]);
			}
		}
		public static final class SecurityPolicy extends GreyCat.Object {
			...
			public static SecurityPolicy create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array<ai.greycat.std.runtime.SecurityEntity> entities, ai.greycat.std.core.Map<java.lang.String, ai.greycat.std.runtime.UserCredential> credentials, ai.greycat.std.core.Map<java.lang.String, ai.greycat.std.runtime.UserRole> roles, ai.greycat.std.runtime.SecurityFields fields, ai.greycat.std.core.Map<java.lang.String, java.lang.String> keys, ai.greycat.std.core.time keys_last_refresh){
				return new SecurityPolicy(greycat.libs_by_name.get(ai.greycat.std.name).mapped[55], entities, credentials, roles, fields, keys, keys_last_refresh);
			}
		}
		...
		public static final class RuntimeInfo extends GreyCat.Object {
			...
			public static RuntimeInfo create(ai.greycat.GreyCat greycat, java.lang.String version, java.lang.String program_version, java.lang.String arch, ai.greycat.std.core.TimeZone timezone, ai.greycat.std.runtime.License license, java.lang.Long io_threads, java.lang.Long bg_threads, java.lang.Long fg_threads, java.lang.Long mem_total, java.lang.Long mem_worker, java.lang.Long nb_ctx, ai.greycat.std.runtime.StoreStat store_stats){
				return new RuntimeInfo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[57], version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
			}
		}
		public static final class User extends GreyCat.Object {
			...
			public static User create(ai.greycat.GreyCat greycat, java.lang.Long id, java.lang.String name, java.lang.Boolean activated, java.lang.String full_name, java.lang.String email, java.lang.String role, java.lang.Long permissions_flags, ai.greycat.std.core.Array<ai.greycat.std.runtime.UserGroupPolicy> groups, java.lang.Long groups_flags, java.lang.Boolean external){
				return new User(greycat.libs_by_name.get(ai.greycat.std.name).mapped[58], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external);
			}
		}
		public static final class DebugBreakpoint extends GreyCat.Object {
			...
			public static DebugBreakpoint create(ai.greycat.GreyCat greycat, java.lang.String module, java.lang.Long line, java.lang.Long column){
				return new DebugBreakpoint(greycat.libs_by_name.get(ai.greycat.std.name).mapped[59], module, line, column);
			}
		}
		public static final class UserGroup extends GreyCat.Object {
			...
			public static UserGroup create(ai.greycat.GreyCat greycat, java.lang.Long id, java.lang.String name, java.lang.Boolean activated){
				return new UserGroup(greycat.libs_by_name.get(ai.greycat.std.name).mapped[60], id, name, activated);
			}
		}
		public static final class TaskResult extends GreyCat.Object {
			...
			public static TaskResult create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array values, java.lang.Long errors){
				return new TaskResult(greycat.libs_by_name.get(ai.greycat.std.name).mapped[61], values, errors);
			}
		}
		public static final class TaskBase extends GreyCat.Object {
			...
			public static TaskBase create(ai.greycat.GreyCat greycat, java.lang.Long user_id, java.lang.Long task_id, java.lang.String mod, java.lang.String type, java.lang.String fun, ai.greycat.std.core.time creation, ai.greycat.std.core.time start, ai.greycat.std.core.duration duration, ai.greycat.std.runtime.TaskStatus status){
				return new TaskBase(greycat.libs_by_name.get(ai.greycat.std.name).mapped[62], user_id, task_id, mod, type, fun, creation, start, duration, status);
			}
		}
		public static final class UserRole extends GreyCat.Object {
			...
			public static UserRole create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.Array<java.lang.String> permissions){
				return new UserRole(greycat.libs_by_name.get(ai.greycat.std.name).mapped[63], name, permissions);
			}
		}
		public static final class TaskInfo extends GreyCat.Object {
			...
			public static TaskInfo create(ai.greycat.GreyCat greycat, java.lang.Long user_id, java.lang.Long task_id, java.lang.String mod, java.lang.String type, java.lang.String fun, ai.greycat.std.core.time creation, ai.greycat.std.core.time start, ai.greycat.std.core.duration duration, ai.greycat.std.runtime.TaskStatus status, java.lang.Double progress, ai.greycat.std.core.duration remaining, java.lang.Long sub_waiting, java.lang.Long sub_tasks_all){
				return new TaskInfo(greycat.libs_by_name.get(ai.greycat.std.name).mapped[64], user_id, task_id, mod, type, fun, creation, start, duration, status, progress, remaining, sub_waiting, sub_tasks_all);
			}
		}
		public static final class PeriodicTask extends GreyCat.Object {
			...
			public ai.greycat.std.core.Array<java.lang.Object> arguments(){
				return (ai.greycat.std.core.Array<java.lang.Object>)super.get(super.type.generated_offsets[2]);
			}
			public void set_arguments(ai.greycat.std.core.Array<java.lang.Object> v){
				super.set(super.type.generated_offsets[2],v);
			}
			...
			public static PeriodicTask create(ai.greycat.GreyCat greycat, ai.greycat.std.core.function function, java.lang.Long user_id, ai.greycat.std.core.Array<java.lang.Object> arguments, ai.greycat.std.core.time start, ai.greycat.std.core.duration every){
				return new PeriodicTask(greycat.libs_by_name.get(ai.greycat.std.name).mapped[65], function, user_id, arguments, start, every);
			}
		}
		public static final class DebugFrame extends GreyCat.Object {
			...
			public ai.greycat.std.core.Map<java.lang.String, java.lang.Object> scope(){
				return (ai.greycat.std.core.Map<java.lang.String, java.lang.Object>)super.get(super.type.generated_offsets[3]);
			}
			public void set_scope(ai.greycat.std.core.Map<java.lang.String, java.lang.Object> v){
				super.set(super.type.generated_offsets[3],v);
			}
			public static DebugFrame create(ai.greycat.GreyCat greycat, java.lang.String module, java.lang.Long line, java.lang.Long column, ai.greycat.std.core.Map<java.lang.String, java.lang.Object> scope){
				return new DebugFrame(greycat.libs_by_name.get(ai.greycat.std.name).mapped[66], module, line, column, scope);
			}
		}
		public static final class TaskMode extends GreyCat.Enum {
			...
			public static ai.greycat.std.runtime.TaskMode commit(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[67];
			...
			public static TaskMode create(ai.greycat.GreyCat greycat){
				return new TaskMode(greycat.libs_by_name.get(ai.greycat.std.name).mapped[67]);
			}
		}
		public static final class UserGroupPolicyType extends GreyCat.Enum {
			...
			public static ai.greycat.std.runtime.UserGroupPolicyType read(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[68];
			...
			public static UserGroupPolicyType create(ai.greycat.GreyCat greycat){
				return new UserGroupPolicyType(greycat.libs_by_name.get(ai.greycat.std.name).mapped[68]);
			}
		}
	}
	public static final class io {
		public static final class CsvColumnDate extends GreyCat.Object {
			...
			public static CsvColumnDate create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Long offset, java.lang.String format, ai.greycat.std.core.TimeZone tz, java.lang.Boolean as_time){
				return new CsvColumnDate(greycat.libs_by_name.get(ai.greycat.std.name).mapped[69], name, mandatory, offset, format, tz, as_time);
			}
		}
		public static final class CsvColumnStatistics extends GreyCat.Object {
			...
			public ai.greycat.std.core.Map<java.lang.String, java.lang.Long> date_format_count(){
				return (ai.greycat.std.core.Map<java.lang.String, java.lang.Long>)super.get(super.type.generated_offsets[8]);
			}
			...
			public static CsvColumnStatistics create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Object example, java.lang.Long null_count, java.lang.Long bool_count, java.lang.Long int_count, java.lang.Long float_count, java.lang.Long string_count, java.lang.Long date_count, ai.greycat.std.core.Map<java.lang.String, java.lang.Long> date_format_count, ai.greycat.std.core.Map<java.lang.Object, java.lang.Long> enumerable_count, ai.greycat.std.util.Gaussian profile){
				return new CsvColumnStatistics(greycat.libs_by_name.get(ai.greycat.std.name).mapped[70], name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, enumerable_count, profile);
			}
		}
		public static final class CsvFormat extends GreyCat.Object {
			...
			public static java.lang.String generate(ai.greycat.GreyCat greycat,ai.greycat.std.io.CsvFormat format,java.lang.Long ident_col,java.lang.Long time_col) throws java.io.IOException {
				return (java.lang.String) greycat.call("io::CsvFormat::generate", format, ident_col, time_col);
			}
			public static ai.greycat.std.io.CsvValidateResult validate(ai.greycat.GreyCat greycat,java.lang.String path,ai.greycat.std.io.CsvFormat format,java.lang.Long max_rows,java.lang.Long max_invalid,java.lang.String invalid_path) throws java.io.IOException {
			...
			public static ai.greycat.std.core.Table sample(ai.greycat.GreyCat greycat,java.lang.String path,ai.greycat.std.io.CsvFormat format,java.lang.Long offset,java.lang.Long max) throws java.io.IOException {
			...
			public static CsvFormat create(ai.greycat.GreyCat greycat, java.lang.Long header_lines, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, java.lang.Long columns_size, ai.greycat.std.core.Array<ai.greycat.std.io.CsvColumn> columns){
				return new CsvFormat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[71], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns);
			}
		}
		public static final class CsvStatistics extends GreyCat.Object {
			...
			public static CsvStatistics create(ai.greycat.GreyCat greycat, java.lang.Long header_lines, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, ai.greycat.std.core.Array<ai.greycat.std.io.CsvColumnStatistics> columns, java.lang.Long line_count, java.lang.Long fail_count, java.lang.Long file_count){
				return new CsvStatistics(greycat.libs_by_name.get(ai.greycat.std.name).mapped[72], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns, line_count, fail_count, file_count);
			}
		}
		public static final class Url extends GreyCat.Object {
			...
			public static Url create(ai.greycat.GreyCat greycat, java.lang.String protocol, java.lang.String host, java.lang.Long port, java.lang.String path, ai.greycat.std.core.Map<java.lang.String, java.lang.String> params, java.lang.String hash){
				return new Url(greycat.libs_by_name.get(ai.greycat.std.name).mapped[73], protocol, host, port, path, params, hash);
			}
		}
		public static final class SmtpAuth extends GreyCat.Enum {
			...
			public static SmtpAuth create(ai.greycat.GreyCat greycat){
				return new SmtpAuth(greycat.libs_by_name.get(ai.greycat.std.name).mapped[74]);
			}
		}
		public static final class Email extends GreyCat.Object {
			...
			public static Email create(ai.greycat.GreyCat greycat, java.lang.String from, java.lang.String subject, java.lang.String body, java.lang.Boolean body_is_html, ai.greycat.std.core.Array<java.lang.String> to, ai.greycat.std.core.Array<java.lang.String> cc, ai.greycat.std.core.Array<java.lang.String> bcc){
				return new Email(greycat.libs_by_name.get(ai.greycat.std.name).mapped[75], from, subject, body, body_is_html, to, cc, bcc);
			}
		}
		public static final class CsvColumnTime extends GreyCat.Object {
			...
			public static CsvColumnTime create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Long offset, ai.greycat.std.core.DurationUnit unit){
				return new CsvColumnTime(greycat.libs_by_name.get(ai.greycat.std.name).mapped[76], name, mandatory, offset, unit);
			}
		}
		public static final class CsvColumn extends GreyCat.Object {
			...
			public static CsvColumn create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Long offset){
				return new CsvColumn(greycat.libs_by_name.get(ai.greycat.std.name).mapped[77], name, mandatory, offset);
			}
		}
		public static final class CsvAnalysis extends GreyCat.Object {
			...
			public static ai.greycat.std.io.CsvStatistics analyze(ai.greycat.GreyCat greycat,java.lang.String file_path,ai.greycat.std.io.CsvAnalysisConfig config) throws java.io.IOException {
				return (ai.greycat.std.io.CsvStatistics) greycat.call("io::CsvAnalysis::analyze", file_path, config);
			}
			public static CsvAnalysis create(ai.greycat.GreyCat greycat, ai.greycat.std.io.CsvAnalysisConfig config, ai.greycat.std.io.CsvStatistics statistics){
				return new CsvAnalysis(greycat.libs_by_name.get(ai.greycat.std.name).mapped[78], config, statistics);
			}
		}
		public static final class HttpHeader extends GreyCat.Object {
			...
			public static HttpHeader create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.String value){
				return new HttpHeader(greycat.libs_by_name.get(ai.greycat.std.name).mapped[79], name, value);
			}
		}
		public static final class Mqtt extends GreyCat.Object {
			public static final java.lang.String name = "io::Mqtt";
			private Mqtt(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			public static Mqtt create(ai.greycat.GreyCat greycat){
				return new Mqtt(greycat.libs_by_name.get(ai.greycat.std.name).mapped[80]);
			}
		}
		public static final class CsvValidateResult extends GreyCat.Object {
			...
			public static CsvValidateResult create(ai.greycat.GreyCat greycat, java.lang.Long line_count, java.lang.Long fail_count, ai.greycat.std.core.Array<java.lang.Long> invalid_count){
				return new CsvValidateResult(greycat.libs_by_name.get(ai.greycat.std.name).mapped[81], line_count, fail_count, invalid_count);
			}
		}
		public static final class CsvColumnString extends GreyCat.Object {
			...
			public static CsvColumnString create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Long offset, java.lang.Boolean trim, java.lang.Boolean try_number, java.lang.Boolean try_json, ai.greycat.std.core.Array<java.lang.String> values, ai.greycat.std.io.TextEncoder encoder){
				return new CsvColumnString(greycat.libs_by_name.get(ai.greycat.std.name).mapped[82], name, mandatory, offset, trim, try_number, try_json, values, encoder);
			}
		}
		public static final class Http extends GreyCat.Object {
			...
			public static Http create(ai.greycat.GreyCat greycat){
				return new Http(greycat.libs_by_name.get(ai.greycat.std.name).mapped[83]);
			}
		}
		public static final class CsvAnalysisConfig extends GreyCat.Object {
			...
			public static CsvAnalysisConfig create(ai.greycat.GreyCat greycat, java.lang.Long header_lines, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, java.lang.Long row_limit, java.lang.Long enumerable_limit, java.lang.Long date_check_limit, ai.greycat.std.core.Array<java.lang.String> date_formats){
				return new CsvAnalysisConfig(greycat.libs_by_name.get(ai.greycat.std.name).mapped[84], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats);
			}
		}
		public static final class CsvColumnBoolean extends GreyCat.Object {
			...
			public static CsvColumnBoolean create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Long offset){
				return new CsvColumnBoolean(greycat.libs_by_name.get(ai.greycat.std.name).mapped[85], name, mandatory, offset);
			}
		}
		public static final class CsvColumnIgnored extends GreyCat.Object {
			...
			public static CsvColumnIgnored create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Long offset){
				return new CsvColumnIgnored(greycat.libs_by_name.get(ai.greycat.std.name).mapped[86], name, mandatory, offset);
			}
		}
		public static final class CsvColumnFloat extends GreyCat.Object {
			...
			public static CsvColumnFloat create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Long offset){
				return new CsvColumnFloat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[87], name, mandatory, offset);
			}
		}
		public static final class CsvColumnDuration extends GreyCat.Object {
			...
			public static CsvColumnDuration create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Long offset, ai.greycat.std.core.DurationUnit unit){
				return new CsvColumnDuration(greycat.libs_by_name.get(ai.greycat.std.name).mapped[88], name, mandatory, offset, unit);
			}
		}
		public static final class CsvColumnInteger extends GreyCat.Object {
			...
			public static CsvColumnInteger create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean mandatory, java.lang.Long offset){
				return new CsvColumnInteger(greycat.libs_by_name.get(ai.greycat.std.name).mapped[89], name, mandatory, offset);
			}
		}
		...
		public static final class Smtp extends GreyCat.Object {
			...
			public static Smtp create(ai.greycat.GreyCat greycat, java.lang.String host, java.lang.Long port, ai.greycat.std.io.SmtpMode mode, ai.greycat.std.io.SmtpAuth authenticate, java.lang.String user, java.lang.String pass){
				return new Smtp(greycat.libs_by_name.get(ai.greycat.std.name).mapped[91], host, port, mode, authenticate, user, pass);
			}
		}
		public static final class SmtpMode extends GreyCat.Enum {
			...
			public static SmtpMode create(ai.greycat.GreyCat greycat){
				return new SmtpMode(greycat.libs_by_name.get(ai.greycat.std.name).mapped[92]);
			}
		}
		public static final class File extends GreyCat.Object {
			...
			public static File create(ai.greycat.GreyCat greycat, java.lang.String path, java.lang.Long size, ai.greycat.std.core.time last_modification){
				return new File(greycat.libs_by_name.get(ai.greycat.std.name).mapped[93], path, size, last_modification);
			}
		}
	}
	public static final class math {
		public static final class MathConstants extends GreyCat.Object {
			...
			public static java.lang.Double e(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.std.name).mapped[94];
			...
			public static MathConstants create(ai.greycat.GreyCat greycat){
				return new MathConstants(greycat.libs_by_name.get(ai.greycat.std.name).mapped[94]);
			}
		}
	}
	public static final class util {
		public static final class SlidingWindow extends ai.greycat.std_n.util.SlidingWindow {
			...
			public static SlidingWindow create(ai.greycat.GreyCat greycat){
				return new SlidingWindow(greycat.libs_by_name.get(ai.greycat.std.name).mapped[95]);
			}
		}
		public static final class DenseDim extends GreyCat.Object {
			public static final java.lang.String name = "util::DenseDim";
			private DenseDim(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			...
			public java.lang.Long step(){
				return (java.lang.Long)super.get(super.type.generated_offsets[2]);
			}
			public void set_step(java.lang.Long v){
				super.set(super.type.generated_offsets[2],v);
			}
			public static DenseDim create(ai.greycat.GreyCat greycat, java.lang.Long min, java.lang.Long max, java.lang.Long step){
				return new DenseDim(greycat.libs_by_name.get(ai.greycat.std.name).mapped[96], min, max, step);
			}
		}
		public static final class Random extends GreyCat.Object {
			...
			public static Random create(ai.greycat.GreyCat greycat, java.lang.Long seed, java.lang.Double v){
				return new Random(greycat.libs_by_name.get(ai.greycat.std.name).mapped[97], seed, v);
			}
		}
		public static final class Crypto extends GreyCat.Object {
			...
			public static Crypto create(ai.greycat.GreyCat greycat){
				return new Crypto(greycat.libs_by_name.get(ai.greycat.std.name).mapped[98]);
			}
		}
		public static final class HistogramFloat extends ai.greycat.std_n.util.HistogramFloat {
			...
			public static HistogramFloat create(ai.greycat.GreyCat greycat){
				return new HistogramFloat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[99]);
			}
		}
		public static final class BoxPlotInt extends GreyCat.Object {
			...
			public static BoxPlotInt create(ai.greycat.GreyCat greycat, java.lang.Long min, java.lang.Long max, java.lang.Long whiskerLow, java.lang.Long whiskerHigh, java.lang.Long percentile1, java.lang.Long percentile5, java.lang.Long percentile25, java.lang.Long percentile50, java.lang.Long percentile75, java.lang.Long percentile95, java.lang.Long percentile99, java.lang.Long countOutliersLow, java.lang.Long countOutliersHigh, java.lang.Double percentageOutliersLow, java.lang.Double percentageOutliersHigh, java.lang.Double sum, java.lang.Double avg, java.lang.Double std, java.lang.Long size){
				return new BoxPlotInt(greycat.libs_by_name.get(ai.greycat.std.name).mapped[100], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
			}
		}
		public static final class Assert extends GreyCat.Object {
			...
			public static Assert create(ai.greycat.GreyCat greycat){
				return new Assert(greycat.libs_by_name.get(ai.greycat.std.name).mapped[101]);
			}
		}
		public static final class ProgressTracker extends GreyCat.Object {
			...
			public static ProgressTracker create(ai.greycat.GreyCat greycat, ai.greycat.std.core.time start, java.lang.Long total, java.lang.Long counter, ai.greycat.std.core.duration duration, java.lang.Double progress, java.lang.Double speed, ai.greycat.std.core.duration remaining){
				return new ProgressTracker(greycat.libs_by_name.get(ai.greycat.std.name).mapped[102], start, total, counter, duration, progress, speed, remaining);
			}
		}
		public static final class Gaussian extends GreyCat.Object {
			...
			public static Gaussian create(ai.greycat.GreyCat greycat, java.lang.Double sum, java.lang.Double sum_sq, java.lang.Long count, java.lang.Double min, java.lang.Double max){
				return new Gaussian(greycat.libs_by_name.get(ai.greycat.std.name).mapped[103], sum, sum_sq, count, min, max);
			}
		}
		public static final class GaussianProfile extends ai.greycat.std_n.util.GaussianProfile {
			...
			public static GaussianProfile create(ai.greycat.GreyCat greycat){
				return new GaussianProfile(greycat.libs_by_name.get(ai.greycat.std.name).mapped[104]);
			}
		}
		public static final class TimeWindow extends ai.greycat.std_n.util.TimeWindow {
			...
			public static TimeWindow create(ai.greycat.GreyCat greycat){
				return new TimeWindow(greycat.libs_by_name.get(ai.greycat.std.name).mapped[105]);
			}
		}
		...
		public static final class Plot extends GreyCat.Object {
			...
			public static Plot create(ai.greycat.GreyCat greycat){
				return new Plot(greycat.libs_by_name.get(ai.greycat.std.name).mapped[107]);
			}
		}
		public static final class Iban extends ai.greycat.std_n.util.Iban {
			...
			public static Iban create(ai.greycat.GreyCat greycat){
				return new Iban(greycat.libs_by_name.get(ai.greycat.std.name).mapped[108]);
			}
		}
		public static final class Queue<T> extends ai.greycat.std_n.util.Queue<T> {
			...
			public static <T>Queue<T> create(ai.greycat.GreyCat greycat){
				return new Queue<>(greycat.libs_by_name.get(ai.greycat.std.name).mapped[109]);
			}
		}
		public static final class BoxPlotFloat extends GreyCat.Object {
			...
			public static BoxPlotFloat create(ai.greycat.GreyCat greycat, java.lang.Double min, java.lang.Double max, java.lang.Double whiskerLow, java.lang.Double whiskerHigh, java.lang.Double percentile1, java.lang.Double percentile5, java.lang.Double percentile25, java.lang.Double percentile50, java.lang.Double percentile75, java.lang.Double percentile95, java.lang.Double percentile99, java.lang.Long countOutliersLow, java.lang.Long countOutliersHigh, java.lang.Double percentageOutliersLow, java.lang.Double percentageOutliersHigh, java.lang.Double sum, java.lang.Double avg, java.lang.Double std, java.lang.Long size){
				return new BoxPlotFloat(greycat.libs_by_name.get(ai.greycat.std.name).mapped[110], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
			}
		}
		public static final class HistogramInt extends ai.greycat.std_n.util.HistogramInt {
			...
			public static HistogramInt create(ai.greycat.GreyCat greycat){
				return new HistogramInt(greycat.libs_by_name.get(ai.greycat.std.name).mapped[111]);
			}
		}
	}
	@Override
	public void configure(java.util.Map<String, ai.greycat.GreyCat.Loader> loaders, java.util.Map<String, ai.greycat.GreyCat.Factory> factories) {
		...
		factories.put(core.Date2.name, core.Date2::new);
		...
		factories.put(io.Mqtt.name, io.Mqtt::new);
		...
		factories.put(util.DenseDim.name, util.DenseDim::new);
	...
	public void init(ai.greycat.GreyCat greycat) {
		this.mapped = new ai.greycat.GreyCat.Type[112];
		this.mapped[0] = greycat.types_by_name.get(core.String.name);
		this.mapped[1] = greycat.types_by_name.get(core.Error.name);
		this.mapped[2] = greycat.types_by_name.get(core.GeoCircle.name);
		if(this.mapped[2] != null){
			this.mapped[2].resolveGeneratedOffsets("center","radius");
		}
		this.mapped[3] = greycat.types_by_name.get(core.Array.name);
		this.mapped[4] = greycat.types_by_name.get(core.ErrorCode.name);
		if(this.mapped[4] != null){
			this.mapped[4].resolveGeneratedOffsetWithValues("none", 0L,"interrupted", 1L,"await", 2L,"too_deep_iterator", 3L,"wrong_operand", 4L,"wrong_params", 5L,"wrong_param_type", 6L,"wrong_numeric", 7L,"wrong_state", 8L,"wrong_null", 9L,"unresolved_ref", 10L,"throw", 12L,"wrong_type", 13L,"wrong_dimension", 14L,"unsupported_operation", 15L,"unsupported_type", 16L,"dimensions_mismatch", 17L,"timeout", 18L,"forbidden", 19L,"runtime_error", 20L);
		}
		this.mapped[5] = greycat.types_by_name.get(core.geo.name);
		if(this.mapped[5] != null){
			this.mapped[5].static_values = new java.lang.Object[]{greycat.createGeo(java.lang.Double.longBitsToDouble(-4587686678796158022L),java.lang.Double.longBitsToDouble(-4582834833316020224L)),greycat.createGeo(java.lang.Double.longBitsToDouble(4635685358058617786L),java.lang.Double.longBitsToDouble(4640537203538755584L))};
		}
		this.mapped[6] = greycat.types_by_name.get(core.ti4d.name);
		this.mapped[7] = greycat.types_by_name.get(core.nodeTime.name);
		this.mapped[8] = greycat.types_by_name.get(core.Date.name);
		this.mapped[9] = greycat.types_by_name.get(core.TimeZone.name);
		...
		this.mapped[10] = greycat.types_by_name.get(core.Table.name);
		this.mapped[11] = greycat.types_by_name.get(core.ti6d.name);
		this.mapped[12] = greycat.types_by_name.get(core.nodeGeo.name);
		this.mapped[13] = greycat.types_by_name.get(core.duration.name);
		this.mapped[14] = greycat.types_by_name.get(core.Date2.name);
		if(this.mapped[14] != null){
			this.mapped[14].resolveGeneratedOffsets("year","month","day","hour","minute","second","microsecond");
		}
		this.mapped[15] = greycat.types_by_name.get(core.DurationUnit.name);
		if(this.mapped[15] != null){
			this.mapped[15].resolveGeneratedOffsetWithValues("microseconds", 1L,"milliseconds", 1000L,"seconds", 1000000L,"minutes", 60000000L,"hours", 3600000000L,"days", 86400000000L,"weeks", 604800000000L,"months", 2628000000000L,"years", 31536000000000L);
		}
		this.mapped[16] = greycat.types_by_name.get(core.tf3d.name);
		this.mapped[17] = greycat.types_by_name.get(core.Tensor.name);
		this.mapped[18] = greycat.types_by_name.get(core.ti2d.name);
		this.mapped[19] = greycat.types_by_name.get(core.Map.name);
		this.mapped[20] = greycat.types_by_name.get(core.nodeIndex.name);
		this.mapped[21] = greycat.types_by_name.get(core.tf4d.name);
		this.mapped[22] = greycat.types_by_name.get(core.TableColumnMapping.name);
		if(this.mapped[22] != null){
			this.mapped[22].resolveGeneratedOffsets("column","extractors");
		}
		this.mapped[23] = greycat.types_by_name.get(core.nodeList.name);
		this.mapped[24] = greycat.types_by_name.get(core.TensorType.name);
		if(this.mapped[24] != null){
			this.mapped[24].resolveGeneratedOffsetWithValues("i32", 4L,"i64", 8L,"f32", 4L,"f64", 8L,"c64", 8L,"c128", 16L);
		}
		this.mapped[25] = greycat.types_by_name.get(core.Tuple.name);
		if(this.mapped[25] != null){
			this.mapped[25].resolveGeneratedOffsets("x","y");
		}
		this.mapped[26] = greycat.types_by_name.get(core.tf2d.name);
		this.mapped[27] = greycat.types_by_name.get(core.function.name);
		this.mapped[28] = greycat.types_by_name.get(core.TableColumnMeta.name);
		if(this.mapped[28] != null){
			this.mapped[28].resolveGeneratedOffsets("type","size","index","header","min","max","avg","std");
		}
		this.mapped[29] = greycat.types_by_name.get(core.GeoBox.name);
		...
		if(this.mapped[31] != null){
			this.mapped[31].resolveGeneratedOffsets("points");
		}
		this.mapped[32] = greycat.types_by_name.get(core.nodeIndexBucket.name);
		this.mapped[33] = greycat.types_by_name.get(core.time.name);
		if(this.mapped[33] != null){
			this.mapped[33].static_values = new java.lang.Object[]{greycat.createTime(-9223372036854775808L),greycat.createTime(9223372036854775807L)};
		}
		this.mapped[34] = greycat.types_by_name.get(core.ti10d.name);
		this.mapped[35] = greycat.types_by_name.get(core.SamplingMode.name);
		if(this.mapped[35] != null){
			this.mapped[35].resolveGeneratedOffsetWithValues("fixed", 0L,"fixed_reg", 1L,"adaptative", 2L,"dense", 3L);
		}
		this.mapped[36] = greycat.types_by_name.get(core.ti5d.name);
		this.mapped[37] = greycat.types_by_name.get(core.DatePart.name);
		if(this.mapped[37] != null){
			this.mapped[37].resolveGeneratedOffsetWithValues("years", 0L,"months", 1L,"days", 2L,"hours", 3L,"minutes", 4L,"seconds", 5L,"microseconds", 6L);
		}
		this.mapped[38] = greycat.types_by_name.get(core.ti3d.name);
		this.mapped[39] = greycat.types_by_name.get(core.nodeTimeSingleton.name);
		if(this.mapped[39] != null){
			this.mapped[39].resolveGeneratedOffsets("t","v");
		}
		this.mapped[40] = greycat.types_by_name.get(core.NodeInfo.name);
		if(this.mapped[40] != null){
			this.mapped[40].resolveGeneratedOffsets("size","from","to");
		}
		this.mapped[41] = greycat.types_by_name.get(runtime.TaskRequest.name);
		if(this.mapped[41] != null){
			this.mapped[41].resolveGeneratedOffsets("function","arguments","mode");
		}
		this.mapped[42] = greycat.types_by_name.get(runtime.System.name);
		this.mapped[43] = greycat.types_by_name.get(runtime.License.name);
		if(this.mapped[43] != null){
			this.mapped[43].resolveGeneratedOffsets("name","start","end","company","max_memory","extra_1","extra_2","type");
		}
		this.mapped[44] = greycat.types_by_name.get(runtime.Task.name);
		if(this.mapped[44] != null){
			this.mapped[44].resolveGeneratedOffsets("user_id","task_id","mod","type","fun","creation","start","duration","status");
		}
		this.mapped[45] = greycat.types_by_name.get(runtime.DebugInfo.name);
		if(this.mapped[45] != null){
			this.mapped[45].resolveGeneratedOffsets("scopes","root");
		}
		this.mapped[46] = greycat.types_by_name.get(runtime.Runtime.name);
		this.mapped[47] = greycat.types_by_name.get(runtime.StoreStat.name);
		if(this.mapped[47] != null){
			this.mapped[47].resolveGeneratedOffsets("capacity_bytes","allocated_bytes","allocated_ratio","remained_bytes","remained_ratio","used_bytes","used_ratio","available_bytes","available_ratio");
		}
		...
		this.mapped[49] = greycat.types_by_name.get(runtime.LicenseType.name);
		if(this.mapped[49] != null){
			this.mapped[49].resolveGeneratedOffsetWithValues("community", 0L,"enterprise", 1L,"testing", 2L);
		}
		this.mapped[50] = greycat.types_by_name.get(runtime.TaskStatus.name);
		if(this.mapped[50] != null){
			this.mapped[50].resolveGeneratedOffsetWithValues("empty", 0L,"waiting", 1L,"running", 2L,"cancelled", 3L,"error", 4L,"ended", 5L,"ended_with_errors", 6L);
		}
		this.mapped[51] = greycat.types_by_name.get(runtime.SecurityFields.name);
		if(this.mapped[51] != null){
			this.mapped[51].resolveGeneratedOffsets("email","name","first_name","last_name","roles","groups");
		}
		this.mapped[52] = greycat.types_by_name.get(runtime.OpenIDConnect.name);
		if(this.mapped[52] != null){
			this.mapped[52].resolveGeneratedOffsets("url","clientId");
		}
		...
		this.mapped[54] = greycat.types_by_name.get(runtime.Debug.name);
		this.mapped[55] = greycat.types_by_name.get(runtime.SecurityPolicy.name);
		if(this.mapped[55] != null){
			this.mapped[55].resolveGeneratedOffsets("entities","credentials","roles","fields","keys","keys_last_refresh");
		}
		...
		this.mapped[57] = greycat.types_by_name.get(runtime.RuntimeInfo.name);
		if(this.mapped[57] != null){
			this.mapped[57].resolveGeneratedOffsets("version","program_version","arch","timezone","license","io_threads","bg_threads","fg_threads","mem_total","mem_worker","nb_ctx","store_stats");
		}
		this.mapped[58] = greycat.types_by_name.get(runtime.User.name);
		if(this.mapped[58] != null){
			this.mapped[58].resolveGeneratedOffsets("id","name","activated","full_name","email","role","permissions_flags","groups","groups_flags","external");
		}
		this.mapped[59] = greycat.types_by_name.get(runtime.DebugBreakpoint.name);
		if(this.mapped[59] != null){
			this.mapped[59].resolveGeneratedOffsets("module","line","column");
		}
		this.mapped[60] = greycat.types_by_name.get(runtime.UserGroup.name);
		if(this.mapped[60] != null){
			this.mapped[60].resolveGeneratedOffsets("id","name","activated");
		}
		this.mapped[61] = greycat.types_by_name.get(runtime.TaskResult.name);
		if(this.mapped[61] != null){
			this.mapped[61].resolveGeneratedOffsets("values","errors");
		}
		this.mapped[62] = greycat.types_by_name.get(runtime.TaskBase.name);
		if(this.mapped[62] != null){
			this.mapped[62].resolveGeneratedOffsets("user_id","task_id","mod","type","fun","creation","start","duration","status");
		}
		this.mapped[63] = greycat.types_by_name.get(runtime.UserRole.name);
		if(this.mapped[63] != null){
			this.mapped[63].resolveGeneratedOffsets("name","permissions");
		}
		this.mapped[64] = greycat.types_by_name.get(runtime.TaskInfo.name);
		if(this.mapped[64] != null){
			this.mapped[64].resolveGeneratedOffsets("user_id","task_id","mod","type","fun","creation","start","duration","status","progress","remaining","sub_waiting","sub_tasks_all");
		}
		this.mapped[65] = greycat.types_by_name.get(runtime.PeriodicTask.name);
		if(this.mapped[65] != null){
			this.mapped[65].resolveGeneratedOffsets("function","user_id","arguments","start","every");
		}
		this.mapped[66] = greycat.types_by_name.get(runtime.DebugFrame.name);
		if(this.mapped[66] != null){
			this.mapped[66].resolveGeneratedOffsets("module","line","column","scope");
		}
		this.mapped[67] = greycat.types_by_name.get(runtime.TaskMode.name);
		if(this.mapped[67] != null){
			this.mapped[67].resolveGeneratedOffsetWithValues("commit", null,"volatile", null,"exclusive", null);
		}
		this.mapped[68] = greycat.types_by_name.get(runtime.UserGroupPolicyType.name);
		if(this.mapped[68] != null){
			this.mapped[68].resolveGeneratedOffsetWithValues("read", 0L,"write", 1L,"execute", 2L);
		}
		this.mapped[69] = greycat.types_by_name.get(io.CsvColumnDate.name);
		if(this.mapped[69] != null){
			this.mapped[69].resolveGeneratedOffsets("name","mandatory","offset","format","tz","as_time");
		}
		this.mapped[70] = greycat.types_by_name.get(io.CsvColumnStatistics.name);
		...
		this.mapped[71] = greycat.types_by_name.get(io.CsvFormat.name);
		if(this.mapped[71] != null){
			this.mapped[71].resolveGeneratedOffsets("header_lines","separator","string_delimiter","decimal_separator","thousands_separator","columns_size","columns");
		}
		this.mapped[72] = greycat.types_by_name.get(io.CsvStatistics.name);
		if(this.mapped[72] != null){
			this.mapped[72].resolveGeneratedOffsets("header_lines","separator","string_delimiter","decimal_separator","thousands_separator","columns","line_count","fail_count","file_count");
		}
		this.mapped[73] = greycat.types_by_name.get(io.Url.name);
		if(this.mapped[73] != null){
			this.mapped[73].resolveGeneratedOffsets("protocol","host","port","path","params","hash");
		}
		this.mapped[74] = greycat.types_by_name.get(io.SmtpAuth.name);
		if(this.mapped[74] != null){
			this.mapped[74].resolveGeneratedOffsetWithValues("none", 0L,"plain", 1L,"login", 2L);
		}
		this.mapped[75] = greycat.types_by_name.get(io.Email.name);
		if(this.mapped[75] != null){
			this.mapped[75].resolveGeneratedOffsets("from","subject","body","body_is_html","to","cc","bcc");
		}
		this.mapped[76] = greycat.types_by_name.get(io.CsvColumnTime.name);
		if(this.mapped[76] != null){
			this.mapped[76].resolveGeneratedOffsets("name","mandatory","offset","unit");
		}
		this.mapped[77] = greycat.types_by_name.get(io.CsvColumn.name);
		if(this.mapped[77] != null){
			this.mapped[77].resolveGeneratedOffsets("name","mandatory","offset");
		}
		this.mapped[78] = greycat.types_by_name.get(io.CsvAnalysis.name);
		if(this.mapped[78] != null){
			this.mapped[78].resolveGeneratedOffsets("config","statistics");
		}
		this.mapped[79] = greycat.types_by_name.get(io.HttpHeader.name);
		if(this.mapped[79] != null){
			this.mapped[79].resolveGeneratedOffsets("name","value");
		}
		this.mapped[80] = greycat.types_by_name.get(io.Mqtt.name);
		this.mapped[81] = greycat.types_by_name.get(io.CsvValidateResult.name);
		if(this.mapped[81] != null){
			this.mapped[81].resolveGeneratedOffsets("line_count","fail_count","invalid_count");
		}
		this.mapped[82] = greycat.types_by_name.get(io.CsvColumnString.name);
		if(this.mapped[82] != null){
			this.mapped[82].resolveGeneratedOffsets("name","mandatory","offset","trim","try_number","try_json","values","encoder");
		}
		this.mapped[83] = greycat.types_by_name.get(io.Http.name);
		this.mapped[84] = greycat.types_by_name.get(io.CsvAnalysisConfig.name);
		if(this.mapped[84] != null){
			this.mapped[84].resolveGeneratedOffsets("header_lines","separator","string_delimiter","decimal_separator","thousands_separator","row_limit","enumerable_limit","date_check_limit","date_formats");
		}
		if(this.mapped[84] != null){
			this.mapped[84].static_values = new java.lang.Object[]{100L,100L};
		}
		this.mapped[85] = greycat.types_by_name.get(io.CsvColumnBoolean.name);
		if(this.mapped[85] != null){
			this.mapped[85].resolveGeneratedOffsets("name","mandatory","offset");
		}
		this.mapped[86] = greycat.types_by_name.get(io.CsvColumnIgnored.name);
		if(this.mapped[86] != null){
			this.mapped[86].resolveGeneratedOffsets("name","mandatory","offset");
		}
		this.mapped[87] = greycat.types_by_name.get(io.CsvColumnFloat.name);
		if(this.mapped[87] != null){
			this.mapped[87].resolveGeneratedOffsets("name","mandatory","offset");
		}
		this.mapped[88] = greycat.types_by_name.get(io.CsvColumnDuration.name);
		if(this.mapped[88] != null){
			this.mapped[88].resolveGeneratedOffsets("name","mandatory","offset","unit");
		}
		this.mapped[89] = greycat.types_by_name.get(io.CsvColumnInteger.name);
		if(this.mapped[89] != null){
			this.mapped[89].resolveGeneratedOffsets("name","mandatory","offset");
		}
		this.mapped[90] = greycat.types_by_name.get(io.TextEncoder.name);
		...
		this.mapped[91] = greycat.types_by_name.get(io.Smtp.name);
		if(this.mapped[91] != null){
			this.mapped[91].resolveGeneratedOffsets("host","port","mode","authenticate","user","pass");
		}
		this.mapped[92] = greycat.types_by_name.get(io.SmtpMode.name);
		if(this.mapped[92] != null){
			this.mapped[92].resolveGeneratedOffsetWithValues("plain", 0L,"ssl_tls", 1L,"starttls", 2L);
		}
		this.mapped[93] = greycat.types_by_name.get(io.File.name);
		if(this.mapped[93] != null){
			this.mapped[93].resolveGeneratedOffsets("path","size","last_modification");
		}
		this.mapped[94] = greycat.types_by_name.get(math.MathConstants.name);
		if(this.mapped[94] != null){
			this.mapped[94].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4613303445314885481L),java.lang.Double.longBitsToDouble(4609176140021203710L),java.lang.Double.longBitsToDouble(4601495173785380110L),java.lang.Double.longBitsToDouble(4604418534313441775L),java.lang.Double.longBitsToDouble(4612367379483415830L),java.lang.Double.longBitsToDouble(4614256656552045848L),java.lang.Double.longBitsToDouble(4609753056924675352L),java.lang.Double.longBitsToDouble(4605249457297304856L),java.lang.Double.longBitsToDouble(4599405781057128579L),java.lang.Double.longBitsToDouble(4603909380684499075L),java.lang.Double.longBitsToDouble(4607760587169110893L),java.lang.Double.longBitsToDouble(4609047870845172685L),java.lang.Double.longBitsToDouble(4604544271217802189L)};
		}
		this.mapped[95] = greycat.types_by_name.get(util.SlidingWindow.name);
		this.mapped[96] = greycat.types_by_name.get(util.DenseDim.name);
		if(this.mapped[96] != null){
			this.mapped[96].resolveGeneratedOffsets("min","max","step");
		}
		this.mapped[97] = greycat.types_by_name.get(util.Random.name);
		if(this.mapped[97] != null){
			this.mapped[97].resolveGeneratedOffsets("seed","v");
		}
		this.mapped[98] = greycat.types_by_name.get(util.Crypto.name);
		this.mapped[99] = greycat.types_by_name.get(util.HistogramFloat.name);
		if(this.mapped[99] != null){
			this.mapped[99].static_values = new java.lang.Object[]{0L,1L,2L,3L};
		}
		this.mapped[100] = greycat.types_by_name.get(util.BoxPlotInt.name);
		...
		this.mapped[102] = greycat.types_by_name.get(util.ProgressTracker.name);
		if(this.mapped[102] != null){
			this.mapped[102].resolveGeneratedOffsets("start","total","counter","duration","progress","speed","remaining");
		}
		this.mapped[103] = greycat.types_by_name.get(util.Gaussian.name);
		if(this.mapped[103] != null){
			this.mapped[103].resolveGeneratedOffsets("sum","sum_sq","count","min","max");
		}
		this.mapped[104] = greycat.types_by_name.get(util.GaussianProfile.name);
		if(this.mapped[104] != null){
			this.mapped[104].static_values = new java.lang.Object[]{0L,1L,2L,3L,4L,5L,6L};
		}
		this.mapped[105] = greycat.types_by_name.get(util.TimeWindow.name);
		this.mapped[106] = greycat.types_by_name.get(util.Buffer.name);
		this.mapped[107] = greycat.types_by_name.get(util.Plot.name);
		this.mapped[108] = greycat.types_by_name.get(util.Iban.name);
		this.mapped[109] = greycat.types_by_name.get(util.Queue.name);
		this.mapped[110] = greycat.types_by_name.get(util.BoxPlotFloat.name);
		if(this.mapped[110] != null){
			this.mapped[110].resolveGeneratedOffsets("min","max","whiskerLow","whiskerHigh","percentile1","percentile5","percentile25","percentile50","percentile75","percentile95","percentile99","countOutliersLow","countOutliersHigh","percentageOutliersLow","percentageOutliersHigh","sum","avg","std","size");
		}
		this.mapped[111] = greycat.types_by_name.get(util.HistogramInt.name);
		if(this.mapped[111] != null){
			this.mapped[111].static_values = new java.lang.Object[]{0L,1L,2L,3L};
		}
	}
}
