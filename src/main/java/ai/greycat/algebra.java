...
public final class algebra extends ai.greycat.GreyCat.Library {
	...
	public static final class kmeans {
		public static final class KmeanMetaResult extends GreyCat.Object {
			...
			public static KmeanMetaResult create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array<java.lang.Double> runDistances, ai.greycat.algebra.kmeans.KmeanResult bestResult){
				return new KmeanMetaResult(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[0], runDistances, bestResult);
			}
		}
		public static final class Kmeans extends GreyCat.Object {
			...
			public static Kmeans create(ai.greycat.GreyCat greycat){
				return new Kmeans(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[1]);
			}
		}
		public static final class KmeanResult extends GreyCat.Object {
			...
			public static KmeanResult create(ai.greycat.GreyCat greycat, java.lang.Double loss, ai.greycat.std.core.Array<java.lang.Double> roundsDistances, ai.greycat.std.core.Tensor centroids, ai.greycat.std.core.Tensor clusters_count, ai.greycat.std.core.Tensor clusters_sum_distance, ai.greycat.std.core.Tensor clusters_avg_distance, ai.greycat.std.core.Tensor assignement, ai.greycat.std.core.Tensor distances, ai.greycat.std.core.Tensor clusterInterDistances){
				return new KmeanResult(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[2], loss, roundsDistances, centroids, clusters_count, clusters_sum_distance, clusters_avg_distance, assignement, distances, clusterInterDistances);
			}
		}
	}
	public static final class ml {
		public static final class Polynomial extends ai.greycat.algebra_n.ml.Polynomial {
			...
			public static Polynomial create(ai.greycat.GreyCat greycat){
				return new Polynomial(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[3]);
			}
		}
		public static final class Solver extends GreyCat.Object {
			...
			public static Solver create(ai.greycat.GreyCat greycat){
				return new Solver(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[4]);
			}
		}
		public static final class TimeSeriesDecomposition extends GreyCat.Object {
			...
			public static TimeSeriesDecomposition create(ai.greycat.GreyCat greycat){
				return new TimeSeriesDecomposition(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[5]);
			}
		}
		public static final class HeatMapProfile extends GreyCat.Object {
			...
			public static HeatMapProfile create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Table<java.lang.Long> counts, ai.greycat.std.core.Array<java.lang.String> x_labels, ai.greycat.std.core.Array<java.lang.String> y_labels, java.lang.Long counts_max, java.lang.Long counts_sum){
				return new HeatMapProfile(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[6], counts, x_labels, y_labels, counts_max, counts_sum);
			}
		}
		public static final class PCA extends ai.greycat.algebra_n.ml.PCA {
			...
			public static PCA create(ai.greycat.GreyCat greycat){
				return new PCA(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[7]);
			}
		}
		public static final class GaussianND extends ai.greycat.algebra_n.ml.GaussianND {
			...
			public static GaussianND create(ai.greycat.GreyCat greycat){
				return new GaussianND(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[8]);
			}
		}
	}
	public static final class nn_layers_names {
		public static final class NNLayersNames extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.nn_layers_names.NNLayersNames layer_0(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[9];
			...
			public static NNLayersNames create(ai.greycat.GreyCat greycat){
				return new NNLayersNames(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[9]);
			}
		}
	}
	public static final class patterns {
		public static final class DTWPatternDetectionEngine extends GreyCat.Object {
			...
			public static DTWPatternDetectionEngine create(ai.greycat.GreyCat greycat, ai.greycat.std.core.nodeTime timeseries, ai.greycat.algebra.patterns.PatternDetectionEngineState state, ai.greycat.algebra.patterns.PatternNullStrategy nullStrategy, java.lang.Double nullReplaceConstant, ai.greycat.algebra.patterns.SamplingPolicy samplingPolicy, java.lang.Double std, ai.greycat.algebra.patterns.MatchingNormalisation matchingNormalisation){
				return new DTWPatternDetectionEngine(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[10], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, std, matchingNormalisation);
			}
		}
		public static final class EuclideanPatternDetectionEngine extends GreyCat.Object {
			...
			public static EuclideanPatternDetectionEngine create(ai.greycat.GreyCat greycat, ai.greycat.std.core.nodeTime timeseries, ai.greycat.algebra.patterns.PatternDetectionEngineState state, ai.greycat.algebra.patterns.PatternNullStrategy nullStrategy, java.lang.Double nullReplaceConstant, ai.greycat.algebra.patterns.SamplingPolicy samplingPolicy, ai.greycat.std.core.Array<ai.greycat.std.core.Tensor> pattern_tensors, ai.greycat.std.core.Array<ai.greycat.std.core.Tensor> window_tensors, java.lang.Double std, ai.greycat.algebra.patterns.MatchingNormalisation matchingNormalisation){
				return new EuclideanPatternDetectionEngine(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[11], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, pattern_tensors, window_tensors, std, matchingNormalisation);
			}
		}
		public static final class SamplingPolicy extends GreyCat.Enum {
			...
			public static SamplingPolicy create(ai.greycat.GreyCat greycat){
				return new SamplingPolicy(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[12]);
			}
		}
		public static final class FFTResult extends GreyCat.Object {
			...
			public static FFTResult create(ai.greycat.GreyCat greycat, java.lang.Double distance, java.lang.Long best_pattern, ai.greycat.std.core.duration best_timespan){
				return new FFTResult(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[13], distance, best_pattern, best_timespan);
			}
		}
		public static final class Detection extends GreyCat.Object {
			...
			public static Detection create(ai.greycat.GreyCat greycat, java.lang.Double score, java.lang.Long best_pattern, ai.greycat.std.core.duration timespan){
				return new Detection(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[14], score, best_pattern, timespan);
			}
		}
		public static final class SaxPatternDetectionEngine extends GreyCat.Object {
			...
			public static SaxPatternDetectionEngine create(ai.greycat.GreyCat greycat, ai.greycat.std.core.nodeTime timeseries, ai.greycat.algebra.patterns.PatternDetectionEngineState state, ai.greycat.algebra.patterns.PatternNullStrategy nullStrategy, java.lang.Double nullReplaceConstant, ai.greycat.algebra.patterns.SamplingPolicy samplingPolicy, java.lang.Long alphabet_size, ai.greycat.std.core.Array<java.lang.Double> alphabet_boundaries, ai.greycat.std.core.nodeIndex lookup_table, java.lang.Double max_distance, ai.greycat.std.core.Array<java.lang.String> pattern_fingerprints, java.lang.Long fingerprint_length){
				return new SaxPatternDetectionEngine(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[15], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, alphabet_size, alphabet_boundaries, lookup_table, max_distance, pattern_fingerprints, fingerprint_length);
			}
		}
		public static final class DistanceMetrics extends GreyCat.Object {
			...
			public static DistanceMetrics create(ai.greycat.GreyCat greycat){
				return new DistanceMetrics(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[16]);
			}
		}
		public static final class PatternDetectionSensitivity extends GreyCat.Object {
			...
			public static PatternDetectionSensitivity create(ai.greycat.GreyCat greycat, java.lang.Double threshold, java.lang.Double overlap){
				return new PatternDetectionSensitivity(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[17], threshold, overlap);
			}
		}
		public static final class PatternDetector extends GreyCat.Object {
			...
			public static PatternDetector create(ai.greycat.GreyCat greycat){
				return new PatternDetector(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[18]);
			}
		}
		public static final class FFTPatternDetector extends GreyCat.Object {
			...
			public static FFTPatternDetector create(ai.greycat.GreyCat greycat){
				return new FFTPatternDetector(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[19]);
			}
		}
		public static final class EuclideanPatternDetector extends GreyCat.Object {
			...
			public static EuclideanPatternDetector create(ai.greycat.GreyCat greycat){
				return new EuclideanPatternDetector(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[20]);
			}
		}
		public static final class PatternDetectors extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.patterns.PatternDetectors none(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[21];
			...
			public static PatternDetectors create(ai.greycat.GreyCat greycat){
				return new PatternDetectors(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[21]);
			}
		}
		public static final class ScoreDetails extends GreyCat.Object {
			...
			public static ScoreDetails create(ai.greycat.GreyCat greycat, java.lang.Long best_pattern, ai.greycat.std.core.duration timespan){
				return new ScoreDetails(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[22], best_pattern, timespan);
			}
		}
		public static final class ScoreDetailsSingleton extends GreyCat.Object {
			...
			public static ScoreDetailsSingleton create(ai.greycat.GreyCat greycat, java.lang.Long best_pattern, ai.greycat.std.core.duration timespan, ai.greycat.std.core.time timestamp){
				return new ScoreDetailsSingleton(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[23], best_pattern, timespan, timestamp);
			}
		}
		public static final class SaxPatternDetector extends GreyCat.Object {
			...
			public static SaxPatternDetector create(ai.greycat.GreyCat greycat, java.lang.Long alphabet_size, java.lang.Long fingerprint_length){
				return new SaxPatternDetector(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[24], alphabet_size, fingerprint_length);
			}
		}
		public static final class DTWPatternDetector extends GreyCat.Object {
			...
			public static DTWPatternDetector create(ai.greycat.GreyCat greycat){
				return new DTWPatternDetector(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[25]);
			}
		}
		public static final class PatternDetectionEngineState extends GreyCat.Object {
			...
			public static PatternDetectionEngineState create(ai.greycat.GreyCat greycat, java.lang.Boolean hasScores, java.lang.Boolean hasDetections, ai.greycat.std.core.Array<ai.greycat.std.util.TimeWindow> patterns, ai.greycat.std.core.nodeList scores, ai.greycat.std.core.nodeTime detections){
				return new PatternDetectionEngineState(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[26], hasScores, hasDetections, patterns, scores, detections);
			}
		}
		public static final class RandomPatternDetectionEngine extends GreyCat.Object {
			...
			public static RandomPatternDetectionEngine create(ai.greycat.GreyCat greycat, ai.greycat.std.core.nodeTime timeseries, ai.greycat.algebra.patterns.PatternDetectionEngineState state, ai.greycat.algebra.patterns.PatternNullStrategy nullStrategy, java.lang.Double nullReplaceConstant, ai.greycat.algebra.patterns.SamplingPolicy samplingPolicy, ai.greycat.std.util.Random rng){
				return new RandomPatternDetectionEngine(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[27], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, rng);
			}
		}
		public static final class PatternDetectionEngine extends GreyCat.Object {
			...
			public static PatternDetectionEngine create(ai.greycat.GreyCat greycat, ai.greycat.std.core.nodeTime timeseries, ai.greycat.algebra.patterns.PatternDetectionEngineState state, ai.greycat.algebra.patterns.PatternNullStrategy nullStrategy, java.lang.Double nullReplaceConstant, ai.greycat.algebra.patterns.SamplingPolicy samplingPolicy){
				return new PatternDetectionEngine(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[28], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy);
			}
		}
		public static final class PatternNullStrategy extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.patterns.PatternNullStrategy replace(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[29];
			...
			public static PatternNullStrategy create(ai.greycat.GreyCat greycat){
				return new PatternNullStrategy(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[29]);
			}
		}
		public static final class RandomPatternDetector extends GreyCat.Object {
			...
			public static RandomPatternDetector create(ai.greycat.GreyCat greycat){
				return new RandomPatternDetector(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[30]);
			}
		}
		public static final class OverlappingDetection extends GreyCat.Object {
			...
			public static OverlappingDetection create(ai.greycat.GreyCat greycat, java.lang.Double score, java.lang.Long best_pattern, ai.greycat.std.core.duration timespan, ai.greycat.std.core.duration overlap){
				return new OverlappingDetection(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[31], score, best_pattern, timespan, overlap);
			}
		}
		public static final class MatchingNormalisation extends GreyCat.Enum {
			...
			public static MatchingNormalisation create(ai.greycat.GreyCat greycat){
				return new MatchingNormalisation(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[32]);
			}
		}
	}
	public static final class transforms {
		public static final class FFTModel extends GreyCat.Object {
			...
			public static FFTModel create(ai.greycat.GreyCat greycat, ai.greycat.std.core.nodeTime nt, ai.greycat.std.core.duration sampling_step, ai.greycat.std.core.Tensor time_complex, ai.greycat.std.core.Tensor frequency_complex, ai.greycat.std.core.Table frequency_table, ai.greycat.std.core.time start_time, java.lang.Long best_size){
				return new FFTModel(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[33], nt, sampling_step, time_complex, frequency_complex, frequency_table, start_time, best_size);
			}
		}
	}
	public static final class powerflow {
		public static final class PowerBusResult extends GreyCat.Object {
			...
			public static PowerBusResult create(ai.greycat.GreyCat greycat, java.lang.Double abs, java.lang.Double angle_radians, java.lang.Double voltage, java.lang.Double voltage_img, java.lang.Double current, java.lang.Double current_img){
				return new PowerBusResult(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[34], abs, angle_radians, voltage, voltage_img, current, current_img);
			}
		}
		public static final class PowerLineResult extends GreyCat.Object {
			...
			public static PowerLineResult create(ai.greycat.GreyCat greycat, java.lang.Double p_from_mw, java.lang.Double q_from_mvar, java.lang.Double p_to_mw, java.lang.Double q_to_mvar, java.lang.Double pl_mw, java.lang.Double ql_mvar, java.lang.Double i_from_ka, java.lang.Double i_to_ka, java.lang.Double i_ka, java.lang.Double vm_from_pu, java.lang.Double vm_to_pu, java.lang.Double va_from_radians, java.lang.Double va_to_radians, java.lang.Double loading_percent){
				return new PowerLineResult(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[35], p_from_mw, q_from_mvar, p_to_mw, q_to_mvar, pl_mw, ql_mvar, i_from_ka, i_to_ka, i_ka, vm_from_pu, vm_to_pu, va_from_radians, va_to_radians, loading_percent);
			}
		}
	}
	public static final class compute {
		public static final class ComputeRegularizer extends GreyCat.Object {
			...
			public static ComputeRegularizer create(ai.greycat.GreyCat greycat, java.lang.Double l1, java.lang.Double l2){
				return new ComputeRegularizer(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[36], l1, l2);
			}
		}
		public static final class ComputeEngine extends ai.greycat.algebra_n.compute.ComputeEngine {
			...
			public static ComputeEngine create(ai.greycat.GreyCat greycat){
				return new ComputeEngine(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[37]);
			}
		}
		public static final class ComputeActivation extends GreyCat.Object {
			...
			public static ComputeActivation create(ai.greycat.GreyCat greycat){
				return new ComputeActivation(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[38]);
			}
		}
		public static final class ComputeOperationTan extends GreyCat.Object {
			...
			public static ComputeOperationTan create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationTan(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[39], input, output);
			}
		}
		public static final class ComputeLayerMinMaxScaler extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[40];
				return (java.lang.String) t.static_values[0];
			}
			...
			public static ComputeLayerMinMaxScaler create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Boolean inverse_transform){
				return new ComputeLayerMinMaxScaler(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[40], name, type, inverse_transform);
			}
		}
		public static final class ComputeCounter extends GreyCat.Object {
			...
			public static ComputeCounter create(ai.greycat.GreyCat greycat, java.lang.Long epoch, java.lang.Long optimizationSteps, java.lang.Long batchNotOptimized){
				return new ComputeCounter(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[41], epoch, optimizationSteps, batchNotOptimized);
			}
		}
		public static final class ComputeOptimizerNadam extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[42];
			...
			public static ComputeOptimizerNadam create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate, java.lang.Double beta1, java.lang.Double beta2, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerNadam(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[42], learning_rate, beta1, beta2, smooth_epsilon);
			}
		}
		public static final class ComputeOperationCos extends GreyCat.Object {
			...
			public static ComputeOperationCos create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationCos(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[43], input, output);
			}
		}
		public static final class ComputeOperationSoftmax extends GreyCat.Object {
			...
			public static ComputeOperationSoftmax create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSoftmax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[44], input, output);
			}
		}
		public static final class ComputeOperationSoftSign extends GreyCat.Object {
			...
			public static ComputeOperationSoftSign create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSoftSign(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[45], input, output);
			}
		}
		public static final class ComputeActivationElu extends GreyCat.Object {
			...
			public static ComputeActivationElu create(ai.greycat.GreyCat greycat, java.lang.Double alpha){
				return new ComputeActivationElu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[46], alpha);
			}
		}
		public static final class ComputeClassificationLoss extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.compute.ComputeClassificationLoss categorical_cross_entropy(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[47];
			...
			public static ComputeClassificationLoss create(ai.greycat.GreyCat greycat){
				return new ComputeClassificationLoss(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[47]);
			}
		}
		public static final class ComputeOperationAtan extends GreyCat.Object {
			...
			public static ComputeOperationAtan create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAtan(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[48], input, output);
			}
		}
		public static final class ComputeInitializerNone extends GreyCat.Object {
			...
			public static ComputeInitializerNone create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerNone(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[49]);
			}
		}
		public static final class ComputeOptimizerAdaGrad extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[50];
				return (java.lang.Double) t.static_values[0];
			}
			...
			public static ComputeOptimizerAdaGrad create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate, java.lang.Double initial_accumulator, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerAdaGrad(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[50], learning_rate, initial_accumulator, smooth_epsilon);
			}
		}
		public static final class ComputeOperationAvg extends GreyCat.Object {
			...
			public static ComputeOperationAvg create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationAvg(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[51], input, input2, output);
			}
		}
		public static final class ComputeOperationSigmoid extends GreyCat.Object {
			...
			public static ComputeOperationSigmoid create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSigmoid(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[52], input, output);
			}
		}
		public static final class ComputeOperationArgMax extends GreyCat.Object {
			...
			public static ComputeOperationArgMax create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.String output2){
				return new ComputeOperationArgMax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[53], input, output, output2);
			}
		}
		public static final class ComputeOperationAcosh extends GreyCat.Object {
			...
			public static ComputeOperationAcosh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAcosh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[54], input, output);
			}
		}
		public static final class ComputeLayerCall extends GreyCat.Object {
			...
			public static ComputeLayerCall create(ai.greycat.GreyCat greycat, java.lang.String layer_name, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeBinding> bindings){
				return new ComputeLayerCall(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[55], layer_name, bindings);
			}
		}
		public static final class ComputeOperationRaiseToPower extends GreyCat.Object {
			...
			public static ComputeOperationRaiseToPower create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double power){
				return new ComputeOperationRaiseToPower(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[56], input, output, power);
			}
		}
		public static final class ComputeLayerActivation extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[57];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[57];
			...
			public static ComputeLayerActivation create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.algebra.compute.ComputeActivation activation){
				return new ComputeLayerActivation(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[57], name, activation);
			}
		}
		public static final class ComputeOperationSign extends GreyCat.Object {
			...
			public static ComputeOperationSign create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSign(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[58], input, output);
			}
		}
		public static final class ComputeVar extends GreyCat.Object {
			...
			public static ComputeVar create(ai.greycat.GreyCat greycat, java.lang.String name){
				return new ComputeVar(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[59], name);
			}
		}
		public static final class ComputeOptimizerAdaDelta extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[60];
				return (java.lang.Double) t.static_values[0];
			}
			...
			public static ComputeOptimizerAdaDelta create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate, java.lang.Double decay_rate, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerAdaDelta(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[60], learning_rate, decay_rate, smooth_epsilon);
			}
		}
		public static final class ComputeOperation2In1Out extends GreyCat.Object {
			...
			public static ComputeOperation2In1Out create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperation2In1Out(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[61], input, input2, output);
			}
		}
		public static final class ComputeModel extends GreyCat.Object {
			...
			public static ComputeModel create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers){
				return new ComputeModel(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[62], layers);
			}
		}
		public static final class ComputeActivationSoftmax extends GreyCat.Object {
			...
			public static ComputeActivationSoftmax create(ai.greycat.GreyCat greycat, java.lang.String classes){
				return new ComputeActivationSoftmax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[63], classes);
			}
		}
		public static final class ComputeInitializerLeCunUniform extends GreyCat.Object {
			...
			public static ComputeInitializerLeCunUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerLeCunUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[64]);
			}
		}
		public static final class ComputeActivationExp extends GreyCat.Object {
			...
			public static ComputeActivationExp create(ai.greycat.GreyCat greycat){
				return new ComputeActivationExp(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[65]);
			}
		}
		public static final class ComputeLayerFilter extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[66];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[66];
			...
			public static ComputeLayerFilter create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Long inputs, java.lang.Long outputs, ai.greycat.std.core.Array<java.lang.Long> maskValues){
				return new ComputeLayerFilter(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[66], name, type, inputs, outputs, maskValues);
			}
		}
		public static final class ComputeInitializerRelu extends GreyCat.Object {
			...
			public static ComputeInitializerRelu create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[67]);
			}
		}
		public static final class ComputeInitializerConstant extends GreyCat.Object {
			...
			public static ComputeInitializerConstant create(ai.greycat.GreyCat greycat, java.lang.Object value){
				return new ComputeInitializerConstant(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[68], value);
			}
		}
		public static final class ComputeVarInOut extends GreyCat.Object {
			...
			public static ComputeVarInOut create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, ai.greycat.std.core.Array<java.lang.Long> shape, java.lang.Boolean with_grad){
				return new ComputeVarInOut(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[69], name, type, shape, with_grad);
			}
		}
		public static final class ComputeOptimizerAdaMax extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[70];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Double beta1_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[70];
			...
			public static ComputeOptimizerAdaMax create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate, java.lang.Double beta1, java.lang.Double beta2, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerAdaMax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[70], learning_rate, beta1, beta2, smooth_epsilon);
			}
		}
		public static final class ComputeOperationScale extends GreyCat.Object {
			...
			public static ComputeOperationScale create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double alpha){
				return new ComputeOperationScale(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[71], input, output, alpha);
			}
		}
		public static final class ComputeOperationAsinh extends GreyCat.Object {
			...
			public static ComputeOperationAsinh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAsinh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[72], input, output);
			}
		}
		public static final class ComputeInitializerPytorch extends GreyCat.Object {
			...
			public static ComputeInitializerPytorch create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerPytorch(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[73]);
			}
		}
		public static final class ComputeVarProxy extends GreyCat.Object {
			...
			public static ComputeVarProxy create(ai.greycat.GreyCat greycat, java.lang.String name){
				return new ComputeVarProxy(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[74], name);
			}
		}
		public static final class ComputeInitializerUniformOut extends GreyCat.Object {
			...
			public static ComputeInitializerUniformOut create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerUniformOut(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[75]);
			}
		}
		public static final class ComputeOperationCosh extends GreyCat.Object {
			...
			public static ComputeOperationCosh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationCosh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[76], input, output);
			}
		}
		public static final class ComputeOperationLogSoftmax extends GreyCat.Object {
			...
			public static ComputeOperationLogSoftmax create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Long axis){
				return new ComputeOperationLogSoftmax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[77], input, output, axis);
			}
		}
		public static final class ComputeOperationSum extends GreyCat.Object {
			...
			public static ComputeOperationSum create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Long axis){
				return new ComputeOperationSum(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[78], input, output, axis);
			}
		}
		public static final class ComputeVariable extends GreyCat.Object {
			...
			public static ComputeVariable create(ai.greycat.GreyCat greycat, java.lang.String name){
				return new ComputeVariable(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[79], name);
			}
		}
		public static final class ComputeLayerClassification extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[80];
				return (java.lang.String) t.static_values[0];
			}
			...
			public static ComputeLayerClassification create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Boolean calculate_probabilities, java.lang.Boolean from_logits){
				return new ComputeLayerClassification(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[80], name, calculate_probabilities, from_logits);
			}
		}
		public static final class ComputeOperationAbs extends GreyCat.Object {
			...
			public static ComputeOperationAbs create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAbs(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[81], input, output);
			}
		}
		public static final class ComputeActivationSoftSign extends GreyCat.Object {
			...
			public static ComputeActivationSoftSign create(ai.greycat.GreyCat greycat){
				return new ComputeActivationSoftSign(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[82]);
			}
		}
		public static final class ComputeOperationMul extends GreyCat.Object {
			...
			public static ComputeOperationMul create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationMul(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[83], input, input2, output);
			}
		}
		public static final class ComputeOperationMatMul extends GreyCat.Object {
			...
			public static java.lang.Boolean transpose_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[84];
			...
			public static ComputeOperationMatMul create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output, java.lang.Boolean transposeA, java.lang.Boolean transposeB, java.lang.Double alpha, java.lang.Double beta){
				return new ComputeOperationMatMul(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[84], input, input2, output, transposeA, transposeB, alpha, beta);
			}
		}
		public static final class ComputeOptimizerMomentum extends GreyCat.Object {
			...
			public static ComputeOptimizerMomentum create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate, java.lang.Double decay_rate){
				return new ComputeOptimizerMomentum(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[85], learning_rate, decay_rate);
			}
		}
		public static final class ComputeOperationAcos extends GreyCat.Object {
			...
			public static ComputeOperationAcos create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAcos(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[86], input, output);
			}
		}
		public static final class ComputeInitializerNormalAvg extends GreyCat.Object {
			...
			public static ComputeInitializerNormalAvg create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerNormalAvg(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[87]);
			}
		}
		public static final class ComputeOperationSumIf extends GreyCat.Object {
			...
			public static ComputeOperationSumIf create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String ifCondition, java.lang.String output, java.lang.String counts, java.lang.Long classes){
				return new ComputeOperationSumIf(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[88], input, ifCondition, output, counts, classes);
			}
		}
		public static final class ComputeLayerCustom extends GreyCat.Object {
			...
			public static ComputeLayerCustom create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeOperation> ops, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeVariable> vars){
				return new ComputeLayerCustom(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[89], name, ops, vars);
			}
		}
		public static final class ComputeOperationHardSigmoid extends GreyCat.Object {
			...
			public static ComputeOperationHardSigmoid create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double slope, java.lang.Double shift){
				return new ComputeOperationHardSigmoid(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[90], input, output, slope, shift);
			}
		}
		public static final class ComputeOperationExp extends GreyCat.Object {
			...
			public static ComputeOperationExp create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationExp(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[91], input, output);
			}
		}
		public static final class ComputeLayerPCAScaler extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[92];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[92];
			...
			public static ComputeLayerPCAScaler create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Boolean inverse_transform){
				return new ComputeLayerPCAScaler(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[92], name, type, inverse_transform);
			}
		}
		public static final class ComputeLayerDense extends GreyCat.Object {
			...
			public static ComputeLayerDense create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Long inputs, java.lang.Long outputs, java.lang.Boolean use_bias, ai.greycat.algebra.compute.ComputeInitializer weight_initializer, ai.greycat.algebra.compute.ComputeRegularizer weight_regularizer, ai.greycat.algebra.compute.ComputeInitializer bias_initializer, ai.greycat.algebra.compute.ComputeRegularizer bias_regularizer, ai.greycat.algebra.compute.ComputeActivation activation){
				return new ComputeLayerDense(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[93], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
			}
		}
		public static final class ComputeReduction extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.compute.ComputeReduction auto(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[94];
			...
			public static ComputeReduction create(ai.greycat.GreyCat greycat){
				return new ComputeReduction(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[94]);
			}
		}
		public static final class ComputeOperationSelu extends GreyCat.Object {
			...
			public static ComputeOperationSelu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[95], input, output);
			}
		}
		public static final class ComputeOptimizerNesterov extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[96];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Double decay_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[96];
			...
			public static ComputeOptimizerNesterov create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate, java.lang.Double decay_rate){
				return new ComputeOptimizerNesterov(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[96], learning_rate, decay_rate);
			}
		}
		public static final class ComputeInitializerIdentity extends GreyCat.Object {
			...
			public static ComputeInitializerIdentity create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerIdentity(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[97]);
			}
		}
		public static final class ComputeActivationRelu extends GreyCat.Object {
			...
			public static java.lang.Double threshold_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[98];
				return (java.lang.Double) t.static_values[0];
			}
			public static ComputeActivationRelu create(ai.greycat.GreyCat greycat, java.lang.Double max_value, java.lang.Double threshold){
				return new ComputeActivationRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[98], max_value, threshold);
			}
		}
		public static final class ComputeLayerLinear extends GreyCat.Object {
			...
			public static ComputeLayerLinear create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Long inputs, java.lang.Long outputs, java.lang.Boolean use_bias, ai.greycat.algebra.compute.ComputeInitializer weight_initializer, ai.greycat.algebra.compute.ComputeRegularizer weight_regularizer, ai.greycat.algebra.compute.ComputeInitializer bias_initializer, ai.greycat.algebra.compute.ComputeRegularizer bias_regularizer){
				return new ComputeLayerLinear(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[99], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
			}
		}
		public static final class ComputeActivationCelu extends GreyCat.Object {
			...
			public static java.lang.Double alpha_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[100];
				return (java.lang.Double) t.static_values[0];
			}
			public static ComputeActivationCelu create(ai.greycat.GreyCat greycat, java.lang.Double alpha){
				return new ComputeActivationCelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[100], alpha);
			}
		}
		public static final class ComputeOperationAtanh extends GreyCat.Object {
			...
			public static ComputeOperationAtanh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAtanh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[101], input, output);
			}
		}
		public static final class ComputeInitializer extends GreyCat.Object {
			...
			public static ComputeInitializer create(ai.greycat.GreyCat greycat){
				return new ComputeInitializer(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[102]);
			}
		}
		public static final class ComputeOperationCelu extends GreyCat.Object {
			...
			public static java.lang.Double alpha_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[103];
				return (java.lang.Double) t.static_values[0];
			}
			public static ComputeOperationCelu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double alpha){
				return new ComputeOperationCelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[103], input, output, alpha);
			}
		}
		public static final class ComputeOperationFilter extends GreyCat.Object {
			...
			public static ComputeOperationFilter create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.String mask, java.lang.Long nbOutputs){
				return new ComputeOperationFilter(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[104], input, output, mask, nbOutputs);
			}
		}
		public static final class ComputeActivationSigmoid extends GreyCat.Object {
			...
			public static ComputeActivationSigmoid create(ai.greycat.GreyCat greycat){
				return new ComputeActivationSigmoid(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[105]);
			}
		}
		public static final class ComputeOperation extends GreyCat.Object {
			...
			public static ComputeOperation create(ai.greycat.GreyCat greycat){
				return new ComputeOperation(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[106]);
			}
		}
		public static final class ComputeInitializerNormalIn extends GreyCat.Object {
			...
			public static ComputeInitializerNormalIn create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerNormalIn(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[107]);
			}
		}
		public static final class ComputeOperationSin extends GreyCat.Object {
			...
			public static ComputeOperationSin create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSin(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[108], input, output);
			}
		}
		public static final class ComputeOperationAdd extends GreyCat.Object {
			...
			public static ComputeOperationAdd create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationAdd(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[109], input, input2, output);
			}
		}
		public static final class ComputeInitializerNormal extends GreyCat.Object {
			...
			public static ComputeInitializerNormal create(ai.greycat.GreyCat greycat, java.lang.Double avg, java.lang.Double std){
				return new ComputeInitializerNormal(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[110], avg, std);
			}
		}
		public static final class ComputeInitializerGlorotUniform extends GreyCat.Object {
			...
			public static ComputeInitializerGlorotUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerGlorotUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[111]);
			}
		}
		public static final class ComputeVarOptimize extends GreyCat.Object {
			...
			public static ComputeVarOptimize create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, ai.greycat.std.core.Array<java.lang.Long> shape, java.lang.Double l1, java.lang.Double l2, ai.greycat.algebra.compute.ComputeInitializer init){
				return new ComputeVarOptimize(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[112], name, type, shape, l1, l2, init);
			}
		}
		public static final class ComputeOptimizerSgd extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[113];
				return (java.lang.Double) t.static_values[0];
			}
			public static ComputeOptimizerSgd create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate){
				return new ComputeOptimizerSgd(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[113], learning_rate);
			}
		}
		public static final class ComputeOptimizer extends GreyCat.Object {
			...
			public static ComputeOptimizer create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate){
				return new ComputeOptimizer(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[114], learning_rate);
			}
		}
		public static final class ComputeInitializerSigmoidUniform extends GreyCat.Object {
			...
			public static ComputeInitializerSigmoidUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerSigmoidUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[115]);
			}
		}
		public static final class ComputeOperationDiv extends GreyCat.Object {
			...
			public static ComputeOperationDiv create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationDiv(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[116], input, input2, output);
			}
		}
		public static final class ComputeOperation1In1Out extends GreyCat.Object {
			...
			public static ComputeOperation1In1Out create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperation1In1Out(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[117], input, output);
			}
		}
		public static final class ComputeOperationClip extends GreyCat.Object {
			...
			public static ComputeOperationClip create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double min, java.lang.Double max){
				return new ComputeOperationClip(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[118], input, output, min, max);
			}
		}
		public static final class ComputeInitializerLSTM extends GreyCat.Object {
			...
			public static ComputeInitializerLSTM create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerLSTM(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[119]);
			}
		}
		public static final class ComputeLayerStandardScaler extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[120];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[120];
			...
			public static ComputeLayerStandardScaler create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Boolean inverse_transform){
				return new ComputeLayerStandardScaler(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[120], name, type, inverse_transform);
			}
		}
		public static final class ComputeInitializerReluUniform extends GreyCat.Object {
			...
			public static ComputeInitializerReluUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerReluUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[121]);
			}
		}
		public static final class ComputeOperationSoftplus extends GreyCat.Object {
			...
			public static ComputeOperationSoftplus create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSoftplus(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[122], input, output);
			}
		}
		public static final class ComputeLayerConfusion extends GreyCat.Object {
			...
			public static java.lang.String var_computed_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[123];
				return (java.lang.String) t.static_values[0];
			}
			...
			public static ComputeLayerConfusion create(ai.greycat.GreyCat greycat, java.lang.String name, java.lang.Long nbClass){
				return new ComputeLayerConfusion(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[123], name, nbClass);
			}
		}
		public static final class ComputeOperationTanh extends GreyCat.Object {
			...
			public static ComputeOperationTanh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationTanh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[124], input, output);
			}
		}
		public static final class ComputeActivationLeakyRelu extends GreyCat.Object {
			...
			public static java.lang.Double alpha_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[125];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Double threshold_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[125];
			...
			public static ComputeActivationLeakyRelu create(ai.greycat.GreyCat greycat, java.lang.Double alpha, java.lang.Double max_value, java.lang.Double threshold){
				return new ComputeActivationLeakyRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[125], alpha, max_value, threshold);
			}
		}
		public static final class ComputeOperationNeg extends GreyCat.Object {
			...
			public static ComputeOperationNeg create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationNeg(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[126], input, output);
			}
		}
		public static final class ComputeOptimizerAdam extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[127];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Double beta1_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[127];
			...
			public static ComputeOptimizerAdam create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate, java.lang.Double beta1, java.lang.Double beta2, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerAdam(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[127], learning_rate, beta1, beta2, smooth_epsilon);
			}
		}
		public static final class ComputeOperationAsin extends GreyCat.Object {
			...
			public static ComputeOperationAsin create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAsin(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[128], input, output);
			}
		}
		public static final class ComputeRegressionLoss extends GreyCat.Enum {
			...
			public static ComputeRegressionLoss create(ai.greycat.GreyCat greycat){
				return new ComputeRegressionLoss(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[129]);
			}
		}
		public static final class ComputeVarConst extends GreyCat.Object {
			...
			public static ComputeVarConst create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, ai.greycat.std.core.Array<java.lang.Long> shape){
				return new ComputeVarConst(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[130], name, type, shape);
			}
		}
		public static final class ComputeActivationSelu extends GreyCat.Object {
			...
			public static ComputeActivationSelu create(ai.greycat.GreyCat greycat){
				return new ComputeActivationSelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[131]);
			}
		}
		public static final class ComputeLayerSeq extends GreyCat.Object {
			...
			public static ComputeLayerSeq create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayerCall> calls, ai.greycat.algebra.compute.ComputeOptimizer optimizer){
				return new ComputeLayerSeq(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[132], name, calls, optimizer);
			}
		}
		public static final class ComputeInitializerXavier extends GreyCat.Object {
			...
			public static ComputeInitializerXavier create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerXavier(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[133]);
			}
		}
		public static final class ComputeOperationLeakyRelu extends GreyCat.Object {
			...
			public static ComputeOperationLeakyRelu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double alpha, java.lang.Double max_value, java.lang.Double threshold){
				return new ComputeOperationLeakyRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[134], input, output, alpha, max_value, threshold);
			}
		}
		public static final class ComputeOperationLog extends GreyCat.Object {
			...
			public static ComputeOperationLog create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationLog(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[135], input, output);
			}
		}
		public static final class ComputeActivationTanh extends GreyCat.Object {
			...
			public static ComputeActivationTanh create(ai.greycat.GreyCat greycat){
				return new ComputeActivationTanh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[136]);
			}
		}
		public static final class ComputeInitializerXavierUniform extends GreyCat.Object {
			...
			public static ComputeInitializerXavierUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerXavierUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137]);
			}
		}
		public static final class ComputeOperationArg extends GreyCat.Object {
			...
			public static ComputeOperationArg create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.String output2){
				return new ComputeOperationArg(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[138], input, output, output2);
			}
		}
		public static final class ComputeOperationPow extends GreyCat.Object {
			...
			public static ComputeOperationPow create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationPow(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[139], input, input2, output);
			}
		}
		public static final class ComputeOperationSub extends GreyCat.Object {
			...
			public static ComputeOperationSub create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationSub(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[140], input, input2, output);
			}
		}
		public static final class ComputeActivationHardSigmoid extends GreyCat.Object {
			...
			public static java.lang.Double slope_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[141];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Double shift_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[141];
			...
			public static ComputeActivationHardSigmoid create(ai.greycat.GreyCat greycat, java.lang.Double slope, java.lang.Double shift){
				return new ComputeActivationHardSigmoid(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[141], slope, shift);
			}
		}
		public static final class ComputeOperationLeCunTanh extends GreyCat.Object {
			...
			public static ComputeOperationLeCunTanh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationLeCunTanh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[142], input, output);
			}
		}
		public static final class ComputeLayerLossRegression extends GreyCat.Object {
			...
			public static ComputeLayerLossRegression create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.algebra.compute.ComputeReduction reduction, ai.greycat.algebra.compute.ComputeRegressionLoss loss_type){
				return new ComputeLayerLossRegression(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[143], name, reduction, loss_type);
			}
		}
		public static final class ComputeOperationFill extends GreyCat.Object {
			...
			public static ComputeOperationFill create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.Object value){
				return new ComputeOperationFill(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[144], input, value);
			}
		}
		public static final class ComputeActivationSoftplus extends GreyCat.Object {
			...
			public static ComputeActivationSoftplus create(ai.greycat.GreyCat greycat){
				return new ComputeActivationSoftplus(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[145]);
			}
		}
		public static final class ComputeLayerLSTM extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[146];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[146];
			...
			public static ComputeLayerLSTM create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.algebra.compute.ComputeInitializer bias_initializer, ai.greycat.algebra.compute.ComputeRegularizer weight_regularizer, ai.greycat.algebra.compute.ComputeRegularizer bias_regularizer, ai.greycat.std.core.TensorType type, java.lang.Boolean use_bias, java.lang.Boolean return_sequences, java.lang.Boolean bidirectional, java.lang.Boolean auto_init_states, java.lang.Long inputs, java.lang.Long outputs, java.lang.Long layers, java.lang.Long sequences){
				return new ComputeLayerLSTM(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[146], name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences);
			}
		}
		public static final class ComputeOptimizerFtrl extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[147];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Double beta_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[147];
			...
			public static ComputeOptimizerFtrl create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate, java.lang.Double lambda1, java.lang.Double lambda2, java.lang.Double beta){
				return new ComputeOptimizerFtrl(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[147], learning_rate, lambda1, lambda2, beta);
			}
		}
		public static final class ComputeOptimizerRmsProp extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[148];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Double decay_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[148];
			...
			public static ComputeOptimizerRmsProp create(ai.greycat.GreyCat greycat, java.lang.Double learning_rate, java.lang.Double decay_rate, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerRmsProp(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[148], learning_rate, decay_rate, smooth_epsilon);
			}
		}
		public static final class ComputeInitializerUniformIn extends GreyCat.Object {
			...
			public static ComputeInitializerUniformIn create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerUniformIn(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[149]);
			}
		}
		public static final class ComputeOperationSinh extends GreyCat.Object {
			...
			public static ComputeOperationSinh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSinh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[150], input, output);
			}
		}
		public static final class ComputeState extends ai.greycat.algebra_n.compute.ComputeState {
			...
			public static ComputeState create(ai.greycat.GreyCat greycat){
				return new ComputeState(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[151]);
			}
		}
		public static final class ComputeOperationEuclidean extends GreyCat.Object {
			...
			public static ComputeOperationEuclidean create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationEuclidean(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[152], input, input2, output);
			}
		}
		public static final class ComputeInitializerUniform extends GreyCat.Object {
			...
			public static ComputeInitializerUniform create(ai.greycat.GreyCat greycat, java.lang.Double min, java.lang.Double max){
				return new ComputeInitializerUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[153], min, max);
			}
		}
		public static final class ComputeOperationAddBias extends GreyCat.Object {
			...
			public static ComputeOperationAddBias create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationAddBias(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[154], input, input2, output);
			}
		}
		public static final class ComputeLayer extends GreyCat.Object {
			...
			public static ComputeLayer create(ai.greycat.GreyCat greycat, java.lang.String name){
				return new ComputeLayer(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[155], name);
			}
		}
		public static final class ComputeOperationElu extends GreyCat.Object {
			...
			public static java.lang.Double alpha_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[156];
				return (java.lang.Double) t.static_values[0];
			}
			public static ComputeOperationElu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double alpha){
				return new ComputeOperationElu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[156], input, output, alpha);
			}
		}
		public static final class ComputeLayerLossClassification extends GreyCat.Object {
			...
			public static java.lang.String var_class_weights_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[157];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_predicted_classes_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[157];
			...
			public static ComputeLayerLossClassification create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.algebra.compute.ComputeReduction reduction, ai.greycat.algebra.compute.ComputeClassificationLoss loss_type, java.lang.Boolean has_class_weights, java.lang.Boolean calculate_probabilities, java.lang.Boolean from_logits){
				return new ComputeLayerLossClassification(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[157], name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits);
			}
		}
		public static final class ComputeOperationRelu extends GreyCat.Object {
			...
			public static java.lang.Double threshold_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[158];
				return (java.lang.Double) t.static_values[0];
			}
			public static ComputeOperationRelu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double max_value, java.lang.Double threshold){
				return new ComputeOperationRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[158], input, output, max_value, threshold);
			}
		}
		public static final class ComputeBinding extends GreyCat.Object {
			...
			public static ComputeBinding create(ai.greycat.GreyCat greycat, java.lang.String src_layer_name, java.lang.String src_var_name, java.lang.String target_var_name){
				return new ComputeBinding(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[159], src_layer_name, src_var_name, target_var_name);
			}
		}
		public static final class ComputeInitializerNormalOut extends GreyCat.Object {
			...
			public static ComputeInitializerNormalOut create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerNormalOut(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[160]);
			}
		}
		public static final class ComputeOperationArgMin extends GreyCat.Object {
			...
			public static ComputeOperationArgMin create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.String output2){
				return new ComputeOperationArgMin(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[161], input, output, output2);
			}
		}
		public static final class ComputeOperationSqrt extends GreyCat.Object {
			...
			public static ComputeOperationSqrt create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSqrt(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[162], input, output);
			}
		}
		public static final class ComputeInitializerUniformAvg extends GreyCat.Object {
			...
			public static ComputeInitializerUniformAvg create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerUniformAvg(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[163]);
			}
		}
		public static final class ComputeLayerLoss extends GreyCat.Object {
			...
			public static java.lang.String var_computed_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[164];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_expected_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[164];
			...
			public static ComputeLayerLoss create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.algebra.compute.ComputeReduction reduction){
				return new ComputeLayerLoss(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[164], name, reduction);
			}
		}
	}
	public static final class nn {
		public static final class ComputeLayerTypes extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.nn.ComputeLayerTypes linear(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[165];
			...
			public static ComputeLayerTypes create(ai.greycat.GreyCat greycat){
				return new ComputeLayerTypes(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[165]);
			}
		}
		public static final class BindingsResult extends GreyCat.Object {
			...
			public static BindingsResult create(ai.greycat.GreyCat greycat, java.lang.String previousLayerName, java.lang.String previousLayerOutput, java.lang.String expectedLayerName, java.lang.String expectedLayerOutput, ai.greycat.algebra.compute.ComputeLayer postLayer){
				return new BindingsResult(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[166], previousLayerName, previousLayerOutput, expectedLayerName, expectedLayerOutput, postLayer);
			}
		}
		public static final class ComputeActivations extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.nn.ComputeActivations relu(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[167];
			...
			public static ComputeActivations create(ai.greycat.GreyCat greycat){
				return new ComputeActivations(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[167]);
			}
		}
		public static final class PostProcessType extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.nn.PostProcessType none(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[168];
			...
			public static PostProcessType create(ai.greycat.GreyCat greycat){
				return new PostProcessType(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[168]);
			}
		}
		public static final class AutoEncoderNetwork extends GreyCat.Object {
			...
			public static AutoEncoderNetwork create(ai.greycat.GreyCat greycat, java.lang.Long inputs, java.lang.Boolean inputs_gradients, java.lang.Long outputs, java.lang.Long fixed_batch_size, java.lang.Long inputs_sequences, java.lang.Long outputs_sequences, ai.greycat.std.core.TensorType tensor_type, java.lang.Long seed, java.lang.Boolean randomizeSeed, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers, ai.greycat.algebra.nn.PreProcessType preProcessType, java.lang.Object preProcessObject, ai.greycat.algebra.nn.PostProcessType postProcessType, java.lang.Object postProcessObject, ai.greycat.algebra.compute.ComputeOptimizer optimizer, ai.greycat.algebra.compute.ComputeLayerLoss lossLayer, java.lang.String _lastLayer, java.lang.String _lastOutput, java.lang.Long encoder_layer_idx, java.lang.String encoder_layer_name, java.lang.String encoder_layer_var){
				return new AutoEncoderNetwork(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[169], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, encoder_layer_idx, encoder_layer_name, encoder_layer_var);
			}
		}
		public static final class InitializerConfig extends GreyCat.Object {
			...
			public static InitializerConfig create(ai.greycat.GreyCat greycat, ai.greycat.algebra.compute.ComputeInitializer weight_initializer, ai.greycat.algebra.compute.ComputeRegularizer weight_regularizer, ai.greycat.algebra.compute.ComputeInitializer bias_initializer, ai.greycat.algebra.compute.ComputeRegularizer bias_regularizer){
				return new InitializerConfig(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[170], weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
			}
		}
		public static final class PreProcessType extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.nn.PreProcessType none(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[171];
			...
			public static PreProcessType create(ai.greycat.GreyCat greycat){
				return new PreProcessType(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[171]);
			}
		}
		public static final class ClassificationNetwork extends GreyCat.Object {
			...
			public static ClassificationNetwork create(ai.greycat.GreyCat greycat, java.lang.Long inputs, java.lang.Boolean inputs_gradients, java.lang.Long outputs, java.lang.Long fixed_batch_size, java.lang.Long inputs_sequences, java.lang.Long outputs_sequences, ai.greycat.std.core.TensorType tensor_type, java.lang.Long seed, java.lang.Boolean randomizeSeed, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers, ai.greycat.algebra.nn.PreProcessType preProcessType, java.lang.Object preProcessObject, ai.greycat.algebra.nn.PostProcessType postProcessType, java.lang.Object postProcessObject, ai.greycat.algebra.compute.ComputeOptimizer optimizer, ai.greycat.algebra.compute.ComputeLayerLoss lossLayer, java.lang.String _lastLayer, java.lang.String _lastOutput, java.lang.Boolean calculate_probabilities, java.lang.Boolean has_class_weights, java.lang.Boolean from_logits){
				return new ClassificationNetwork(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[172], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, calculate_probabilities, has_class_weights, from_logits);
			}
		}
		public static final class NeuralNetwork extends GreyCat.Object {
			...
			public static java.lang.String err_negative_in_out(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[173];
				return (java.lang.String) t.static_values[0];
			}
		...
		public static final class ComputeInitializers extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.nn.ComputeInitializers none(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[174];
			...
			public static ComputeInitializers create(ai.greycat.GreyCat greycat){
				return new ComputeInitializers(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[174]);
			}
		}
		public static final class ComputeOptimizers extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.nn.ComputeOptimizers ada_delta(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[175];
			...
			public static ComputeOptimizers create(ai.greycat.GreyCat greycat){
				return new ComputeOptimizers(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[175]);
			}
		}
		public static final class RegressionNetwork extends GreyCat.Object {
			...
			public static RegressionNetwork create(ai.greycat.GreyCat greycat, java.lang.Long inputs, java.lang.Boolean inputs_gradients, java.lang.Long outputs, java.lang.Long fixed_batch_size, java.lang.Long inputs_sequences, java.lang.Long outputs_sequences, ai.greycat.std.core.TensorType tensor_type, java.lang.Long seed, java.lang.Boolean randomizeSeed, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers, ai.greycat.algebra.nn.PreProcessType preProcessType, java.lang.Object preProcessObject, ai.greycat.algebra.nn.PostProcessType postProcessType, java.lang.Object postProcessObject, ai.greycat.algebra.compute.ComputeOptimizer optimizer, ai.greycat.algebra.compute.ComputeLayerLoss lossLayer, java.lang.String _lastLayer, java.lang.String _lastOutput){
				return new RegressionNetwork(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[176], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput);
			}
		}
		public static final class ClassificationMetrics extends GreyCat.Object {
			...
			public static ClassificationMetrics create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array<java.lang.Double> precision, ai.greycat.std.core.Array<java.lang.Double> recall, ai.greycat.std.core.Array<java.lang.Double> f1Score){
				return new ClassificationMetrics(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[177], precision, recall, f1Score);
			}
		}
	}
	@Override
	...
	public void init(ai.greycat.GreyCat greycat) {
		...
		if(this.mapped[15] != null){
			this.mapped[15].static_values = new java.lang.Object[]{"ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz"};
		}
		this.mapped[16] = greycat.types_by_name.get(patterns.DistanceMetrics.name);
		this.mapped[17] = greycat.types_by_name.get(patterns.PatternDetectionSensitivity.name);
		if(this.mapped[17] != null){
			this.mapped[17].resolveGeneratedOffsets("threshold","overlap");
		}
		this.mapped[18] = greycat.types_by_name.get(patterns.PatternDetector.name);
		this.mapped[19] = greycat.types_by_name.get(patterns.FFTPatternDetector.name);
		this.mapped[20] = greycat.types_by_name.get(patterns.EuclideanPatternDetector.name);
		this.mapped[21] = greycat.types_by_name.get(patterns.PatternDetectors.name);
		if(this.mapped[21] != null){
			this.mapped[21].resolveGeneratedOffsetWithValues("none", "None","euclidean", "Euclidean","fft", "FFT","dtw", "DTW","random", "Random","sax", "SAX");
		}
		this.mapped[22] = greycat.types_by_name.get(patterns.ScoreDetails.name);
		if(this.mapped[22] != null){
			this.mapped[22].resolveGeneratedOffsets("best_pattern","timespan");
		}
		this.mapped[23] = greycat.types_by_name.get(patterns.ScoreDetailsSingleton.name);
		if(this.mapped[23] != null){
			this.mapped[23].resolveGeneratedOffsets("best_pattern","timespan","timestamp");
		}
		this.mapped[24] = greycat.types_by_name.get(patterns.SaxPatternDetector.name);
		if(this.mapped[24] != null){
			this.mapped[24].resolveGeneratedOffsets("alphabet_size","fingerprint_length");
		}
		this.mapped[25] = greycat.types_by_name.get(patterns.DTWPatternDetector.name);
		this.mapped[26] = greycat.types_by_name.get(patterns.PatternDetectionEngineState.name);
		if(this.mapped[26] != null){
			this.mapped[26].resolveGeneratedOffsets("hasScores","hasDetections","patterns","scores","detections");
		}
		this.mapped[27] = greycat.types_by_name.get(patterns.RandomPatternDetectionEngine.name);
		if(this.mapped[27] != null){
			this.mapped[27].resolveGeneratedOffsets("timeseries","state","nullStrategy","nullReplaceConstant","samplingPolicy","rng");
		}
		this.mapped[28] = greycat.types_by_name.get(patterns.PatternDetectionEngine.name);
		if(this.mapped[28] != null){
			this.mapped[28].resolveGeneratedOffsets("timeseries","state","nullStrategy","nullReplaceConstant","samplingPolicy");
		}
		this.mapped[29] = greycat.types_by_name.get(patterns.PatternNullStrategy.name);
		if(this.mapped[29] != null){
			this.mapped[29].resolveGeneratedOffsetWithValues("replace", "Replace","interpolate", "Interpolate","previous", "Previous","next", "Next","none", "None");
		}
		this.mapped[30] = greycat.types_by_name.get(patterns.RandomPatternDetector.name);
		this.mapped[31] = greycat.types_by_name.get(patterns.OverlappingDetection.name);
		if(this.mapped[31] != null){
			this.mapped[31].resolveGeneratedOffsets("score","best_pattern","timespan","overlap");
		}
		this.mapped[32] = greycat.types_by_name.get(patterns.MatchingNormalisation.name);
		if(this.mapped[32] != null){
			this.mapped[32].resolveGeneratedOffsetWithValues("as_is", "As-is","shift", "Vertical shift","scaling", "Vertical scaling","shift_and_scaling", "Vertical shift and scaling");
		}
		this.mapped[33] = greycat.types_by_name.get(transforms.FFTModel.name);
		if(this.mapped[33] != null){
			this.mapped[33].resolveGeneratedOffsets("nt","sampling_step","time_complex","frequency_complex","frequency_table","start_time","best_size");
		}
		this.mapped[34] = greycat.types_by_name.get(powerflow.PowerBusResult.name);
		if(this.mapped[34] != null){
			this.mapped[34].resolveGeneratedOffsets("abs","angle_radians","voltage","voltage_img","current","current_img");
		}
		this.mapped[35] = greycat.types_by_name.get(powerflow.PowerLineResult.name);
		if(this.mapped[35] != null){
			this.mapped[35].resolveGeneratedOffsets("p_from_mw","q_from_mvar","p_to_mw","q_to_mvar","pl_mw","ql_mvar","i_from_ka","i_to_ka","i_ka","vm_from_pu","vm_to_pu","va_from_radians","va_to_radians","loading_percent");
		}
		this.mapped[36] = greycat.types_by_name.get(compute.ComputeRegularizer.name);
		if(this.mapped[36] != null){
			this.mapped[36].resolveGeneratedOffsets("l1","l2");
		}
		this.mapped[37] = greycat.types_by_name.get(compute.ComputeEngine.name);
		this.mapped[38] = greycat.types_by_name.get(compute.ComputeActivation.name);
		this.mapped[39] = greycat.types_by_name.get(compute.ComputeOperationTan.name);
		if(this.mapped[39] != null){
			this.mapped[39].resolveGeneratedOffsets("input","output");
		}
		this.mapped[40] = greycat.types_by_name.get(compute.ComputeLayerMinMaxScaler.name);
		if(this.mapped[40] != null){
			this.mapped[40].resolveGeneratedOffsets("name","type","inverse_transform");
		}
		if(this.mapped[40] != null){
			this.mapped[40].static_values = new java.lang.Object[]{"input","output","min","max"};
		}
		this.mapped[41] = greycat.types_by_name.get(compute.ComputeCounter.name);
		if(this.mapped[41] != null){
			this.mapped[41].resolveGeneratedOffsets("epoch","optimizationSteps","batchNotOptimized");
		}
		this.mapped[42] = greycat.types_by_name.get(compute.ComputeOptimizerNadam.name);
		if(this.mapped[42] != null){
			this.mapped[42].resolveGeneratedOffsets("learning_rate","beta1","beta2","smooth_epsilon");
		}
		if(this.mapped[42] != null){
			this.mapped[42].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4562254508917369340L),java.lang.Double.longBitsToDouble(4606281698874543309L),java.lang.Double.longBitsToDouble(4607173411600762667L),java.lang.Double.longBitsToDouble(4502148214488346440L)};
		}
		this.mapped[43] = greycat.types_by_name.get(compute.ComputeOperationCos.name);
		if(this.mapped[43] != null){
			this.mapped[43].resolveGeneratedOffsets("input","output");
		}
		this.mapped[44] = greycat.types_by_name.get(compute.ComputeOperationSoftmax.name);
		if(this.mapped[44] != null){
			this.mapped[44].resolveGeneratedOffsets("input","output");
		}
		this.mapped[45] = greycat.types_by_name.get(compute.ComputeOperationSoftSign.name);
		if(this.mapped[45] != null){
			this.mapped[45].resolveGeneratedOffsets("input","output");
		}
		this.mapped[46] = greycat.types_by_name.get(compute.ComputeActivationElu.name);
		if(this.mapped[46] != null){
			this.mapped[46].resolveGeneratedOffsets("alpha");
		}
		if(this.mapped[46] != null){
			this.mapped[46].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4607182418800017408L)};
		}
		this.mapped[47] = greycat.types_by_name.get(compute.ComputeClassificationLoss.name);
		if(this.mapped[47] != null){
			this.mapped[47].resolveGeneratedOffsetWithValues("categorical_cross_entropy", "Categorical Cross Entropy","sparse_categorical_cross_entropy", "Sparse Categorical Cross Entropy");
		}
		this.mapped[48] = greycat.types_by_name.get(compute.ComputeOperationAtan.name);
		if(this.mapped[48] != null){
			this.mapped[48].resolveGeneratedOffsets("input","output");
		}
		this.mapped[49] = greycat.types_by_name.get(compute.ComputeInitializerNone.name);
		this.mapped[50] = greycat.types_by_name.get(compute.ComputeOptimizerAdaGrad.name);
		if(this.mapped[50] != null){
			this.mapped[50].resolveGeneratedOffsets("learning_rate","initial_accumulator","smooth_epsilon");
		}
		if(this.mapped[50] != null){
			this.mapped[50].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4562254508917369340L),java.lang.Double.longBitsToDouble(4591870180066957722L),java.lang.Double.longBitsToDouble(4502148214488346440L)};
		}
		this.mapped[51] = greycat.types_by_name.get(compute.ComputeOperationAvg.name);
		if(this.mapped[51] != null){
			this.mapped[51].resolveGeneratedOffsets("input","input2","output");
		}
		this.mapped[52] = greycat.types_by_name.get(compute.ComputeOperationSigmoid.name);
		if(this.mapped[52] != null){
			this.mapped[52].resolveGeneratedOffsets("input","output");
		}
		this.mapped[53] = greycat.types_by_name.get(compute.ComputeOperationArgMax.name);
		if(this.mapped[53] != null){
			this.mapped[53].resolveGeneratedOffsets("input","output","output2");
		}
		this.mapped[54] = greycat.types_by_name.get(compute.ComputeOperationAcosh.name);
		if(this.mapped[54] != null){
			this.mapped[54].resolveGeneratedOffsets("input","output");
		}
		this.mapped[55] = greycat.types_by_name.get(compute.ComputeLayerCall.name);
		if(this.mapped[55] != null){
			this.mapped[55].resolveGeneratedOffsets("layer_name","bindings");
		}
		this.mapped[56] = greycat.types_by_name.get(compute.ComputeOperationRaiseToPower.name);
		if(this.mapped[56] != null){
			this.mapped[56].resolveGeneratedOffsets("input","output","power");
		}
		this.mapped[57] = greycat.types_by_name.get(compute.ComputeLayerActivation.name);
		if(this.mapped[57] != null){
			this.mapped[57].resolveGeneratedOffsets("name","activation");
		}
		if(this.mapped[57] != null){
			this.mapped[57].static_values = new java.lang.Object[]{"input","output"};
		}
		this.mapped[58] = greycat.types_by_name.get(compute.ComputeOperationSign.name);
		if(this.mapped[58] != null){
			this.mapped[58].resolveGeneratedOffsets("input","output");
		}
		this.mapped[59] = greycat.types_by_name.get(compute.ComputeVar.name);
		if(this.mapped[59] != null){
			this.mapped[59].resolveGeneratedOffsets("name");
		}
		this.mapped[60] = greycat.types_by_name.get(compute.ComputeOptimizerAdaDelta.name);
		if(this.mapped[60] != null){
			this.mapped[60].resolveGeneratedOffsets("learning_rate","decay_rate","smooth_epsilon");
		}
		if(this.mapped[60] != null){
			this.mapped[60].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4562254508917369340L),java.lang.Double.longBitsToDouble(4606732058837280358L),java.lang.Double.longBitsToDouble(4502148214488346440L)};
		}
		this.mapped[61] = greycat.types_by_name.get(compute.ComputeOperation2In1Out.name);
		if(this.mapped[61] != null){
			this.mapped[61].resolveGeneratedOffsets("input","input2","output");
		}
		this.mapped[62] = greycat.types_by_name.get(compute.ComputeModel.name);
		if(this.mapped[62] != null){
			this.mapped[62].resolveGeneratedOffsets("layers");
		}
		this.mapped[63] = greycat.types_by_name.get(compute.ComputeActivationSoftmax.name);
		if(this.mapped[63] != null){
			this.mapped[63].resolveGeneratedOffsets("classes");
		}
		this.mapped[64] = greycat.types_by_name.get(compute.ComputeInitializerLeCunUniform.name);
		this.mapped[65] = greycat.types_by_name.get(compute.ComputeActivationExp.name);
		this.mapped[66] = greycat.types_by_name.get(compute.ComputeLayerFilter.name);
		if(this.mapped[66] != null){
			this.mapped[66].resolveGeneratedOffsets("name","type","inputs","outputs","maskValues");
		}
		if(this.mapped[66] != null){
			this.mapped[66].static_values = new java.lang.Object[]{"input","output","mask"};
		}
		this.mapped[67] = greycat.types_by_name.get(compute.ComputeInitializerRelu.name);
		this.mapped[68] = greycat.types_by_name.get(compute.ComputeInitializerConstant.name);
		if(this.mapped[68] != null){
			this.mapped[68].resolveGeneratedOffsets("value");
		}
		this.mapped[69] = greycat.types_by_name.get(compute.ComputeVarInOut.name);
		if(this.mapped[69] != null){
			this.mapped[69].resolveGeneratedOffsets("name","type","shape","with_grad");
		}
		this.mapped[70] = greycat.types_by_name.get(compute.ComputeOptimizerAdaMax.name);
		if(this.mapped[70] != null){
			this.mapped[70].resolveGeneratedOffsets("learning_rate","beta1","beta2","smooth_epsilon");
		}
		if(this.mapped[70] != null){
			this.mapped[70].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4562254508917369340L),java.lang.Double.longBitsToDouble(4606281698874543309L),java.lang.Double.longBitsToDouble(4607173411600762667L),java.lang.Double.longBitsToDouble(4502148214488346440L)};
		}
		this.mapped[71] = greycat.types_by_name.get(compute.ComputeOperationScale.name);
		if(this.mapped[71] != null){
			this.mapped[71].resolveGeneratedOffsets("input","output","alpha");
		}
		this.mapped[72] = greycat.types_by_name.get(compute.ComputeOperationAsinh.name);
		if(this.mapped[72] != null){
			this.mapped[72].resolveGeneratedOffsets("input","output");
		}
		this.mapped[73] = greycat.types_by_name.get(compute.ComputeInitializerPytorch.name);
		this.mapped[74] = greycat.types_by_name.get(compute.ComputeVarProxy.name);
		if(this.mapped[74] != null){
			this.mapped[74].resolveGeneratedOffsets("name");
		}
		this.mapped[75] = greycat.types_by_name.get(compute.ComputeInitializerUniformOut.name);
		this.mapped[76] = greycat.types_by_name.get(compute.ComputeOperationCosh.name);
		if(this.mapped[76] != null){
			this.mapped[76].resolveGeneratedOffsets("input","output");
		}
		this.mapped[77] = greycat.types_by_name.get(compute.ComputeOperationLogSoftmax.name);
		if(this.mapped[77] != null){
			this.mapped[77].resolveGeneratedOffsets("input","output","axis");
		}
		this.mapped[78] = greycat.types_by_name.get(compute.ComputeOperationSum.name);
		if(this.mapped[78] != null){
			this.mapped[78].resolveGeneratedOffsets("input","output","axis");
		}
		this.mapped[79] = greycat.types_by_name.get(compute.ComputeVariable.name);
		if(this.mapped[79] != null){
			this.mapped[79].resolveGeneratedOffsets("name");
		}
		this.mapped[80] = greycat.types_by_name.get(compute.ComputeLayerClassification.name);
		if(this.mapped[80] != null){
			this.mapped[80].resolveGeneratedOffsets("name","calculate_probabilities","from_logits");
		}
		if(this.mapped[80] != null){
			this.mapped[80].static_values = new java.lang.Object[]{"input","predicted_classes","probabilities"};
		}
		this.mapped[81] = greycat.types_by_name.get(compute.ComputeOperationAbs.name);
		if(this.mapped[81] != null){
			this.mapped[81].resolveGeneratedOffsets("input","output");
		}
		this.mapped[82] = greycat.types_by_name.get(compute.ComputeActivationSoftSign.name);
		this.mapped[83] = greycat.types_by_name.get(compute.ComputeOperationMul.name);
		if(this.mapped[83] != null){
			this.mapped[83].resolveGeneratedOffsets("input","input2","output");
		}
		this.mapped[84] = greycat.types_by_name.get(compute.ComputeOperationMatMul.name);
		if(this.mapped[84] != null){
			this.mapped[84].resolveGeneratedOffsets("input","input2","output","transposeA","transposeB","alpha","beta");
		}
		if(this.mapped[84] != null){
			this.mapped[84].static_values = new java.lang.Object[]{false,java.lang.Double.longBitsToDouble(4607182418800017408L),java.lang.Double.longBitsToDouble(0L)};
		}
		this.mapped[85] = greycat.types_by_name.get(compute.ComputeOptimizerMomentum.name);
		if(this.mapped[85] != null){
			this.mapped[85].resolveGeneratedOffsets("learning_rate","decay_rate");
		}
		if(this.mapped[85] != null){
			this.mapped[85].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4562254508917369340L),java.lang.Double.longBitsToDouble(4606281698874543309L)};
		}
		this.mapped[86] = greycat.types_by_name.get(compute.ComputeOperationAcos.name);
		if(this.mapped[86] != null){
			this.mapped[86].resolveGeneratedOffsets("input","output");
		}
		this.mapped[87] = greycat.types_by_name.get(compute.ComputeInitializerNormalAvg.name);
		this.mapped[88] = greycat.types_by_name.get(compute.ComputeOperationSumIf.name);
		if(this.mapped[88] != null){
			this.mapped[88].resolveGeneratedOffsets("input","ifCondition","output","counts","classes");
		}
		this.mapped[89] = greycat.types_by_name.get(compute.ComputeLayerCustom.name);
		if(this.mapped[89] != null){
			this.mapped[89].resolveGeneratedOffsets("name","ops","vars");
		}
		this.mapped[90] = greycat.types_by_name.get(compute.ComputeOperationHardSigmoid.name);
		if(this.mapped[90] != null){
			this.mapped[90].resolveGeneratedOffsets("input","output","slope","shift");
		}
		if(this.mapped[90] != null){
			this.mapped[90].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4596373779694328218L),java.lang.Double.longBitsToDouble(4602678819172646912L)};
		}
		this.mapped[91] = greycat.types_by_name.get(compute.ComputeOperationExp.name);
		if(this.mapped[91] != null){
			this.mapped[91].resolveGeneratedOffsets("input","output");
		}
		this.mapped[92] = greycat.types_by_name.get(compute.ComputeLayerPCAScaler.name);
		if(this.mapped[92] != null){
			this.mapped[92].resolveGeneratedOffsets("name","type","inverse_transform");
		}
		if(this.mapped[92] != null){
			this.mapped[92].static_values = new java.lang.Object[]{"input","output","avg","std","space"};
		}
		this.mapped[93] = greycat.types_by_name.get(compute.ComputeLayerDense.name);
		if(this.mapped[93] != null){
			this.mapped[93].resolveGeneratedOffsets("name","type","inputs","outputs","use_bias","weight_initializer","weight_regularizer","bias_initializer","bias_regularizer","activation");
		}
		if(this.mapped[93] != null){
			this.mapped[93].static_values = new java.lang.Object[]{"input","output","weight","bias","mult","pre_activation"};
		}
		this.mapped[94] = greycat.types_by_name.get(compute.ComputeReduction.name);
		...
		this.mapped[95] = greycat.types_by_name.get(compute.ComputeOperationSelu.name);
		if(this.mapped[95] != null){
			this.mapped[95].resolveGeneratedOffsets("input","output");
		}
		this.mapped[96] = greycat.types_by_name.get(compute.ComputeOptimizerNesterov.name);
		if(this.mapped[96] != null){
			this.mapped[96].resolveGeneratedOffsets("learning_rate","decay_rate");
		}
		if(this.mapped[96] != null){
			this.mapped[96].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4562254508917369340L),java.lang.Double.longBitsToDouble(4606281698874543309L)};
		}
		this.mapped[97] = greycat.types_by_name.get(compute.ComputeInitializerIdentity.name);
		this.mapped[98] = greycat.types_by_name.get(compute.ComputeActivationRelu.name);
		if(this.mapped[98] != null){
			this.mapped[98].resolveGeneratedOffsets("max_value","threshold");
		}
		if(this.mapped[98] != null){
			this.mapped[98].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(0L)};
		}
		this.mapped[99] = greycat.types_by_name.get(compute.ComputeLayerLinear.name);
		if(this.mapped[99] != null){
			this.mapped[99].resolveGeneratedOffsets("name","type","inputs","outputs","use_bias","weight_initializer","weight_regularizer","bias_initializer","bias_regularizer");
		}
		if(this.mapped[99] != null){
			this.mapped[99].static_values = new java.lang.Object[]{"input","output","weight","bias","mult"};
		}
		this.mapped[100] = greycat.types_by_name.get(compute.ComputeActivationCelu.name);
		if(this.mapped[100] != null){
			this.mapped[100].resolveGeneratedOffsets("alpha");
		}
		if(this.mapped[100] != null){
			this.mapped[100].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4607182418800017408L)};
		}
		this.mapped[101] = greycat.types_by_name.get(compute.ComputeOperationAtanh.name);
		if(this.mapped[101] != null){
			this.mapped[101].resolveGeneratedOffsets("input","output");
		}
		this.mapped[102] = greycat.types_by_name.get(compute.ComputeInitializer.name);
		this.mapped[103] = greycat.types_by_name.get(compute.ComputeOperationCelu.name);
		if(this.mapped[103] != null){
			this.mapped[103].resolveGeneratedOffsets("input","output","alpha");
		}
		if(this.mapped[103] != null){
			this.mapped[103].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4607182418800017408L)};
		}
		this.mapped[104] = greycat.types_by_name.get(compute.ComputeOperationFilter.name);
		if(this.mapped[104] != null){
			this.mapped[104].resolveGeneratedOffsets("input","output","mask","nbOutputs");
		}
		this.mapped[105] = greycat.types_by_name.get(compute.ComputeActivationSigmoid.name);
		this.mapped[106] = greycat.types_by_name.get(compute.ComputeOperation.name);
		this.mapped[107] = greycat.types_by_name.get(compute.ComputeInitializerNormalIn.name);
		this.mapped[108] = greycat.types_by_name.get(compute.ComputeOperationSin.name);
		if(this.mapped[108] != null){
			this.mapped[108].resolveGeneratedOffsets("input","output");
		}
		this.mapped[109] = greycat.types_by_name.get(compute.ComputeOperationAdd.name);
		if(this.mapped[109] != null){
			this.mapped[109].resolveGeneratedOffsets("input","input2","output");
		}
		this.mapped[110] = greycat.types_by_name.get(compute.ComputeInitializerNormal.name);
		if(this.mapped[110] != null){
			this.mapped[110].resolveGeneratedOffsets("avg","std");
		}
		this.mapped[111] = greycat.types_by_name.get(compute.ComputeInitializerGlorotUniform.name);
		this.mapped[112] = greycat.types_by_name.get(compute.ComputeVarOptimize.name);
		if(this.mapped[112] != null){
			this.mapped[112].resolveGeneratedOffsets("name","type","shape","l1","l2","init");
		}
		this.mapped[113] = greycat.types_by_name.get(compute.ComputeOptimizerSgd.name);
		if(this.mapped[113] != null){
			this.mapped[113].resolveGeneratedOffsets("learning_rate");
		}
		if(this.mapped[113] != null){
			this.mapped[113].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4576918229304087675L)};
		}
		this.mapped[114] = greycat.types_by_name.get(compute.ComputeOptimizer.name);
		if(this.mapped[114] != null){
			this.mapped[114].resolveGeneratedOffsets("learning_rate");
		}
		this.mapped[115] = greycat.types_by_name.get(compute.ComputeInitializerSigmoidUniform.name);
		this.mapped[116] = greycat.types_by_name.get(compute.ComputeOperationDiv.name);
		if(this.mapped[116] != null){
			this.mapped[116].resolveGeneratedOffsets("input","input2","output");
		}
		this.mapped[117] = greycat.types_by_name.get(compute.ComputeOperation1In1Out.name);
		if(this.mapped[117] != null){
			this.mapped[117].resolveGeneratedOffsets("input","output");
		}
		this.mapped[118] = greycat.types_by_name.get(compute.ComputeOperationClip.name);
		if(this.mapped[118] != null){
			this.mapped[118].resolveGeneratedOffsets("input","output","min","max");
		}
		this.mapped[119] = greycat.types_by_name.get(compute.ComputeInitializerLSTM.name);
		this.mapped[120] = greycat.types_by_name.get(compute.ComputeLayerStandardScaler.name);
		if(this.mapped[120] != null){
			this.mapped[120].resolveGeneratedOffsets("name","type","inverse_transform");
		}
		if(this.mapped[120] != null){
			this.mapped[120].static_values = new java.lang.Object[]{"input","output","avg","std"};
		}
		this.mapped[121] = greycat.types_by_name.get(compute.ComputeInitializerReluUniform.name);
		this.mapped[122] = greycat.types_by_name.get(compute.ComputeOperationSoftplus.name);
		if(this.mapped[122] != null){
			this.mapped[122].resolveGeneratedOffsets("input","output");
		}
		this.mapped[123] = greycat.types_by_name.get(compute.ComputeLayerConfusion.name);
		if(this.mapped[123] != null){
			this.mapped[123].resolveGeneratedOffsets("name","nbClass");
		}
		if(this.mapped[123] != null){
			this.mapped[123].static_values = new java.lang.Object[]{"computed","expected","confusion"};
		}
		this.mapped[124] = greycat.types_by_name.get(compute.ComputeOperationTanh.name);
		if(this.mapped[124] != null){
			this.mapped[124].resolveGeneratedOffsets("input","output");
		}
		this.mapped[125] = greycat.types_by_name.get(compute.ComputeActivationLeakyRelu.name);
		if(this.mapped[125] != null){
			this.mapped[125].resolveGeneratedOffsets("alpha","max_value","threshold");
		}
		if(this.mapped[125] != null){
			this.mapped[125].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4599075939470750515L),java.lang.Double.longBitsToDouble(0L)};
		}
		this.mapped[126] = greycat.types_by_name.get(compute.ComputeOperationNeg.name);
		if(this.mapped[126] != null){
			this.mapped[126].resolveGeneratedOffsets("input","output");
		}
		this.mapped[127] = greycat.types_by_name.get(compute.ComputeOptimizerAdam.name);
		if(this.mapped[127] != null){
			this.mapped[127].resolveGeneratedOffsets("learning_rate","beta1","beta2","smooth_epsilon");
		}
		if(this.mapped[127] != null){
			this.mapped[127].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4562254508917369340L),java.lang.Double.longBitsToDouble(4606281698874543309L),java.lang.Double.longBitsToDouble(4607173411600762667L),java.lang.Double.longBitsToDouble(4502148214488346440L)};
		}
		this.mapped[128] = greycat.types_by_name.get(compute.ComputeOperationAsin.name);
		if(this.mapped[128] != null){
			this.mapped[128].resolveGeneratedOffsets("input","output");
		}
		this.mapped[129] = greycat.types_by_name.get(compute.ComputeRegressionLoss.name);
		if(this.mapped[129] != null){
			this.mapped[129].resolveGeneratedOffsetWithValues("square", "Square","abs", "Abs");
		}
		this.mapped[130] = greycat.types_by_name.get(compute.ComputeVarConst.name);
		if(this.mapped[130] != null){
			this.mapped[130].resolveGeneratedOffsets("name","type","shape");
		}
		this.mapped[131] = greycat.types_by_name.get(compute.ComputeActivationSelu.name);
		this.mapped[132] = greycat.types_by_name.get(compute.ComputeLayerSeq.name);
		if(this.mapped[132] != null){
			this.mapped[132].resolveGeneratedOffsets("name","calls","optimizer");
		}
		this.mapped[133] = greycat.types_by_name.get(compute.ComputeInitializerXavier.name);
		this.mapped[134] = greycat.types_by_name.get(compute.ComputeOperationLeakyRelu.name);
		if(this.mapped[134] != null){
			this.mapped[134].resolveGeneratedOffsets("input","output","alpha","max_value","threshold");
		}
		if(this.mapped[134] != null){
			this.mapped[134].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4599075939470750515L),java.lang.Double.longBitsToDouble(9218868437227405311L),java.lang.Double.longBitsToDouble(0L)};
		}
		this.mapped[135] = greycat.types_by_name.get(compute.ComputeOperationLog.name);
		if(this.mapped[135] != null){
			this.mapped[135].resolveGeneratedOffsets("input","output");
		}
		this.mapped[136] = greycat.types_by_name.get(compute.ComputeActivationTanh.name);
		this.mapped[137] = greycat.types_by_name.get(compute.ComputeInitializerXavierUniform.name);
		this.mapped[138] = greycat.types_by_name.get(compute.ComputeOperationArg.name);
		if(this.mapped[138] != null){
			this.mapped[138].resolveGeneratedOffsets("input","output","output2");
		}
		this.mapped[139] = greycat.types_by_name.get(compute.ComputeOperationPow.name);
		if(this.mapped[139] != null){
			this.mapped[139].resolveGeneratedOffsets("input","input2","output");
		}
		this.mapped[140] = greycat.types_by_name.get(compute.ComputeOperationSub.name);
		if(this.mapped[140] != null){
			this.mapped[140].resolveGeneratedOffsets("input","input2","output");
		}
		this.mapped[141] = greycat.types_by_name.get(compute.ComputeActivationHardSigmoid.name);
		if(this.mapped[141] != null){
			this.mapped[141].resolveGeneratedOffsets("slope","shift");
		}
		if(this.mapped[141] != null){
			this.mapped[141].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4596373779694328218L),java.lang.Double.longBitsToDouble(4602678819172646912L)};
		}
		this.mapped[142] = greycat.types_by_name.get(compute.ComputeOperationLeCunTanh.name);
		if(this.mapped[142] != null){
			this.mapped[142].resolveGeneratedOffsets("input","output");
		}
		this.mapped[143] = greycat.types_by_name.get(compute.ComputeLayerLossRegression.name);
		if(this.mapped[143] != null){
			this.mapped[143].resolveGeneratedOffsets("name","reduction","loss_type");
		}
		this.mapped[144] = greycat.types_by_name.get(compute.ComputeOperationFill.name);
		if(this.mapped[144] != null){
			this.mapped[144].resolveGeneratedOffsets("input","value");
		}
		this.mapped[145] = greycat.types_by_name.get(compute.ComputeActivationSoftplus.name);
		this.mapped[146] = greycat.types_by_name.get(compute.ComputeLayerLSTM.name);
		if(this.mapped[146] != null){
			this.mapped[146].resolveGeneratedOffsets("name","bias_initializer","weight_regularizer","bias_regularizer","type","use_bias","return_sequences","bidirectional","auto_init_states","inputs","outputs","layers","sequences");
		}
		if(this.mapped[146] != null){
			this.mapped[146].static_values = new java.lang.Object[]{"input","output","hx","cx","hy","cy","weight","bias","internal_i","internal_f","internal_cp","internal_o","internal_h","internal_c","internal_mult","internal_output"};
		}
		this.mapped[147] = greycat.types_by_name.get(compute.ComputeOptimizerFtrl.name);
		if(this.mapped[147] != null){
			this.mapped[147].resolveGeneratedOffsets("learning_rate","lambda1","lambda2","beta");
		}
		if(this.mapped[147] != null){
			this.mapped[147].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4562254508917369340L),java.lang.Double.longBitsToDouble(0L),java.lang.Double.longBitsToDouble(0L),java.lang.Double.longBitsToDouble(0L)};
		}
		this.mapped[148] = greycat.types_by_name.get(compute.ComputeOptimizerRmsProp.name);
		if(this.mapped[148] != null){
			this.mapped[148].resolveGeneratedOffsets("learning_rate","decay_rate","smooth_epsilon");
		}
		if(this.mapped[148] != null){
			this.mapped[148].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4562254508917369340L),java.lang.Double.longBitsToDouble(4606281698874543309L),java.lang.Double.longBitsToDouble(4502148214488346440L)};
		}
		this.mapped[149] = greycat.types_by_name.get(compute.ComputeInitializerUniformIn.name);
		this.mapped[150] = greycat.types_by_name.get(compute.ComputeOperationSinh.name);
		if(this.mapped[150] != null){
			this.mapped[150].resolveGeneratedOffsets("input","output");
		}
		this.mapped[151] = greycat.types_by_name.get(compute.ComputeState.name);
		this.mapped[152] = greycat.types_by_name.get(compute.ComputeOperationEuclidean.name);
		if(this.mapped[152] != null){
			this.mapped[152].resolveGeneratedOffsets("input","input2","output");
		}
		this.mapped[153] = greycat.types_by_name.get(compute.ComputeInitializerUniform.name);
		if(this.mapped[153] != null){
			this.mapped[153].resolveGeneratedOffsets("min","max");
		}
		this.mapped[154] = greycat.types_by_name.get(compute.ComputeOperationAddBias.name);
		if(this.mapped[154] != null){
			this.mapped[154].resolveGeneratedOffsets("input","input2","output");
		}
		this.mapped[155] = greycat.types_by_name.get(compute.ComputeLayer.name);
		if(this.mapped[155] != null){
			this.mapped[155].resolveGeneratedOffsets("name");
		}
		this.mapped[156] = greycat.types_by_name.get(compute.ComputeOperationElu.name);
		if(this.mapped[156] != null){
			this.mapped[156].resolveGeneratedOffsets("input","output","alpha");
		}
		if(this.mapped[156] != null){
			this.mapped[156].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(4607182418800017408L)};
		}
		this.mapped[157] = greycat.types_by_name.get(compute.ComputeLayerLossClassification.name);
		if(this.mapped[157] != null){
			this.mapped[157].resolveGeneratedOffsets("name","reduction","loss_type","has_class_weights","calculate_probabilities","from_logits");
		}
		if(this.mapped[157] != null){
			this.mapped[157].static_values = new java.lang.Object[]{"class_weights","predicted_classes","probabilities","sum_reduce"};
		}
		this.mapped[158] = greycat.types_by_name.get(compute.ComputeOperationRelu.name);
		if(this.mapped[158] != null){
			this.mapped[158].resolveGeneratedOffsets("input","output","max_value","threshold");
		}
		if(this.mapped[158] != null){
			this.mapped[158].static_values = new java.lang.Object[]{java.lang.Double.longBitsToDouble(0L)};
		}
		this.mapped[159] = greycat.types_by_name.get(compute.ComputeBinding.name);
		if(this.mapped[159] != null){
			this.mapped[159].resolveGeneratedOffsets("src_layer_name","src_var_name","target_var_name");
		}
		this.mapped[160] = greycat.types_by_name.get(compute.ComputeInitializerNormalOut.name);
		this.mapped[161] = greycat.types_by_name.get(compute.ComputeOperationArgMin.name);
		if(this.mapped[161] != null){
			this.mapped[161].resolveGeneratedOffsets("input","output","output2");
		}
		this.mapped[162] = greycat.types_by_name.get(compute.ComputeOperationSqrt.name);
		if(this.mapped[162] != null){
			this.mapped[162].resolveGeneratedOffsets("input","output");
		}
		this.mapped[163] = greycat.types_by_name.get(compute.ComputeInitializerUniformAvg.name);
		this.mapped[164] = greycat.types_by_name.get(compute.ComputeLayerLoss.name);
		if(this.mapped[164] != null){
			this.mapped[164].resolveGeneratedOffsets("name","reduction");
		}
		if(this.mapped[164] != null){
			this.mapped[164].static_values = new java.lang.Object[]{"computed","expected","loss"};
		}
		this.mapped[165] = greycat.types_by_name.get(nn.ComputeLayerTypes.name);
		...
		this.mapped[166] = greycat.types_by_name.get(nn.BindingsResult.name);
		if(this.mapped[166] != null){
			this.mapped[166].resolveGeneratedOffsets("previousLayerName","previousLayerOutput","expectedLayerName","expectedLayerOutput","postLayer");
		}
		this.mapped[167] = greycat.types_by_name.get(nn.ComputeActivations.name);
		if(this.mapped[167] != null){
			this.mapped[167].resolveGeneratedOffsetWithValues("relu", "Relu","leaky_relu", "Leaky Relu","sigmoid", "Sigmoid","hard_sigmoid", "Hard Sigmoid","exp", "Exp","soft_max", "Soft Max","soft_plus", "Soft Plus","soft_sign", "Soft Sign","tanh", "Tanh","selu", "Selu","elu", "Elu","celu", "Celu");
		}
		this.mapped[168] = greycat.types_by_name.get(nn.PostProcessType.name);
		if(this.mapped[168] != null){
			this.mapped[168].resolveGeneratedOffsetWithValues("none", "None","min_max_scaling", "Min/Max Scaling","standard_scaling", "Standard Scaling");
		}
		this.mapped[169] = greycat.types_by_name.get(nn.AutoEncoderNetwork.name);
		if(this.mapped[169] != null){
			this.mapped[169].resolveGeneratedOffsets("inputs","inputs_gradients","outputs","fixed_batch_size","inputs_sequences","outputs_sequences","tensor_type","seed","randomizeSeed","layers","preProcessType","preProcessObject","postProcessType","postProcessObject","optimizer","lossLayer","_lastLayer","_lastOutput","encoder_layer_idx","encoder_layer_name","encoder_layer_var");
		}
		this.mapped[170] = greycat.types_by_name.get(nn.InitializerConfig.name);
		if(this.mapped[170] != null){
			this.mapped[170].resolveGeneratedOffsets("weight_initializer","weight_regularizer","bias_initializer","bias_regularizer");
		}
		this.mapped[171] = greycat.types_by_name.get(nn.PreProcessType.name);
		if(this.mapped[171] != null){
			this.mapped[171].resolveGeneratedOffsetWithValues("none", "None","min_max_scaling", "Min/Max Scaling","standard_scaling", "Standard Scaling","pca_scaling", "PCA Scaling");
		}
		this.mapped[172] = greycat.types_by_name.get(nn.ClassificationNetwork.name);
		if(this.mapped[172] != null){
			this.mapped[172].resolveGeneratedOffsets("inputs","inputs_gradients","outputs","fixed_batch_size","inputs_sequences","outputs_sequences","tensor_type","seed","randomizeSeed","layers","preProcessType","preProcessObject","postProcessType","postProcessObject","optimizer","lossLayer","_lastLayer","_lastOutput","calculate_probabilities","has_class_weights","from_logits");
		}
		this.mapped[173] = greycat.types_by_name.get(nn.NeuralNetwork.name);
		if(this.mapped[173] != null){
			this.mapped[173].resolveGeneratedOffsets("inputs","inputs_gradients","outputs","fixed_batch_size","inputs_sequences","outputs_sequences","tensor_type","seed","randomizeSeed","layers","preProcessType","preProcessObject","postProcessType","postProcessObject","optimizer","lossLayer","_lastLayer","_lastOutput");
		}
		if(this.mapped[173] != null){
			this.mapped[173].static_values = new java.lang.Object[]{"Inputs or outputs can't be negative","Last layer has different number of outputs than declared","Incompatible loss function","Some NN layers are not currently supported","Tensor Type not currently supported","NN should contain at least 1 layer","layer placeholders","layer classification","layer preprocess","layer postprocess learn","layer main","layer loss learn","layer loss display","layer postprocess display","layer confusion","seq predict","seq postprocess","seq learn","seq loss display","seq encode","seq decode","seq confusion","var input","var enc input","var targets","var Classifier classes","var Classifier probabilities","var Classifier class weights","var Classifier confusion","var input avg","var input min","var input max","var input std","var input space","var output avg","var output min","var output max","var output std"};
		}
		this.mapped[174] = greycat.types_by_name.get(nn.ComputeInitializers.name);
		if(this.mapped[174] != null){
			this.mapped[174].resolveGeneratedOffsetWithValues("none", "None","constant", "Constant","sigmoid_uniform", "SigmoidUniform","lecun_uniform", "LeCunUniform","xavier", "Xavier","xavier_uniform", "XavierUniform","relu", "Relu","relu_uniform", "ReluUniform","normal", "Normal","normal_in", "NormalIn","normal_out", "NormalOut","normal_avg", "NormalAvg","uniform", "Uniform","uniform_in", "UniformIn","uniform_out", "UniformOut","uniform_avg", "UniformAvg","identity", "Identity","pytorch", "Pytorch");
		}
		this.mapped[175] = greycat.types_by_name.get(nn.ComputeOptimizers.name);
		if(this.mapped[175] != null){
			this.mapped[175].resolveGeneratedOffsetWithValues("ada_delta", "Ada Delta","ada_grad", "Ada Grad","adam", "Adam","ada_max", "Ada Max","nadam", "NAdam","ftrl", "Ftrl","sgd", "Stochastic Gradient Descent","rms_prop", "RMS Prop","momentum", "Momentum","nesterov", "Nesterov");
		}
		this.mapped[176] = greycat.types_by_name.get(nn.RegressionNetwork.name);
		if(this.mapped[176] != null){
			this.mapped[176].resolveGeneratedOffsets("inputs","inputs_gradients","outputs","fixed_batch_size","inputs_sequences","outputs_sequences","tensor_type","seed","randomizeSeed","layers","preProcessType","preProcessObject","postProcessType","postProcessObject","optimizer","lossLayer","_lastLayer","_lastOutput");
		}
		this.mapped[177] = greycat.types_by_name.get(nn.ClassificationMetrics.name);
		if(this.mapped[177] != null){
			this.mapped[177].resolveGeneratedOffsets("precision","recall","f1Score");
		}
	}
}
