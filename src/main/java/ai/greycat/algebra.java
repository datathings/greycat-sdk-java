...
public final class algebra extends ai.greycat.GreyCat.Library {
	...
	public static final class nn_layers_names {
		public static final class NNLayersNames extends GreyCat.Enum {
			...
			public static NNLayersNames create(ai.greycat.GreyCat greycat){
				return new NNLayersNames(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[0]);
			}
		}
	}
	public static final class compute {
		public static final class ComputeOperationSqrt extends GreyCat.Object {
			...
			public static ComputeOperationSqrt create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSqrt(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[1], input, output);
			}
		}
		public static final class ComputeOptimizerSgd extends GreyCat.Object {
			...
			public java.lang.Boolean reduce_sum(){
				return (java.lang.Boolean)super.get(super.type.generated_offsets[0]);
			}
			public void set_reduce_sum(java.lang.Boolean v){
				super.set(super.type.generated_offsets[0],v);
			}
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[2];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Boolean reduce_sum_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[2];
				return (java.lang.Boolean) t.static_values[1];
			}
			public static ComputeOptimizerSgd create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate){
				return new ComputeOptimizerSgd(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[2], reduce_sum, learning_rate);
			}
		}
		public static final class ComputeLayerDense extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[3];
			...
			public static ComputeLayerDense create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Long inputs, java.lang.Long outputs, java.lang.Boolean use_bias, ai.greycat.algebra.compute.ComputeInitializer weight_initializer, ai.greycat.algebra.compute.ComputeRegularizer weight_regularizer, ai.greycat.algebra.compute.ComputeInitializer bias_initializer, ai.greycat.algebra.compute.ComputeRegularizer bias_regularizer, ai.greycat.algebra.compute.ComputeActivation activation){
				return new ComputeLayerDense(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[3], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
			}
		}
		public static final class ComputeOperationAsin extends GreyCat.Object {
			...
			public static ComputeOperationAsin create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAsin(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[4], input, output);
			}
		}
		public static final class ComputeOperationSoftplus extends GreyCat.Object {
			...
			public static ComputeOperationSoftplus create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSoftplus(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[5], input, output);
			}
		}
		public static final class ComputeOptimizerMomentum extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[6];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Boolean reduce_sum_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[6];
			...
			public static ComputeOptimizerMomentum create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate, java.lang.Double decay_rate){
				return new ComputeOptimizerMomentum(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[6], reduce_sum, learning_rate, decay_rate);
			}
		}
		public static final class ComputeOperationLossLog extends GreyCat.Object {
			public static final java.lang.String name = "compute.ComputeOperationLossLog";
			private ComputeOperationLossLog(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			public java.lang.String input(){
				return (java.lang.String)super.get(super.type.generated_offsets[0]);
			...
			public static ComputeOperationLossLog create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationLossLog(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[7], input, input2, output);
			}
		}
		public static final class ComputeOptimizerAdaGrad extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[8];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Boolean reduce_sum_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[8];
			...
			public static ComputeOptimizerAdaGrad create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate, java.lang.Double initial_accumulator, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerAdaGrad(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[8], reduce_sum, learning_rate, initial_accumulator, smooth_epsilon);
			}
		}
		public static final class ComputeActivationExp extends GreyCat.Object {
			...
			public static ComputeActivationExp create(ai.greycat.GreyCat greycat){
				return new ComputeActivationExp(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[9]);
			}
		}
		public static final class ComputeOperationArgMin extends GreyCat.Object {
			...
			public static ComputeOperationArgMin create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.String output2){
				return new ComputeOperationArgMin(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[10], input, output, output2);
			}
		}
		public static final class ComputeOperationFilter extends GreyCat.Object {
			...
			public static ComputeOperationFilter create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.String mask, java.lang.Long nbOutputs){
				return new ComputeOperationFilter(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[11], input, output, mask, nbOutputs);
			}
		}
		public static final class ComputeInitializerIdentity extends GreyCat.Object {
			...
			public static ComputeInitializerIdentity create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerIdentity(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[12]);
			}
		}
		public static final class ComputeOperationLossSoftMaxLog extends GreyCat.Object {
			public static final java.lang.String name = "compute.ComputeOperationLossSoftMaxLog";
			private ComputeOperationLossSoftMaxLog(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			public java.lang.String input(){
				return (java.lang.String)super.get(super.type.generated_offsets[0]);
			...
			public static ComputeOperationLossSoftMaxLog create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationLossSoftMaxLog(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[13], input, input2, output);
			}
		}
		public static final class ComputeOperationArgMax extends GreyCat.Object {
			...
			public static ComputeOperationArgMax create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.String output2){
				return new ComputeOperationArgMax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[14], input, output, output2);
			}
		}
		public static final class ComputeInitializerLeCunUniform extends GreyCat.Object {
			...
			public static ComputeInitializerLeCunUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerLeCunUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[15]);
			}
		}
		public static final class ComputeInitializerUniformIn extends GreyCat.Object {
			...
			public static ComputeInitializerUniformIn create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerUniformIn(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[16]);
			}
		}
		public static final class ComputeOperationSigmoid extends GreyCat.Object {
			...
			public static ComputeOperationSigmoid create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSigmoid(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[17], input, output);
			}
		}
		public static final class ComputeLayerLSTM extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[18];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[18];
			...
			public static ComputeLayerLSTM create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.algebra.compute.ComputeInitializer bias_initializer, ai.greycat.algebra.compute.ComputeRegularizer weight_regularizer, ai.greycat.algebra.compute.ComputeRegularizer bias_regularizer, ai.greycat.std.core.TensorType type, java.lang.Boolean use_bias, java.lang.Boolean return_sequences, java.lang.Boolean bidirectional, java.lang.Boolean auto_init_states, java.lang.Long inputs, java.lang.Long outputs, java.lang.Long layers, java.lang.Long sequences){
				return new ComputeLayerLSTM(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[18], name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences);
			}
		}
		public static final class ComputeVarProxy extends GreyCat.Object {
			...
			public static ComputeVarProxy create(ai.greycat.GreyCat greycat, java.lang.String name){
				return new ComputeVarProxy(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[19], name);
			}
		}
		public static final class ComputeOperationExp extends GreyCat.Object {
			...
			public static ComputeOperationExp create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationExp(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[20], input, output);
			}
		}
		public static final class ComputeInitializerGlorotUniform extends GreyCat.Object {
			...
			public static ComputeInitializerGlorotUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerGlorotUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[21]);
			}
		}
		public static final class ComputeConstVar extends GreyCat.Object {
			public static final java.lang.String name = "compute.ComputeConstVar";
			private ComputeConstVar(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			public java.lang.String name(){
				return (java.lang.String)super.get(super.type.generated_offsets[0]);
			...
			public static ComputeConstVar create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, ai.greycat.std.core.Array<java.lang.Long> shape){
				return new ComputeConstVar(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[22], name, type, shape);
			}
		}
		public static final class ComputeOperationSin extends GreyCat.Object {
			...
			public static ComputeOperationSin create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSin(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[23], input, output);
			}
		}
		public static final class ComputeLayerStandardScaler extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[24];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[24];
			...
			public static ComputeLayerStandardScaler create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Boolean inverse_transform){
				return new ComputeLayerStandardScaler(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[24], name, type, inverse_transform);
			}
		}
		public static final class ComputeOperationLog extends GreyCat.Object {
			...
			public static ComputeOperationLog create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationLog(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[25], input, output);
			}
		}
		public static final class ComputeOperationEuclidean extends GreyCat.Object {
			...
			public static ComputeOperationEuclidean create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationEuclidean(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[26], input, input2, output);
			}
		}
		public static final class ComputeOperationSign extends GreyCat.Object {
			...
			public static ComputeOperationSign create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSign(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[27], input, output);
			}
		}
		public static final class ComputeOperationSoftSign extends GreyCat.Object {
			...
			public static ComputeOperationSoftSign create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSoftSign(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[28], input, output);
			}
		}
		public static final class ComputeOperationLogSoftmax extends GreyCat.Object {
			...
			public static ComputeOperationLogSoftmax create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Long axis){
				return new ComputeOperationLogSoftmax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[29], input, output, axis);
			}
		}
		public static final class ComputeOperation extends GreyCat.Object {
			...
			public static ComputeOperation create(ai.greycat.GreyCat greycat){
				return new ComputeOperation(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[30]);
			}
		}
		public static final class ComputeLayerLinear extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[31];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[31];
			...
			public static ComputeLayerLinear create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Long inputs, java.lang.Long outputs, java.lang.Boolean use_bias, ai.greycat.algebra.compute.ComputeInitializer weight_initializer, ai.greycat.algebra.compute.ComputeRegularizer weight_regularizer, ai.greycat.algebra.compute.ComputeInitializer bias_initializer, ai.greycat.algebra.compute.ComputeRegularizer bias_regularizer){
				return new ComputeLayerLinear(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[31], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
			}
		}
		public static final class ComputeInitializerRelu extends GreyCat.Object {
			...
			public static ComputeInitializerRelu create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[32]);
			}
		}
		public static final class ComputeActivationSoftplus extends GreyCat.Object {
			...
			public static ComputeActivationSoftplus create(ai.greycat.GreyCat greycat){
				return new ComputeActivationSoftplus(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[33]);
			}
		}
		public static final class ComputeActivationTanh extends GreyCat.Object {
			...
			public static ComputeActivationTanh create(ai.greycat.GreyCat greycat){
				return new ComputeActivationTanh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[34]);
			}
		}
		public static final class ComputeLayerActivation extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[35];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[35];
			...
			public static ComputeLayerActivation create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.algebra.compute.ComputeActivation activation){
				return new ComputeLayerActivation(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[35], name, activation);
			}
		}
		public static final class ComputeLayerPCAScaler extends GreyCat.Object {
			...
			public static java.lang.String var_input_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[36];
				return (java.lang.String) t.static_values[0];
			}
			public static java.lang.String var_output_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[36];
			...
			public static ComputeLayerPCAScaler create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Boolean inverse_transform){
				return new ComputeLayerPCAScaler(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[36], name, type, inverse_transform);
			}
		}
		public static final class ComputeInitializerSigmoidUniform extends GreyCat.Object {
			...
			public static ComputeInitializerSigmoidUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerSigmoidUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[37]);
			}
		}
		public static final class ComputeOptimizerNadam extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[38];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Boolean reduce_sum_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[38];
			...
			public static ComputeOptimizerNadam create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate, java.lang.Double beta1, java.lang.Double beta2, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerNadam(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[38], reduce_sum, learning_rate, beta1, beta2, smooth_epsilon);
			}
		}
		public static final class ComputeActivationSigmoid extends GreyCat.Object {
			...
			public static ComputeActivationSigmoid create(ai.greycat.GreyCat greycat){
				return new ComputeActivationSigmoid(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[39]);
			}
		}
		public static final class ComputeOperationTanh extends GreyCat.Object {
			...
			public static ComputeOperationTanh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationTanh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[40], input, output);
			}
		}
		public static final class ComputeOperationSoftmax extends GreyCat.Object {
			...
			public static ComputeOperationSoftmax create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Long axis){
				return new ComputeOperationSoftmax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[41], input, output, axis);
			}
		}
		public static final class ComputeOperationPow extends GreyCat.Object {
			...
			public static ComputeOperationPow create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationPow(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[42], input, input2, output);
			}
		}
		public static final class ComputeOperationAcosh extends GreyCat.Object {
			...
			public static ComputeOperationAcosh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAcosh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[43], input, output);
			}
		}
		public static final class ComputeOperation1In1Out extends GreyCat.Object {
			...
			public static ComputeOperation1In1Out create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperation1In1Out(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[44], input, output);
			}
		}
		public static final class ComputeOperationAcos extends GreyCat.Object {
			...
			public static ComputeOperationAcos create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAcos(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[45], input, output);
			}
		}
		public static final class ComputeInOutVar extends GreyCat.Object {
			public static final java.lang.String name = "compute.ComputeInOutVar";
			private ComputeInOutVar(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			public java.lang.String name(){
				return (java.lang.String)super.get(super.type.generated_offsets[0]);
			...
			public static ComputeInOutVar create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, ai.greycat.std.core.Array<java.lang.Long> shape, java.lang.Boolean with_grad){
				return new ComputeInOutVar(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[46], name, type, shape, with_grad);
			}
		}
		public static final class ComputeInitializerPytorch extends GreyCat.Object {
			...
			public static ComputeInitializerPytorch create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerPytorch(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[47]);
			}
		}
		public static final class ComputeOperationCos extends GreyCat.Object {
			...
			public static ComputeOperationCos create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationCos(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[48], input, output);
			}
		}
		public static final class ComputeOperationAtanh extends GreyCat.Object {
			...
			public static ComputeOperationAtanh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAtanh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[49], input, output);
			}
		}
		public static final class ComputeOptimizerRmsProp extends GreyCat.Object {
			...
			public static ComputeOptimizerRmsProp create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate, java.lang.Double decay_rate, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerRmsProp(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[50], reduce_sum, learning_rate, decay_rate, smooth_epsilon);
			}
		}
		public static final class ComputeOptimizerFtrl extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[51];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Boolean reduce_sum_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[51];
			...
			public static ComputeOptimizerFtrl create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate, java.lang.Double lambda1, java.lang.Double lambda2, java.lang.Double beta){
				return new ComputeOptimizerFtrl(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[51], reduce_sum, learning_rate, lambda1, lambda2, beta);
			}
		}
		public static final class ComputeOperationDiv extends GreyCat.Object {
			...
			public static ComputeOperationDiv create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationDiv(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[52], input, input2, output);
			}
		}
		public static final class ComputeActivationCelu extends GreyCat.Object {
			...
			public static java.lang.Double alpha_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[53];
				return (java.lang.Double) t.static_values[0];
			}
			public static ComputeActivationCelu create(ai.greycat.GreyCat greycat, java.lang.Double alpha){
				return new ComputeActivationCelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[53], alpha);
			}
		}
		public static final class ComputeActivationHardSigmoid extends GreyCat.Object {
			...
			public static ComputeActivationHardSigmoid create(ai.greycat.GreyCat greycat, java.lang.Double slope, java.lang.Double shift){
				return new ComputeActivationHardSigmoid(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[54], slope, shift);
			}
		}
		public static final class ComputeOperationTan extends GreyCat.Object {
			...
			public static ComputeOperationTan create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationTan(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[55], input, output);
			}
		}
		public static final class ComputeBinding extends GreyCat.Object {
			...
			public static ComputeBinding create(ai.greycat.GreyCat greycat, java.lang.String src_layer_name, java.lang.String src_var_name, java.lang.String target_var_name){
				return new ComputeBinding(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[56], src_layer_name, src_var_name, target_var_name);
			}
		}
		public static final class ComputeOperationLeakyRelu extends GreyCat.Object {
			...
			public static ComputeOperationLeakyRelu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double alpha, java.lang.Double max_value, java.lang.Double threshold){
				return new ComputeOperationLeakyRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[57], input, output, alpha, max_value, threshold);
			}
		}
		public static final class ComputeOptimizerNesterov extends GreyCat.Object {
			...
			public static ComputeOptimizerNesterov create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate, java.lang.Double decay_rate){
				return new ComputeOptimizerNesterov(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[58], reduce_sum, learning_rate, decay_rate);
			}
		}
		public static final class ComputeInitializerXavier extends GreyCat.Object {
			...
			public static ComputeInitializerXavier create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerXavier(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[59]);
			}
		}
		public static final class ComputeOperationLossSquare extends GreyCat.Object {
			public static final java.lang.String name = "compute.ComputeOperationLossSquare";
			private ComputeOperationLossSquare(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			public java.lang.String input(){
				return (java.lang.String)super.get(super.type.generated_offsets[0]);
			...
			public static ComputeOperationLossSquare create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationLossSquare(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[60], input, input2, output);
			}
		}
		public static final class ComputeVar extends GreyCat.Object {
			...
			public static ComputeVar create(ai.greycat.GreyCat greycat, java.lang.String name){
				return new ComputeVar(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[61], name);
			}
		}
		public static final class ComputeInitializerNormalOut extends GreyCat.Object {
			...
			public static ComputeInitializerNormalOut create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerNormalOut(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[62]);
			}
		}
		public static final class ComputeActivationSoftmax extends GreyCat.Object {
			...
			public static ComputeActivationSoftmax create(ai.greycat.GreyCat greycat, java.lang.Long axis){
				return new ComputeActivationSoftmax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[63], axis);
			}
		}
		public static final class ComputeOperationClip extends GreyCat.Object {
			...
			public static ComputeOperationClip create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double min, java.lang.Double max){
				return new ComputeOperationClip(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[64], input, output, min, max);
			}
		}
		public static final class ComputeOperationAsinh extends GreyCat.Object {
			...
			public static ComputeOperationAsinh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAsinh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[65], input, output);
			}
		}
		public static final class ComputeOperationCosh extends GreyCat.Object {
			...
			public static ComputeOperationCosh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationCosh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[66], input, output);
			}
		}
		public static final class ComputeInitializerNormal extends GreyCat.Object {
			...
			public static ComputeInitializerNormal create(ai.greycat.GreyCat greycat, java.lang.Double avg, java.lang.Double std){
				return new ComputeInitializerNormal(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[67], avg, std);
			}
		}
		public static final class ComputeOperationRaiseToPower extends GreyCat.Object {
			...
			public static ComputeOperationRaiseToPower create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double power){
				return new ComputeOperationRaiseToPower(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[68], input, output, power);
			}
		}
		public static final class ComputeOptimizer extends GreyCat.Object {
			...
			public static ComputeOptimizer create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate){
				return new ComputeOptimizer(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[69], reduce_sum, learning_rate);
			}
		}
		public static final class ComputeOperation2In1Out extends GreyCat.Object {
			...
			public static ComputeOperation2In1Out create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperation2In1Out(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[70], input, input2, output);
			}
		}
		public static final class ComputeOperationSelu extends GreyCat.Object {
			...
			public static ComputeOperationSelu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[71], input, output);
			}
		}
		public static final class ComputeInitializerLSTM extends GreyCat.Object {
			...
			public static ComputeInitializerLSTM create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerLSTM(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[72]);
			}
		}
		public static final class ComputeOperationScale extends GreyCat.Object {
			...
			public static ComputeOperationScale create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double alpha){
				return new ComputeOperationScale(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[73], input, output, alpha);
			}
		}
		public static final class ComputeInitializerXavierUniform extends GreyCat.Object {
			...
			public static ComputeInitializerXavierUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerXavierUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[74]);
			}
		}
		public static final class ComputeActivationSoftSign extends GreyCat.Object {
			...
			public static ComputeActivationSoftSign create(ai.greycat.GreyCat greycat){
				return new ComputeActivationSoftSign(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[75]);
			}
		}
		public static final class ComputeEngine extends ai.greycat.algebra_n.compute.ComputeEngine {
			...
			public static ComputeEngine create(ai.greycat.GreyCat greycat){
				return new ComputeEngine(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[76]);
			}
		}
		public static final class ComputeOperationRelu extends GreyCat.Object {
			...
			public static java.lang.Double threshold_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[77];
				return (java.lang.Double) t.static_values[0];
			}
			public static ComputeOperationRelu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double max_value, java.lang.Double threshold){
				return new ComputeOperationRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[77], input, output, max_value, threshold);
			}
		}
		public static final class ComputeInitializerUniformAvg extends GreyCat.Object {
			...
			public static ComputeInitializerUniformAvg create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerUniformAvg(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[78]);
			}
		}
		public static final class ComputeOperationMul extends GreyCat.Object {
			...
			public static ComputeOperationMul create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationMul(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[79], input, input2, output);
			}
		}
		public static final class ComputeLayerLoss extends GreyCat.Object {
			...
			public ai.greycat.algebra.compute.ComputeLossType type(){
				return (ai.greycat.algebra.compute.ComputeLossType)super.get(super.type.generated_offsets[1]);
			}
			public void set_type(ai.greycat.algebra.compute.ComputeLossType v){
				super.set(super.type.generated_offsets[1],v);
			}
			...
			public static ComputeLayerLoss create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.algebra.compute.ComputeLossType type){
				return new ComputeLayerLoss(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[80], name, type);
			}
		}
		public static final class ComputeActivation extends GreyCat.Object {
			...
			public static ComputeActivation create(ai.greycat.GreyCat greycat){
				return new ComputeActivation(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[81]);
			}
		}
		public static final class ComputeLayerCustom extends GreyCat.Object {
			...
			public ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeVar> vars(){
				return (ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeVar>)super.get(super.type.generated_offsets[2]);
			}
			public void set_vars(ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeVar> v){
				super.set(super.type.generated_offsets[2],v);
			}
			public static ComputeLayerCustom create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeOperation> ops, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeVar> vars){
				return new ComputeLayerCustom(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[82], name, ops, vars);
			}
		}
		public static final class ComputeLossType extends GreyCat.Enum {
			public static final java.lang.String name = "compute.ComputeLossType";
			private ComputeLossType(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			public static ai.greycat.algebra.compute.ComputeLossType square(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[83];
				return (ai.greycat.algebra.compute.ComputeLossType) t.enum_values[t.generated_offsets[0]];
			}
			public static ai.greycat.algebra.compute.ComputeLossType abs(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[83];
				return (ai.greycat.algebra.compute.ComputeLossType) t.enum_values[t.generated_offsets[1]];
			}
			public static ai.greycat.algebra.compute.ComputeLossType log(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[83];
				return (ai.greycat.algebra.compute.ComputeLossType) t.enum_values[t.generated_offsets[2]];
			}
			public static ai.greycat.algebra.compute.ComputeLossType softmax_log(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[83];
				return (ai.greycat.algebra.compute.ComputeLossType) t.enum_values[t.generated_offsets[3]];
			}
			public static ComputeLossType create(ai.greycat.GreyCat greycat){
				return new ComputeLossType(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[83]);
			}
		}
		public static final class ComputeInitializerNone extends GreyCat.Object {
			...
			public static ComputeInitializerNone create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerNone(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[84]);
			}
		}
		public static final class ComputeOperationAtan extends GreyCat.Object {
			...
			public static ComputeOperationAtan create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAtan(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[85], input, output);
			}
		}
		public static final class ComputeOperationAdd extends GreyCat.Object {
			...
			public static ComputeOperationAdd create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationAdd(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[86], input, input2, output);
			}
		}
		public static final class ComputeInitializerReluUniform extends GreyCat.Object {
			...
			public static ComputeInitializerReluUniform create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerReluUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[87]);
			}
		}
		public static final class ComputeLayerCall extends GreyCat.Object {
			...
			public static ComputeLayerCall create(ai.greycat.GreyCat greycat, java.lang.String layer_name, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeBinding> bindings){
				return new ComputeLayerCall(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[88], layer_name, bindings);
			}
		}
		public static final class ComputeLayer extends GreyCat.Object {
			...
			public static ComputeLayer create(ai.greycat.GreyCat greycat, java.lang.String name){
				return new ComputeLayer(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[89], name);
			}
		}
		public static final class ComputeOperationSum extends GreyCat.Object {
			...
			public static ComputeOperationSum create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Long axis){
				return new ComputeOperationSum(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[90], input, output, axis);
			}
		}
		public static final class ComputeOperationArg extends GreyCat.Object {
			...
			public static ComputeOperationArg create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.String output2){
				return new ComputeOperationArg(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[91], input, output, output2);
			}
		}
		public static final class ComputeOptimizerAdaMax extends GreyCat.Object {
			...
			public static ComputeOptimizerAdaMax create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate, java.lang.Double beta1, java.lang.Double beta2, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerAdaMax(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[92], reduce_sum, learning_rate, beta1, beta2, smooth_epsilon);
			}
		}
		public static final class ComputeOperationAvg extends GreyCat.Object {
			...
			public static ComputeOperationAvg create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationAvg(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[93], input, input2, output);
			}
		}
		public static final class ComputeActivationRelu extends GreyCat.Object {
			...
			public static ComputeActivationRelu create(ai.greycat.GreyCat greycat, java.lang.Double max_value, java.lang.Double threshold){
				return new ComputeActivationRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[94], max_value, threshold);
			}
		}
		...
		public static final class ComputeOperationHardSigmoid extends GreyCat.Object {
			...
			public static ComputeOperationHardSigmoid create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double slope, java.lang.Double shift){
				return new ComputeOperationHardSigmoid(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[96], input, output, slope, shift);
			}
		}
		public static final class ComputeOperationSumIf extends GreyCat.Object {
			...
			public static ComputeOperationSumIf create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String ifCondition, java.lang.String output, java.lang.String counts, java.lang.Long classes){
				return new ComputeOperationSumIf(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[97], input, ifCondition, output, counts, classes);
			}
		}
		public static final class ComputeLayerMinMaxScaler extends GreyCat.Object {
			...
			public static ComputeLayerMinMaxScaler create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Boolean inverse_transform){
				return new ComputeLayerMinMaxScaler(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[98], name, type, inverse_transform);
			}
		}
		public static final class ComputeOperationCelu extends GreyCat.Object {
			...
			public static ComputeOperationCelu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double alpha){
				return new ComputeOperationCelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[99], input, output, alpha);
			}
		}
		public static final class ComputeVaro extends GreyCat.Object {
			public static final java.lang.String name = "compute.ComputeVaro";
			private ComputeVaro(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			public java.lang.String name(){
				return (java.lang.String)super.get(super.type.generated_offsets[0]);
			...
			public static ComputeVaro create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, ai.greycat.std.core.Array<java.lang.Long> shape, java.lang.Double l1, java.lang.Double l2, ai.greycat.algebra.compute.ComputeInitializer init){
				return new ComputeVaro(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[100], name, type, shape, l1, l2, init);
			}
		}
		public static final class ComputeLayerFilter extends GreyCat.Object {
			...
			public static ComputeLayerFilter create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.TensorType type, java.lang.Long inputs, java.lang.Long outputs, ai.greycat.std.core.Array<java.lang.Long> maskValues){
				return new ComputeLayerFilter(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[101], name, type, inputs, outputs, maskValues);
			}
		}
		public static final class ComputeOperationLossAbstract extends GreyCat.Object {
			public static final java.lang.String name = "compute.ComputeOperationLossAbstract";
			private ComputeOperationLossAbstract(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}
			public java.lang.String input(){
				return (java.lang.String)super.get(super.type.generated_offsets[0]);
			...
			public static ComputeOperationLossAbstract create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationLossAbstract(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[102], input, input2, output);
			}
		}
		public static final class ComputeOperationFill extends GreyCat.Object {
			...
			public static ComputeOperationFill create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.Object value){
				return new ComputeOperationFill(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[103], input, value);
			}
		}
		public static final class ComputeActivationSelu extends GreyCat.Object {
			...
			public static ComputeActivationSelu create(ai.greycat.GreyCat greycat){
				return new ComputeActivationSelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[104]);
			}
		}
		public static final class ComputeInitializerNormalAvg extends GreyCat.Object {
			...
			public static ComputeInitializerNormalAvg create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerNormalAvg(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[105]);
			}
		}
		public static final class ComputeOptimizerAdaDelta extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[106];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Boolean reduce_sum_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[106];
			...
			public static ComputeOptimizerAdaDelta create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate, java.lang.Double decay_rate, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerAdaDelta(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[106], reduce_sum, learning_rate, decay_rate, smooth_epsilon);
			}
		}
		public static final class ComputeOperationMatMul extends GreyCat.Object {
			...
			public static ComputeOperationMatMul create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output, java.lang.Boolean transposeA, java.lang.Boolean transposeB, java.lang.Double alpha, java.lang.Double beta){
				return new ComputeOperationMatMul(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[107], input, input2, output, transposeA, transposeB, alpha, beta);
			}
		}
		public static final class ComputeInitializerUniform extends GreyCat.Object {
			...
			public static ComputeInitializerUniform create(ai.greycat.GreyCat greycat, java.lang.Double min, java.lang.Double max){
				return new ComputeInitializerUniform(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[108], min, max);
			}
		}
		public static final class ComputeOptimizerAdam extends GreyCat.Object {
			...
			public static java.lang.Double learning_rate_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[109];
				return (java.lang.Double) t.static_values[0];
			}
			public static java.lang.Boolean reduce_sum_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[109];
			...
			public static ComputeOptimizerAdam create(ai.greycat.GreyCat greycat, java.lang.Boolean reduce_sum, java.lang.Double learning_rate, java.lang.Double beta1, java.lang.Double beta2, java.lang.Double smooth_epsilon){
				return new ComputeOptimizerAdam(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[109], reduce_sum, learning_rate, beta1, beta2, smooth_epsilon);
			}
		}
		public static final class ComputeInitializerConstant extends GreyCat.Object {
			...
			public static ComputeInitializerConstant create(ai.greycat.GreyCat greycat, java.lang.Object value){
				return new ComputeInitializerConstant(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[110], value);
			}
		}
		public static final class ComputeOperationElu extends GreyCat.Object {
			...
			public static java.lang.Double alpha_def(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[111];
				return (java.lang.Double) t.static_values[0];
			}
			public static ComputeOperationElu create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output, java.lang.Double alpha){
				return new ComputeOperationElu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[111], input, output, alpha);
			}
		}
		public static final class ComputeModel extends GreyCat.Object {
			...
			public static ComputeModel create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers){
				return new ComputeModel(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[112], layers);
			}
		}
		public static final class ComputeActivationLeakyRelu extends GreyCat.Object {
			...
			public static ComputeActivationLeakyRelu create(ai.greycat.GreyCat greycat, java.lang.Double alpha, java.lang.Double max_value, java.lang.Double threshold){
				return new ComputeActivationLeakyRelu(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[113], alpha, max_value, threshold);
			}
		}
		public static final class ComputeOperationAddBias extends GreyCat.Object {
			...
			public static ComputeOperationAddBias create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationAddBias(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[114], input, input2, output);
			}
		}
		public static final class ComputeOperationSub extends GreyCat.Object {
			...
			public static ComputeOperationSub create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String input2, java.lang.String output){
				return new ComputeOperationSub(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[115], input, input2, output);
			}
		}
		public static final class ComputeOperationLeCunTanh extends GreyCat.Object {
			...
			public static ComputeOperationLeCunTanh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationLeCunTanh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[116], input, output);
			}
		}
		public static final class ComputeState extends ai.greycat.algebra_n.compute.ComputeState {
			...
			public static ComputeState create(ai.greycat.GreyCat greycat){
				return new ComputeState(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[117]);
			}
		}
		public static final class ComputeOperationSinh extends GreyCat.Object {
			...
			public static ComputeOperationSinh create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationSinh(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[118], input, output);
			}
		}
		public static final class ComputeLayerSeq extends GreyCat.Object {
			...
			public static ComputeLayerSeq create(ai.greycat.GreyCat greycat, java.lang.String name, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayerCall> calls, ai.greycat.algebra.compute.ComputeOptimizer optimizer){
				return new ComputeLayerSeq(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[119], name, calls, optimizer);
			}
		}
		public static final class ComputeRegularizer extends GreyCat.Object {
			...
			public static ComputeRegularizer create(ai.greycat.GreyCat greycat, java.lang.Double l1, java.lang.Double l2){
				return new ComputeRegularizer(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[120], l1, l2);
			}
		}
		public static final class ComputeInitializer extends GreyCat.Object {
			...
			public static ComputeInitializer create(ai.greycat.GreyCat greycat){
				return new ComputeInitializer(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[121]);
			}
		}
		public static final class ComputeInitializerUniformOut extends GreyCat.Object {
			...
			public static ComputeInitializerUniformOut create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerUniformOut(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[122]);
			}
		}
		public static final class ComputeInitializerNormalIn extends GreyCat.Object {
			...
			public static ComputeInitializerNormalIn create(ai.greycat.GreyCat greycat){
				return new ComputeInitializerNormalIn(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[123]);
			}
		}
		public static final class ComputeOperationAbs extends GreyCat.Object {
			...
			public static ComputeOperationAbs create(ai.greycat.GreyCat greycat, java.lang.String input, java.lang.String output){
				return new ComputeOperationAbs(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[124], input, output);
			}
		}
	}
	public static final class kmeans {
		public static final class Kmeans extends GreyCat.Object {
			...
			public static Kmeans create(ai.greycat.GreyCat greycat){
				return new Kmeans(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[125]);
			}
		}
	}
	public static final class nn {
		public static final class PreProcessType extends GreyCat.Enum {
			...
			public static PreProcessType create(ai.greycat.GreyCat greycat){
				return new PreProcessType(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[126]);
			}
		}
		public static final class InitializerConfig extends GreyCat.Object {
			...
			public static InitializerConfig create(ai.greycat.GreyCat greycat, ai.greycat.algebra.compute.ComputeInitializer weight_initializer, ai.greycat.algebra.compute.ComputeRegularizer weight_regularizer, ai.greycat.algebra.compute.ComputeInitializer bias_initializer, ai.greycat.algebra.compute.ComputeRegularizer bias_regularizer){
				return new InitializerConfig(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[127], weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
			}
		}
		public static final class PostProcessType extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.nn.PostProcessType none(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[128];
			...
			public static PostProcessType create(ai.greycat.GreyCat greycat){
				return new PostProcessType(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[128]);
			}
		}
		public static final class ComputeActivations extends GreyCat.Enum {
			...
			public static ComputeActivations create(ai.greycat.GreyCat greycat){
				return new ComputeActivations(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[129]);
			}
		}
		public static final class RegressionNetwork extends GreyCat.Object {
			...
			public ai.greycat.algebra.compute.ComputeLossType loss(){
				return (ai.greycat.algebra.compute.ComputeLossType)super.get(super.type.generated_offsets[7]);
			}
			public void set_loss(ai.greycat.algebra.compute.ComputeLossType v){
				super.set(super.type.generated_offsets[7],v);
			}
			public ai.greycat.algebra.compute.ComputeOptimizer optimizer(){
				return (ai.greycat.algebra.compute.ComputeOptimizer)super.get(super.type.generated_offsets[8]);
			}
			public void set_optimizer(ai.greycat.algebra.compute.ComputeOptimizer v){
				super.set(super.type.generated_offsets[8],v);
			}
			...
			public java.lang.Boolean randomizeSeed(){
				return (java.lang.Boolean)super.get(super.type.generated_offsets[10]);
			}
			public void set_randomizeSeed(java.lang.Boolean v){
				super.set(super.type.generated_offsets[10],v);
			}
			public ai.greycat.algebra.compute.ComputeLayerCustom placeholders(){
				return (ai.greycat.algebra.compute.ComputeLayerCustom)super.get(super.type.generated_offsets[11]);
			}
			public void set_placeholders(ai.greycat.algebra.compute.ComputeLayerCustom v){
				super.set(super.type.generated_offsets[11],v);
			}
			public ai.greycat.algebra.compute.ComputeLayer preProcessType(){
				return (ai.greycat.algebra.compute.ComputeLayer)super.get(super.type.generated_offsets[12]);
			}
			public void set_preProcessType(ai.greycat.algebra.compute.ComputeLayer v){
				super.set(super.type.generated_offsets[12],v);
			}
			public ai.greycat.algebra.compute.ComputeLayer postProcessType(){
				return (ai.greycat.algebra.compute.ComputeLayer)super.get(super.type.generated_offsets[13]);
			}
			public void set_postProcessType(ai.greycat.algebra.compute.ComputeLayer v){
				super.set(super.type.generated_offsets[13],v);
			}
			public java.lang.Object preProcessObject(){
				return super.get(super.type.generated_offsets[14]);
			}
			...
			public java.lang.Object postProcessObject(){
				return super.get(super.type.generated_offsets[15]);
			}
			public void set_postProcessObject(java.lang.Object v){
				super.set(super.type.generated_offsets[15],v);
			}
			public ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers(){
				return (ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer>)super.get(super.type.generated_offsets[16]);
			}
			public void set_layers(ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> v){
				super.set(super.type.generated_offsets[16],v);
			}
			public java.lang.String lastLayer(){
				return (java.lang.String)super.get(super.type.generated_offsets[17]);
			}
			public void set_lastLayer(java.lang.String v){
				super.set(super.type.generated_offsets[17],v);
			}
			public java.lang.String lastOutput(){
				return (java.lang.String)super.get(super.type.generated_offsets[18]);
			}
			public void set_lastOutput(java.lang.String v){
				super.set(super.type.generated_offsets[18],v);
			}
			public static RegressionNetwork create(ai.greycat.GreyCat greycat, java.lang.Long inputs, java.lang.Boolean inputs_gradients, java.lang.Long outputs, java.lang.Long fixed_batch_size, java.lang.Long inputs_sequences, java.lang.Long outputs_sequences, ai.greycat.std.core.TensorType tensor_type, ai.greycat.algebra.compute.ComputeLossType loss, ai.greycat.algebra.compute.ComputeOptimizer optimizer, java.lang.Long seed, java.lang.Boolean randomizeSeed, ai.greycat.algebra.compute.ComputeLayerCustom placeholders, ai.greycat.algebra.compute.ComputeLayer preProcessType, ai.greycat.algebra.compute.ComputeLayer postProcessType, java.lang.Object preProcessObject, java.lang.Object postProcessObject, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers, java.lang.String lastLayer, java.lang.String lastOutput){
				return new RegressionNetwork(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[130], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, loss, optimizer, seed, randomizeSeed, placeholders, preProcessType, postProcessType, preProcessObject, postProcessObject, layers, lastLayer, lastOutput);
			}
		}
		public static final class BindingsResult extends GreyCat.Object {
			...
			public static BindingsResult create(ai.greycat.GreyCat greycat, java.lang.String previousLayerName, java.lang.String previousLayerOutput, java.lang.String expectedLayerName, java.lang.String expectedLayerOutput, ai.greycat.algebra.compute.ComputeLayer postLayer){
				return new BindingsResult(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[131], previousLayerName, previousLayerOutput, expectedLayerName, expectedLayerOutput, postLayer);
			}
		}
		public static final class ComputeLayerTypes extends GreyCat.Enum {
			...
			public static ComputeLayerTypes create(ai.greycat.GreyCat greycat){
				return new ComputeLayerTypes(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[132]);
			}
		}
		public static final class AutoEncoderNetwork extends GreyCat.Object {
			...
			public java.lang.Long encoder_layer_idx(){
				return (java.lang.Long)super.get(super.type.generated_offsets[19]);
			}
			...
			public java.lang.String encoder_layer_var(){
				return (java.lang.String)super.get(super.type.generated_offsets[21]);
			}
			public void set_encoder_layer_var(java.lang.String v){
				super.set(super.type.generated_offsets[21],v);
			}
			public static AutoEncoderNetwork create(ai.greycat.GreyCat greycat, java.lang.Long inputs, java.lang.Boolean inputs_gradients, java.lang.Long outputs, java.lang.Long fixed_batch_size, java.lang.Long inputs_sequences, java.lang.Long outputs_sequences, ai.greycat.std.core.TensorType tensor_type, ai.greycat.algebra.compute.ComputeLossType loss, ai.greycat.algebra.compute.ComputeOptimizer optimizer, java.lang.Long seed, java.lang.Boolean randomizeSeed, ai.greycat.algebra.compute.ComputeLayerCustom placeholders, ai.greycat.algebra.compute.ComputeLayer preProcessType, ai.greycat.algebra.compute.ComputeLayer postProcessType, java.lang.Object preProcessObject, java.lang.Object postProcessObject, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers, java.lang.String lastLayer, java.lang.String lastOutput, java.lang.Long encoder_layer_idx, java.lang.String encoder_layer_name, java.lang.String encoder_layer_var){
				return new AutoEncoderNetwork(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[133], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, loss, optimizer, seed, randomizeSeed, placeholders, preProcessType, postProcessType, preProcessObject, postProcessObject, layers, lastLayer, lastOutput, encoder_layer_idx, encoder_layer_name, encoder_layer_var);
			}
		}
		public static final class ClassificationNetwork extends GreyCat.Object {
			...
			public static ClassificationNetwork create(ai.greycat.GreyCat greycat, java.lang.Long inputs, java.lang.Boolean inputs_gradients, java.lang.Long outputs, java.lang.Long fixed_batch_size, java.lang.Long inputs_sequences, java.lang.Long outputs_sequences, ai.greycat.std.core.TensorType tensor_type, ai.greycat.algebra.compute.ComputeLossType loss, ai.greycat.algebra.compute.ComputeOptimizer optimizer, java.lang.Long seed, java.lang.Boolean randomizeSeed, ai.greycat.algebra.compute.ComputeLayerCustom placeholders, ai.greycat.algebra.compute.ComputeLayer preProcessType, ai.greycat.algebra.compute.ComputeLayer postProcessType, java.lang.Object preProcessObject, java.lang.Object postProcessObject, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers, java.lang.String lastLayer, java.lang.String lastOutput){
				return new ClassificationNetwork(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[134], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, loss, optimizer, seed, randomizeSeed, placeholders, preProcessType, postProcessType, preProcessObject, postProcessObject, layers, lastLayer, lastOutput);
			}
		}
		public static final class ComputeOptimizers extends GreyCat.Enum {
			...
			public static ComputeOptimizers create(ai.greycat.GreyCat greycat){
				return new ComputeOptimizers(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[135]);
			}
		}
		public static final class ComputeInitializers extends GreyCat.Enum {
			...
			public static ai.greycat.algebra.nn.ComputeInitializers none(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[136];
			...
			public static ComputeInitializers create(ai.greycat.GreyCat greycat){
				return new ComputeInitializers(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[136]);
			}
		}
		public static final class NeuralNetwork extends GreyCat.Object {
			...
			public static java.lang.String err_negative_in_out(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[0];
			}
			...
			public static java.lang.String layer_loss_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[7];
			}
			...
			public static java.lang.String var_outputs_name(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[10];
			}
			public static java.lang.String pre_process(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[11];
			}
			public static java.lang.String input_avg(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[12];
			}
			public static java.lang.String input_min(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[13];
			}
			public static java.lang.String input_max(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[14];
			}
			public static java.lang.String input_std(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[15];
			}
			public static java.lang.String input_space(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[16];
			}
			public static java.lang.String output_avg(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[17];
			}
			public static java.lang.String output_min(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[18];
			}
			public static java.lang.String output_max(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[19];
			}
			public static java.lang.String output_std(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[20];
			}
			public static java.lang.String post_process(ai.greycat.GreyCat greycat){
				final ai.greycat.GreyCat.Type t = greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137];
				return (java.lang.String) t.static_values[21];
			}
			...
			public static NeuralNetwork create(ai.greycat.GreyCat greycat, java.lang.Long inputs, java.lang.Boolean inputs_gradients, java.lang.Long outputs, java.lang.Long fixed_batch_size, java.lang.Long inputs_sequences, java.lang.Long outputs_sequences, ai.greycat.std.core.TensorType tensor_type, ai.greycat.algebra.compute.ComputeLossType loss, ai.greycat.algebra.compute.ComputeOptimizer optimizer, java.lang.Long seed, java.lang.Boolean randomizeSeed, ai.greycat.algebra.compute.ComputeLayerCustom placeholders, ai.greycat.algebra.compute.ComputeLayer preProcessType, ai.greycat.algebra.compute.ComputeLayer postProcessType, java.lang.Object preProcessObject, java.lang.Object postProcessObject, ai.greycat.std.core.Array<ai.greycat.algebra.compute.ComputeLayer> layers, java.lang.String lastLayer, java.lang.String lastOutput){
				return new NeuralNetwork(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[137], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, loss, optimizer, seed, randomizeSeed, placeholders, preProcessType, postProcessType, preProcessObject, postProcessObject, layers, lastLayer, lastOutput);
			}
		}
	}
	public static final class powerflow {
		public static final class PowerLineResult extends GreyCat.Object {
			...
			public static PowerLineResult create(ai.greycat.GreyCat greycat, java.lang.Double p_from_mw, java.lang.Double q_from_mvar, java.lang.Double p_to_mw, java.lang.Double q_to_mvar, java.lang.Double pl_mw, java.lang.Double ql_mvar, java.lang.Double i_from_ka, java.lang.Double i_to_ka, java.lang.Double i_ka, java.lang.Double vm_from_pu, java.lang.Double vm_to_pu, java.lang.Double va_from_radians, java.lang.Double va_to_radians, java.lang.Double loading_percent){
				return new PowerLineResult(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[138], p_from_mw, q_from_mvar, p_to_mw, q_to_mvar, pl_mw, ql_mvar, i_from_ka, i_to_ka, i_ka, vm_from_pu, vm_to_pu, va_from_radians, va_to_radians, loading_percent);
			}
		}
		public static final class PowerBusResult extends GreyCat.Object {
			...
			public static PowerBusResult create(ai.greycat.GreyCat greycat, java.lang.Double abs, java.lang.Double angle_radians, java.lang.Double voltage, java.lang.Double voltage_img, java.lang.Double current, java.lang.Double current_img){
				return new PowerBusResult(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[139], abs, angle_radians, voltage, voltage_img, current, current_img);
			}
		}
		public static final class PowerNetwork extends ai.greycat.algebra_n.powerflow.PowerNetwork {
			public static final java.lang.String name = "powerflow.PowerNetwork";
			private PowerNetwork(ai.greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type);
			}
			public static PowerNetwork create(ai.greycat.GreyCat greycat){
				return new PowerNetwork(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[140]);
			}
		}
	}
	public static final class ml {
		public static final class HeatMapProfile extends GreyCat.Object {
			...
			public static HeatMapProfile create(ai.greycat.GreyCat greycat, ai.greycat.std.core.Table<java.lang.Long> counts, ai.greycat.std.core.Array<java.lang.String> x_labels, ai.greycat.std.core.Array<java.lang.String> y_labels, java.lang.Long counts_max, java.lang.Long counts_sum){
				return new HeatMapProfile(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[141], counts, x_labels, y_labels, counts_max, counts_sum);
			}
		}
		public static final class GaussianND extends ai.greycat.algebra_n.ml.GaussianND {
			...
			public static GaussianND create(ai.greycat.GreyCat greycat){
				return new GaussianND(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[142]);
			}
		}
		public static final class Polynomial extends ai.greycat.algebra_n.ml.Polynomial {
			...
			public static Polynomial create(ai.greycat.GreyCat greycat){
				return new Polynomial(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[143]);
			}
		}
		public static final class TimeSeriesDecomposition extends GreyCat.Object {
			...
			public static TimeSeriesDecomposition create(ai.greycat.GreyCat greycat){
				return new TimeSeriesDecomposition(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[144]);
			}
		}
		public static final class PCA extends ai.greycat.algebra_n.ml.PCA {
			...
			public static PCA create(ai.greycat.GreyCat greycat){
				return new PCA(greycat.libs_by_name.get(ai.greycat.algebra.name).mapped[145]);
			}
		}
	}
	@Override
	public void configure(java.util.Map<String, ai.greycat.GreyCat.Loader> loaders, java.util.Map<String, ai.greycat.GreyCat.Factory> factories) {
		...
		factories.put(compute.ComputeOperationLossLog.name, compute.ComputeOperationLossLog::new);
		...
		factories.put(compute.ComputeOperationLossSoftMaxLog.name, compute.ComputeOperationLossSoftMaxLog::new);
		...
		factories.put(compute.ComputeConstVar.name, compute.ComputeConstVar::new);
		...
		factories.put(compute.ComputeInOutVar.name, compute.ComputeInOutVar::new);
		...
		factories.put(compute.ComputeOperationLossSquare.name, compute.ComputeOperationLossSquare::new);
		...
		factories.put(compute.ComputeLossType.name, compute.ComputeLossType::new);
		...
		factories.put(compute.ComputeVaro.name, compute.ComputeVaro::new);
		factories.put(compute.ComputeLayerFilter.name, compute.ComputeLayerFilter::new);
		factories.put(compute.ComputeOperationLossAbstract.name, compute.ComputeOperationLossAbstract::new);
		...
		factories.put(powerflow.PowerNetwork.name, powerflow.PowerNetwork::new);
		loaders.put(powerflow.PowerNetwork.name, ai.greycat.algebra_n.powerflow.PowerNetwork::load);
	...
	public void init(ai.greycat.GreyCat greycat) {
		this.mapped = new ai.greycat.GreyCat.Type[146];
		this.mapped[0] = greycat.types_by_name.get(nn_layers_names.NNLayersNames.name);
		...
		this.mapped[1] = greycat.types_by_name.get(compute.ComputeOperationSqrt.name);
		this.mapped[1].resolveGeneratedOffsets("input","output");
		this.mapped[2] = greycat.types_by_name.get(compute.ComputeOptimizerSgd.name);
		this.mapped[2].resolveGeneratedOffsets("reduce_sum","learning_rate");
		this.mapped[2].static_values = new java.lang.Object[]{0.01,false};
		this.mapped[3] = greycat.types_by_name.get(compute.ComputeLayerDense.name);
		this.mapped[3].resolveGeneratedOffsets("name","type","inputs","outputs","use_bias","weight_initializer","weight_regularizer","bias_initializer","bias_regularizer","activation");
		this.mapped[3].static_values = new java.lang.Object[]{"input","output","weight","bias","mult","pre_activation"};
		this.mapped[4] = greycat.types_by_name.get(compute.ComputeOperationAsin.name);
		this.mapped[4].resolveGeneratedOffsets("input","output");
		this.mapped[5] = greycat.types_by_name.get(compute.ComputeOperationSoftplus.name);
		this.mapped[5].resolveGeneratedOffsets("input","output");
		this.mapped[6] = greycat.types_by_name.get(compute.ComputeOptimizerMomentum.name);
		this.mapped[6].resolveGeneratedOffsets("reduce_sum","learning_rate","decay_rate");
		this.mapped[6].static_values = new java.lang.Object[]{0.001,false,0.9};
		this.mapped[7] = greycat.types_by_name.get(compute.ComputeOperationLossLog.name);
		this.mapped[7].resolveGeneratedOffsets("input","input2","output");
		this.mapped[8] = greycat.types_by_name.get(compute.ComputeOptimizerAdaGrad.name);
		this.mapped[8].resolveGeneratedOffsets("reduce_sum","learning_rate","initial_accumulator","smooth_epsilon");
		this.mapped[8].static_values = new java.lang.Object[]{0.001,false,0.1,0.0000001};
		this.mapped[9] = greycat.types_by_name.get(compute.ComputeActivationExp.name);
		this.mapped[10] = greycat.types_by_name.get(compute.ComputeOperationArgMin.name);
		this.mapped[10].resolveGeneratedOffsets("input","output","output2");
		this.mapped[11] = greycat.types_by_name.get(compute.ComputeOperationFilter.name);
		this.mapped[11].resolveGeneratedOffsets("input","output","mask","nbOutputs");
		this.mapped[12] = greycat.types_by_name.get(compute.ComputeInitializerIdentity.name);
		this.mapped[13] = greycat.types_by_name.get(compute.ComputeOperationLossSoftMaxLog.name);
		this.mapped[13].resolveGeneratedOffsets("input","input2","output");
		this.mapped[14] = greycat.types_by_name.get(compute.ComputeOperationArgMax.name);
		this.mapped[14].resolveGeneratedOffsets("input","output","output2");
		this.mapped[15] = greycat.types_by_name.get(compute.ComputeInitializerLeCunUniform.name);
		this.mapped[16] = greycat.types_by_name.get(compute.ComputeInitializerUniformIn.name);
		this.mapped[17] = greycat.types_by_name.get(compute.ComputeOperationSigmoid.name);
		this.mapped[17].resolveGeneratedOffsets("input","output");
		this.mapped[18] = greycat.types_by_name.get(compute.ComputeLayerLSTM.name);
		this.mapped[18].resolveGeneratedOffsets("name","bias_initializer","weight_regularizer","bias_regularizer","type","use_bias","return_sequences","bidirectional","auto_init_states","inputs","outputs","layers","sequences");
		this.mapped[18].static_values = new java.lang.Object[]{"input","output","hx","cx","hy","cy","weight","bias","internal_i","internal_f","internal_cp","internal_o","internal_h","internal_c","internal_mult","internal_output"};
		this.mapped[19] = greycat.types_by_name.get(compute.ComputeVarProxy.name);
		this.mapped[19].resolveGeneratedOffsets("name");
		this.mapped[20] = greycat.types_by_name.get(compute.ComputeOperationExp.name);
		this.mapped[20].resolveGeneratedOffsets("input","output");
		this.mapped[21] = greycat.types_by_name.get(compute.ComputeInitializerGlorotUniform.name);
		this.mapped[22] = greycat.types_by_name.get(compute.ComputeConstVar.name);
		this.mapped[22].resolveGeneratedOffsets("name","type","shape");
		this.mapped[23] = greycat.types_by_name.get(compute.ComputeOperationSin.name);
		this.mapped[23].resolveGeneratedOffsets("input","output");
		this.mapped[24] = greycat.types_by_name.get(compute.ComputeLayerStandardScaler.name);
		this.mapped[24].resolveGeneratedOffsets("name","type","inverse_transform");
		this.mapped[24].static_values = new java.lang.Object[]{"input","output","avg","std"};
		this.mapped[25] = greycat.types_by_name.get(compute.ComputeOperationLog.name);
		this.mapped[25].resolveGeneratedOffsets("input","output");
		this.mapped[26] = greycat.types_by_name.get(compute.ComputeOperationEuclidean.name);
		this.mapped[26].resolveGeneratedOffsets("input","input2","output");
		this.mapped[27] = greycat.types_by_name.get(compute.ComputeOperationSign.name);
		this.mapped[27].resolveGeneratedOffsets("input","output");
		this.mapped[28] = greycat.types_by_name.get(compute.ComputeOperationSoftSign.name);
		this.mapped[28].resolveGeneratedOffsets("input","output");
		this.mapped[29] = greycat.types_by_name.get(compute.ComputeOperationLogSoftmax.name);
		this.mapped[29].resolveGeneratedOffsets("input","output","axis");
		this.mapped[30] = greycat.types_by_name.get(compute.ComputeOperation.name);
		this.mapped[31] = greycat.types_by_name.get(compute.ComputeLayerLinear.name);
		this.mapped[31].resolveGeneratedOffsets("name","type","inputs","outputs","use_bias","weight_initializer","weight_regularizer","bias_initializer","bias_regularizer");
		this.mapped[31].static_values = new java.lang.Object[]{"input","output","weight","bias","mult"};
		this.mapped[32] = greycat.types_by_name.get(compute.ComputeInitializerRelu.name);
		this.mapped[33] = greycat.types_by_name.get(compute.ComputeActivationSoftplus.name);
		this.mapped[34] = greycat.types_by_name.get(compute.ComputeActivationTanh.name);
		this.mapped[35] = greycat.types_by_name.get(compute.ComputeLayerActivation.name);
		this.mapped[35].resolveGeneratedOffsets("name","activation");
		this.mapped[35].static_values = new java.lang.Object[]{"input","output"};
		this.mapped[36] = greycat.types_by_name.get(compute.ComputeLayerPCAScaler.name);
		this.mapped[36].resolveGeneratedOffsets("name","type","inverse_transform");
		this.mapped[36].static_values = new java.lang.Object[]{"input","output","avg","std","space"};
		this.mapped[37] = greycat.types_by_name.get(compute.ComputeInitializerSigmoidUniform.name);
		this.mapped[38] = greycat.types_by_name.get(compute.ComputeOptimizerNadam.name);
		this.mapped[38].resolveGeneratedOffsets("reduce_sum","learning_rate","beta1","beta2","smooth_epsilon");
		this.mapped[38].static_values = new java.lang.Object[]{0.001,false,0.9,0.999,0.0000001};
		this.mapped[39] = greycat.types_by_name.get(compute.ComputeActivationSigmoid.name);
		this.mapped[40] = greycat.types_by_name.get(compute.ComputeOperationTanh.name);
		this.mapped[40].resolveGeneratedOffsets("input","output");
		this.mapped[41] = greycat.types_by_name.get(compute.ComputeOperationSoftmax.name);
		this.mapped[41].resolveGeneratedOffsets("input","output","axis");
		this.mapped[42] = greycat.types_by_name.get(compute.ComputeOperationPow.name);
		this.mapped[42].resolveGeneratedOffsets("input","input2","output");
		this.mapped[43] = greycat.types_by_name.get(compute.ComputeOperationAcosh.name);
		this.mapped[43].resolveGeneratedOffsets("input","output");
		this.mapped[44] = greycat.types_by_name.get(compute.ComputeOperation1In1Out.name);
		this.mapped[44].resolveGeneratedOffsets("input","output");
		this.mapped[45] = greycat.types_by_name.get(compute.ComputeOperationAcos.name);
		this.mapped[45].resolveGeneratedOffsets("input","output");
		this.mapped[46] = greycat.types_by_name.get(compute.ComputeInOutVar.name);
		this.mapped[46].resolveGeneratedOffsets("name","type","shape","with_grad");
		this.mapped[47] = greycat.types_by_name.get(compute.ComputeInitializerPytorch.name);
		this.mapped[48] = greycat.types_by_name.get(compute.ComputeOperationCos.name);
		this.mapped[48].resolveGeneratedOffsets("input","output");
		this.mapped[49] = greycat.types_by_name.get(compute.ComputeOperationAtanh.name);
		this.mapped[49].resolveGeneratedOffsets("input","output");
		this.mapped[50] = greycat.types_by_name.get(compute.ComputeOptimizerRmsProp.name);
		this.mapped[50].resolveGeneratedOffsets("reduce_sum","learning_rate","decay_rate","smooth_epsilon");
		this.mapped[50].static_values = new java.lang.Object[]{0.001,false,0.9,0.0000001};
		this.mapped[51] = greycat.types_by_name.get(compute.ComputeOptimizerFtrl.name);
		this.mapped[51].resolveGeneratedOffsets("reduce_sum","learning_rate","lambda1","lambda2","beta");
		this.mapped[51].static_values = new java.lang.Object[]{0.001,false,0.0,0.0,0.0};
		this.mapped[52] = greycat.types_by_name.get(compute.ComputeOperationDiv.name);
		this.mapped[52].resolveGeneratedOffsets("input","input2","output");
		this.mapped[53] = greycat.types_by_name.get(compute.ComputeActivationCelu.name);
		this.mapped[53].resolveGeneratedOffsets("alpha");
		this.mapped[53].static_values = new java.lang.Object[]{1.0};
		this.mapped[54] = greycat.types_by_name.get(compute.ComputeActivationHardSigmoid.name);
		this.mapped[54].resolveGeneratedOffsets("slope","shift");
		this.mapped[54].static_values = new java.lang.Object[]{0.2,0.5};
		this.mapped[55] = greycat.types_by_name.get(compute.ComputeOperationTan.name);
		this.mapped[55].resolveGeneratedOffsets("input","output");
		this.mapped[56] = greycat.types_by_name.get(compute.ComputeBinding.name);
		this.mapped[56].resolveGeneratedOffsets("src_layer_name","src_var_name","target_var_name");
		this.mapped[57] = greycat.types_by_name.get(compute.ComputeOperationLeakyRelu.name);
		this.mapped[57].resolveGeneratedOffsets("input","output","alpha","max_value","threshold");
		this.mapped[57].static_values = new java.lang.Object[]{0.3,0.0};
		this.mapped[58] = greycat.types_by_name.get(compute.ComputeOptimizerNesterov.name);
		this.mapped[58].resolveGeneratedOffsets("reduce_sum","learning_rate","decay_rate");
		this.mapped[58].static_values = new java.lang.Object[]{0.001,false,0.9};
		this.mapped[59] = greycat.types_by_name.get(compute.ComputeInitializerXavier.name);
		this.mapped[60] = greycat.types_by_name.get(compute.ComputeOperationLossSquare.name);
		this.mapped[60].resolveGeneratedOffsets("input","input2","output");
		this.mapped[61] = greycat.types_by_name.get(compute.ComputeVar.name);
		this.mapped[61].resolveGeneratedOffsets("name");
		this.mapped[62] = greycat.types_by_name.get(compute.ComputeInitializerNormalOut.name);
		this.mapped[63] = greycat.types_by_name.get(compute.ComputeActivationSoftmax.name);
		this.mapped[63].resolveGeneratedOffsets("axis");
		this.mapped[64] = greycat.types_by_name.get(compute.ComputeOperationClip.name);
		this.mapped[64].resolveGeneratedOffsets("input","output","min","max");
		this.mapped[65] = greycat.types_by_name.get(compute.ComputeOperationAsinh.name);
		this.mapped[65].resolveGeneratedOffsets("input","output");
		this.mapped[66] = greycat.types_by_name.get(compute.ComputeOperationCosh.name);
		this.mapped[66].resolveGeneratedOffsets("input","output");
		this.mapped[67] = greycat.types_by_name.get(compute.ComputeInitializerNormal.name);
		this.mapped[67].resolveGeneratedOffsets("avg","std");
		this.mapped[68] = greycat.types_by_name.get(compute.ComputeOperationRaiseToPower.name);
		this.mapped[68].resolveGeneratedOffsets("input","output","power");
		this.mapped[69] = greycat.types_by_name.get(compute.ComputeOptimizer.name);
		this.mapped[69].resolveGeneratedOffsets("reduce_sum","learning_rate");
		this.mapped[70] = greycat.types_by_name.get(compute.ComputeOperation2In1Out.name);
		this.mapped[70].resolveGeneratedOffsets("input","input2","output");
		this.mapped[71] = greycat.types_by_name.get(compute.ComputeOperationSelu.name);
		this.mapped[71].resolveGeneratedOffsets("input","output");
		this.mapped[72] = greycat.types_by_name.get(compute.ComputeInitializerLSTM.name);
		this.mapped[73] = greycat.types_by_name.get(compute.ComputeOperationScale.name);
		this.mapped[73].resolveGeneratedOffsets("input","output","alpha");
		this.mapped[74] = greycat.types_by_name.get(compute.ComputeInitializerXavierUniform.name);
		this.mapped[75] = greycat.types_by_name.get(compute.ComputeActivationSoftSign.name);
		this.mapped[76] = greycat.types_by_name.get(compute.ComputeEngine.name);
		this.mapped[77] = greycat.types_by_name.get(compute.ComputeOperationRelu.name);
		this.mapped[77].resolveGeneratedOffsets("input","output","max_value","threshold");
		this.mapped[77].static_values = new java.lang.Object[]{0.0};
		this.mapped[78] = greycat.types_by_name.get(compute.ComputeInitializerUniformAvg.name);
		this.mapped[79] = greycat.types_by_name.get(compute.ComputeOperationMul.name);
		this.mapped[79].resolveGeneratedOffsets("input","input2","output");
		this.mapped[80] = greycat.types_by_name.get(compute.ComputeLayerLoss.name);
		this.mapped[80].resolveGeneratedOffsets("name","type");
		this.mapped[80].static_values = new java.lang.Object[]{"computed","expected","loss"};
		this.mapped[81] = greycat.types_by_name.get(compute.ComputeActivation.name);
		this.mapped[82] = greycat.types_by_name.get(compute.ComputeLayerCustom.name);
		this.mapped[82].resolveGeneratedOffsets("name","ops","vars");
		this.mapped[83] = greycat.types_by_name.get(compute.ComputeLossType.name);
		this.mapped[83].resolveGeneratedOffsetWithValues("square", "Square","abs", "Abs","log", "Log","softmax_log", "Softmax Log");
		this.mapped[84] = greycat.types_by_name.get(compute.ComputeInitializerNone.name);
		this.mapped[85] = greycat.types_by_name.get(compute.ComputeOperationAtan.name);
		this.mapped[85].resolveGeneratedOffsets("input","output");
		this.mapped[86] = greycat.types_by_name.get(compute.ComputeOperationAdd.name);
		this.mapped[86].resolveGeneratedOffsets("input","input2","output");
		this.mapped[87] = greycat.types_by_name.get(compute.ComputeInitializerReluUniform.name);
		this.mapped[88] = greycat.types_by_name.get(compute.ComputeLayerCall.name);
		this.mapped[88].resolveGeneratedOffsets("layer_name","bindings");
		this.mapped[89] = greycat.types_by_name.get(compute.ComputeLayer.name);
		this.mapped[89].resolveGeneratedOffsets("name");
		this.mapped[90] = greycat.types_by_name.get(compute.ComputeOperationSum.name);
		this.mapped[90].resolveGeneratedOffsets("input","output","axis");
		this.mapped[91] = greycat.types_by_name.get(compute.ComputeOperationArg.name);
		this.mapped[91].resolveGeneratedOffsets("input","output","output2");
		this.mapped[92] = greycat.types_by_name.get(compute.ComputeOptimizerAdaMax.name);
		this.mapped[92].resolveGeneratedOffsets("reduce_sum","learning_rate","beta1","beta2","smooth_epsilon");
		this.mapped[92].static_values = new java.lang.Object[]{0.001,false,0.9,0.999,0.0000001};
		this.mapped[93] = greycat.types_by_name.get(compute.ComputeOperationAvg.name);
		this.mapped[93].resolveGeneratedOffsets("input","input2","output");
		this.mapped[94] = greycat.types_by_name.get(compute.ComputeActivationRelu.name);
		this.mapped[94].resolveGeneratedOffsets("max_value","threshold");
		this.mapped[94].static_values = new java.lang.Object[]{0.0};
		this.mapped[95] = greycat.types_by_name.get(compute.ComputeActivationElu.name);
		this.mapped[95].resolveGeneratedOffsets("alpha");
		this.mapped[95].static_values = new java.lang.Object[]{1.0};
		this.mapped[96] = greycat.types_by_name.get(compute.ComputeOperationHardSigmoid.name);
		this.mapped[96].resolveGeneratedOffsets("input","output","slope","shift");
		this.mapped[96].static_values = new java.lang.Object[]{0.2,0.5};
		this.mapped[97] = greycat.types_by_name.get(compute.ComputeOperationSumIf.name);
		this.mapped[97].resolveGeneratedOffsets("input","ifCondition","output","counts","classes");
		this.mapped[98] = greycat.types_by_name.get(compute.ComputeLayerMinMaxScaler.name);
		this.mapped[98].resolveGeneratedOffsets("name","type","inverse_transform");
		this.mapped[98].static_values = new java.lang.Object[]{"input","output","min","max"};
		this.mapped[99] = greycat.types_by_name.get(compute.ComputeOperationCelu.name);
		this.mapped[99].resolveGeneratedOffsets("input","output","alpha");
		this.mapped[100] = greycat.types_by_name.get(compute.ComputeVaro.name);
		this.mapped[100].resolveGeneratedOffsets("name","type","shape","l1","l2","init");
		this.mapped[101] = greycat.types_by_name.get(compute.ComputeLayerFilter.name);
		this.mapped[101].resolveGeneratedOffsets("name","type","inputs","outputs","maskValues");
		this.mapped[101].static_values = new java.lang.Object[]{"input","output","mask"};
		this.mapped[102] = greycat.types_by_name.get(compute.ComputeOperationLossAbstract.name);
		this.mapped[102].resolveGeneratedOffsets("input","input2","output");
		this.mapped[103] = greycat.types_by_name.get(compute.ComputeOperationFill.name);
		this.mapped[103].resolveGeneratedOffsets("input","value");
		this.mapped[104] = greycat.types_by_name.get(compute.ComputeActivationSelu.name);
		this.mapped[105] = greycat.types_by_name.get(compute.ComputeInitializerNormalAvg.name);
		this.mapped[106] = greycat.types_by_name.get(compute.ComputeOptimizerAdaDelta.name);
		this.mapped[106].resolveGeneratedOffsets("reduce_sum","learning_rate","decay_rate","smooth_epsilon");
		this.mapped[106].static_values = new java.lang.Object[]{0.001,false,0.95,0.0000001};
		this.mapped[107] = greycat.types_by_name.get(compute.ComputeOperationMatMul.name);
		this.mapped[107].resolveGeneratedOffsets("input","input2","output","transposeA","transposeB","alpha","beta");
		this.mapped[108] = greycat.types_by_name.get(compute.ComputeInitializerUniform.name);
		this.mapped[108].resolveGeneratedOffsets("min","max");
		this.mapped[109] = greycat.types_by_name.get(compute.ComputeOptimizerAdam.name);
		this.mapped[109].resolveGeneratedOffsets("reduce_sum","learning_rate","beta1","beta2","smooth_epsilon");
		this.mapped[109].static_values = new java.lang.Object[]{0.001,false,0.9,0.999,0.0000001};
		this.mapped[110] = greycat.types_by_name.get(compute.ComputeInitializerConstant.name);
		this.mapped[110].resolveGeneratedOffsets("value");
		this.mapped[111] = greycat.types_by_name.get(compute.ComputeOperationElu.name);
		this.mapped[111].resolveGeneratedOffsets("input","output","alpha");
		this.mapped[111].static_values = new java.lang.Object[]{1.0};
		this.mapped[112] = greycat.types_by_name.get(compute.ComputeModel.name);
		this.mapped[112].resolveGeneratedOffsets("layers");
		this.mapped[113] = greycat.types_by_name.get(compute.ComputeActivationLeakyRelu.name);
		this.mapped[113].resolveGeneratedOffsets("alpha","max_value","threshold");
		this.mapped[113].static_values = new java.lang.Object[]{0.3,0.0};
		this.mapped[114] = greycat.types_by_name.get(compute.ComputeOperationAddBias.name);
		this.mapped[114].resolveGeneratedOffsets("input","input2","output");
		this.mapped[115] = greycat.types_by_name.get(compute.ComputeOperationSub.name);
		this.mapped[115].resolveGeneratedOffsets("input","input2","output");
		this.mapped[116] = greycat.types_by_name.get(compute.ComputeOperationLeCunTanh.name);
		this.mapped[116].resolveGeneratedOffsets("input","output");
		this.mapped[117] = greycat.types_by_name.get(compute.ComputeState.name);
		this.mapped[118] = greycat.types_by_name.get(compute.ComputeOperationSinh.name);
		this.mapped[118].resolveGeneratedOffsets("input","output");
		this.mapped[119] = greycat.types_by_name.get(compute.ComputeLayerSeq.name);
		this.mapped[119].resolveGeneratedOffsets("name","calls","optimizer");
		this.mapped[120] = greycat.types_by_name.get(compute.ComputeRegularizer.name);
		this.mapped[120].resolveGeneratedOffsets("l1","l2");
		this.mapped[121] = greycat.types_by_name.get(compute.ComputeInitializer.name);
		this.mapped[122] = greycat.types_by_name.get(compute.ComputeInitializerUniformOut.name);
		this.mapped[123] = greycat.types_by_name.get(compute.ComputeInitializerNormalIn.name);
		this.mapped[124] = greycat.types_by_name.get(compute.ComputeOperationAbs.name);
		this.mapped[124].resolveGeneratedOffsets("input","output");
		this.mapped[125] = greycat.types_by_name.get(kmeans.Kmeans.name);
		this.mapped[125].static_values = new java.lang.Object[]{"input","assignement","min_distance","centroids","distance","sum_centroids","sum_min_distance","count_centroids","centroid_distances","sum_cluster_distances","avg_cluster_distances","count_cluster_distances","placeholders","kmeans_forward","kmeans_backward","kmeans_init_round","kmeans_end_round","kmeans_stats_layer","kmeans_init_round_seq","kmeans_forward_seq","kmeans_backward_seq","kmeans_end_round_seq","kmeans_stats_seq"};
		this.mapped[126] = greycat.types_by_name.get(nn.PreProcessType.name);
		this.mapped[126].resolveGeneratedOffsetWithValues("none", "None","min_max_scaling", "Min/Max Scaling","standard_scaling", "Standard Scaling","pca_scaling", "PCA Scaling");
		this.mapped[127] = greycat.types_by_name.get(nn.InitializerConfig.name);
		this.mapped[127].resolveGeneratedOffsets("weight_initializer","weight_regularizer","bias_initializer","bias_regularizer");
		this.mapped[128] = greycat.types_by_name.get(nn.PostProcessType.name);
		this.mapped[128].resolveGeneratedOffsetWithValues("none", "None","min_max_scaling", "Min/Max Scaling","standard_scaling", "Standard Scaling");
		this.mapped[129] = greycat.types_by_name.get(nn.ComputeActivations.name);
		this.mapped[129].resolveGeneratedOffsetWithValues("relu", "Relu","leaky_relu", "Leaky Relu","sigmoid", "Sigmoid","hard_sigmoid", "Hard Sigmoid","exp", "Exp","soft_max", "Soft Max","soft_plus", "Soft Plus","soft_sign", "Soft Sign","tanh", "Tanh","selu", "Selu","elu", "Elu","celu", "Celu");
		this.mapped[130] = greycat.types_by_name.get(nn.RegressionNetwork.name);
		this.mapped[130].resolveGeneratedOffsets("inputs","inputs_gradients","outputs","fixed_batch_size","inputs_sequences","outputs_sequences","tensor_type","loss","optimizer","seed","randomizeSeed","placeholders","preProcessType","postProcessType","preProcessObject","postProcessObject","layers","lastLayer","lastOutput");
		this.mapped[131] = greycat.types_by_name.get(nn.BindingsResult.name);
		...
		this.mapped[132] = greycat.types_by_name.get(nn.ComputeLayerTypes.name);
		...
		this.mapped[133] = greycat.types_by_name.get(nn.AutoEncoderNetwork.name);
		this.mapped[133].resolveGeneratedOffsets("inputs","inputs_gradients","outputs","fixed_batch_size","inputs_sequences","outputs_sequences","tensor_type","loss","optimizer","seed","randomizeSeed","placeholders","preProcessType","postProcessType","preProcessObject","postProcessObject","layers","lastLayer","lastOutput","encoder_layer_idx","encoder_layer_name","encoder_layer_var");
		this.mapped[134] = greycat.types_by_name.get(nn.ClassificationNetwork.name);
		this.mapped[134].resolveGeneratedOffsets("inputs","inputs_gradients","outputs","fixed_batch_size","inputs_sequences","outputs_sequences","tensor_type","loss","optimizer","seed","randomizeSeed","placeholders","preProcessType","postProcessType","preProcessObject","postProcessObject","layers","lastLayer","lastOutput");
		this.mapped[135] = greycat.types_by_name.get(nn.ComputeOptimizers.name);
		...
		this.mapped[136] = greycat.types_by_name.get(nn.ComputeInitializers.name);
		...
		this.mapped[137] = greycat.types_by_name.get(nn.NeuralNetwork.name);
		this.mapped[137].resolveGeneratedOffsets("inputs","inputs_gradients","outputs","fixed_batch_size","inputs_sequences","outputs_sequences","tensor_type","loss","optimizer","seed","randomizeSeed","placeholders","preProcessType","postProcessType","preProcessObject","postProcessObject","layers","lastLayer","lastOutput");
		this.mapped[137].static_values = new java.lang.Object[]{"Inputs or outputs can't be negative","Last layer has different number of outputs than declared","Incompatible loss function","Some NN layers are not currently supported","Tensor Type not currently supported","NN should contain at least 1 layer","placeholders","loss","input","enc_input","output","pre_process","input_avg","input_min","input_max","input_std","input_space","output_avg","output_min","output_max","output_std","post_process","predict","learn","encode","decode"};
		this.mapped[138] = greycat.types_by_name.get(powerflow.PowerLineResult.name);
		this.mapped[138].resolveGeneratedOffsets("p_from_mw","q_from_mvar","p_to_mw","q_to_mvar","pl_mw","ql_mvar","i_from_ka","i_to_ka","i_ka","vm_from_pu","vm_to_pu","va_from_radians","va_to_radians","loading_percent");
		this.mapped[139] = greycat.types_by_name.get(powerflow.PowerBusResult.name);
		this.mapped[139].resolveGeneratedOffsets("abs","angle_radians","voltage","voltage_img","current","current_img");
		this.mapped[140] = greycat.types_by_name.get(powerflow.PowerNetwork.name);
		this.mapped[141] = greycat.types_by_name.get(ml.HeatMapProfile.name);
		this.mapped[141].resolveGeneratedOffsets("counts","x_labels","y_labels","counts_max","counts_sum");
		this.mapped[142] = greycat.types_by_name.get(ml.GaussianND.name);
		this.mapped[143] = greycat.types_by_name.get(ml.Polynomial.name);
		this.mapped[144] = greycat.types_by_name.get(ml.TimeSeriesDecomposition.name);
		this.mapped[145] = greycat.types_by_name.get(ml.PCA.name);
		this.mapped[145].static_values = new java.lang.Object[]{0.95};
	}
}
