...
public final class gc {
	public static final class core {
		public static final class GeoCircle extends GreyCat.Object {
			...
			public GeoCircle(greycat.gc.core.geo center, java.lang.Double radius) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[0], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[0].map_attributes(new Object[] {center, radius}));
			}
		...
		public static final class VectorIndex<T> extends GreyCat.Object {
			...
			public VectorIndex(core.nodeList<core.nodeList<core.VectorLeaf<T>>> layers, util.Random rng) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[1], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[1].map_attributes(new Object[] {layers, rng}));
			}
			public core.nodeList<core.nodeList<core.VectorLeaf<T>>> layers() {
				return (core.nodeList<core.nodeList<core.VectorLeaf<T>>>) getAttribute(type.generated_offsets[0]);
			}
			public void set_layers(core.nodeList<core.nodeList<core.VectorLeaf<T>>> v) {
				setAttribute(type.generated_offsets[0], v);
			}
			public util.Random rng() {
				return (util.Random) getAttribute(type.generated_offsets[1]);
			}
		...
		public static final class GeoBox extends GreyCat.Object {
			...
			public GeoBox(greycat.gc.core.geo sw, greycat.gc.core.geo ne) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[4], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[4].map_attributes(new Object[] {sw, ne}));
			}
		...
		public static final class DurationUnit extends GreyCat.Enum {
			...
			public static DurationUnit get(java.lang.String key, GreyCat greycat) {
				return (DurationUnit) greycat.libs_by_name.get(std.name).mapped[5].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class nodeIndexBucket<K,V> extends GreyCat.Object {
			...
			public nodeIndexBucket(K key, V value, core.nodeIndexBucket<K, V> next) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[7], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[7].map_attributes(new Object[] {key, value, next}));
			}
			public K key() {
		...
		public static final class FloatPrecision extends GreyCat.Enum {
			...
			public FloatPrecision() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[9], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[9].map_attributes(new Object[] {}));
			}
			...
			public static FloatPrecision get(java.lang.String key, GreyCat greycat) {
				return (FloatPrecision) greycat.libs_by_name.get(std.name).mapped[9].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class Date extends GreyCat.Object {
			...
			public Date(java.lang.Long year, java.lang.Long month, java.lang.Long day, java.lang.Long hour, java.lang.Long minute, java.lang.Long second, java.lang.Long microsecond) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[17], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[17].map_attributes(new Object[] {year, month, day, hour, minute, second, microsecond}));
			}
		...
		public static final class ErrorFrame extends GreyCat.Object {
			...
			public ErrorFrame(java.lang.String module, java.lang.String function, java.lang.Long line, java.lang.Long column) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[18], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[18].map_attributes(new Object[] {module, function, line, column}));
			}
		...
		public static final class TableColumnMapping extends GreyCat.Object {
			...
			public TableColumnMapping(java.lang.Long column, core.Array<java.lang.Object> extractors) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[19], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[19].map_attributes(new Object[] {column, extractors}));
			}
			public java.lang.Long column() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class TimeZone extends GreyCat.Enum {
			...
			public static TimeZone get(java.lang.String key, GreyCat greycat) {
				return (TimeZone) greycat.libs_by_name.get(std.name).mapped[20].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class GeoPoly extends GreyCat.Object {
			...
			public GeoPoly(core.Array<greycat.gc.core.geo> points) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[21], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[21].map_attributes(new Object[] {points}));
			}
		...
		public static final class SamplingMode extends GreyCat.Enum {
			...
			public static SamplingMode get(java.lang.String key, GreyCat greycat) {
				return (SamplingMode) greycat.libs_by_name.get(std.name).mapped[25].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class TensorType extends GreyCat.Enum {
			...
			public static TensorType get(java.lang.String key, GreyCat greycat) {
				return (TensorType) greycat.libs_by_name.get(std.name).mapped[26].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class ErrorCode extends GreyCat.Enum {
			...
			public static ErrorCode get(java.lang.String key, GreyCat greycat) {
				return (ErrorCode) greycat.libs_by_name.get(std.name).mapped[28].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class Vector extends GreyCat.Object {
			public static final java.lang.String name = "core::Vector";

			private Vector(greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}

			public Vector(core.Buffer buffer) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[29], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[29].map_attributes(new Object[] {buffer}));
			}
			public core.Buffer buffer() {
				return (core.Buffer) getAttribute(type.generated_offsets[0]);
			}
			public void set_buffer(core.Buffer v) {
				setAttribute(type.generated_offsets[0], v);
			}
		}
		...
		public static final class CalendarUnit extends GreyCat.Enum {
			...
			public CalendarUnit() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[31], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[31].map_attributes(new Object[] {}));
			}
			...
			public static CalendarUnit get(java.lang.String key, GreyCat greycat) {
				return (CalendarUnit) greycat.libs_by_name.get(std.name).mapped[31].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class MathConstants extends GreyCat.Object {
			...
			public MathConstants() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[33], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[33].map_attributes(new Object[] {}));
			}
		}
		public static final class TensorDistance extends GreyCat.Enum {
			...
			public static TensorDistance get(java.lang.String key, GreyCat greycat) {
				return (TensorDistance) greycat.libs_by_name.get(std.name).mapped[34].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class Tuple<T,U> extends GreyCat.Object {
			...
			public Tuple(T x, U y) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[37], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[37].map_attributes(new Object[] {x, y}));
			}
			public T x() {
		...
		public static final class SortOrder extends GreyCat.Enum {
			...
			public SortOrder() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[38], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[38].map_attributes(new Object[] {}));
			}
			...
			public static SortOrder get(java.lang.String key, GreyCat greycat) {
				return (SortOrder) greycat.libs_by_name.get(std.name).mapped[38].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class nodeTimeCursor<T> extends GreyCat.Object {
			...
			public nodeTimeCursor(greycat.gc.core.nodeTime<T> n, greycat.gc.core.time req_time) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[41], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[41].map_attributes(new Object[] {n, req_time}));
			}
		...
		public static final class SearchResult<K,V> extends GreyCat.Object {
			...
			public SearchResult(K key, V value, java.lang.Double distance) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[44], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[44].map_attributes(new Object[] {key, value, distance}));
			}
			public K key() {
				return (K) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class VectorLeaf<T> extends GreyCat.Object {
			public static final java.lang.String name = "core::VectorLeaf";

			private VectorLeaf(greycat.GreyCat.Type type, java.lang.Object... attributes) {
				super(type, attributes);
			}

			public VectorLeaf(core.Vector vector, core.Array<java.lang.Long> list, java.lang.Long i, T value) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[46], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[46].map_attributes(new Object[] {vector, list, i, value}));
			}
			public core.Vector vector() {
				return (core.Vector) getAttribute(type.generated_offsets[0]);
			}
			public void set_vector(core.Vector v) {
				setAttribute(type.generated_offsets[0], v);
			}
			public core.Array<java.lang.Long> list() {
				return (core.Array<java.lang.Long>) getAttribute(type.generated_offsets[1]);
			}
			public void set_list(core.Array<java.lang.Long> v) {
				setAttribute(type.generated_offsets[1], v);
			}
			public java.lang.Long i() {
				return (java.lang.Long) getAttribute(type.generated_offsets[2]);
			}
			public void set_i(java.lang.Long v) {
				setAttribute(type.generated_offsets[2], v);
			}
			public T value() {
		...
		public static final class NodeInfo<T> extends GreyCat.Object {
			...
			public NodeInfo(java.lang.Long size, T from, T to) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[47], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[47].map_attributes(new Object[] {size, from, to}));
			}
		...
		public static final class t4 extends greycat.std_n.core.t4 {
			...
			public t4(java.lang.Object... attributes) {
				super(GreyCat.DEFAULT.libs_by_name.get(std.name).mapped[48]);
			}
		}
	}
	public static final class io {
		...
		public static final class HttpResponse<T> extends GreyCat.Object {
			...
			public HttpResponse(java.lang.Long status_code, core.Map<java.lang.String, java.lang.String> headers, T content, java.lang.String error_msg) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[52], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[52].map_attributes(new Object[] {status_code, headers, content, error_msg}));
			}
		...
		public static final class TextWriter<T> extends GreyCat.Object {
			...
			public TextWriter(java.lang.String path, java.lang.Boolean append) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[53], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[53].map_attributes(new Object[] {path, append}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class CsvColumnStatistics extends GreyCat.Object {
			...
			public CsvColumnStatistics(java.lang.String name, java.lang.Object example, java.lang.Long null_count, java.lang.Long bool_count, java.lang.Long int_count, java.lang.Long float_count, java.lang.Long string_count, java.lang.Long date_count, core.Map<java.lang.String, java.lang.Long> date_format_count, core.Map<java.lang.Object, java.lang.Long> enumerable_count, util.Gaussian profile) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[54], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[54].map_attributes(new Object[] {name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, enumerable_count, profile}));
			}
		...
		public static final class SmtpAuth extends GreyCat.Enum {
			...
			public SmtpAuth() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[55], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[55].map_attributes(new Object[] {}));
			}
			...
			public static SmtpAuth get(java.lang.String key, GreyCat greycat) {
				return (SmtpAuth) greycat.libs_by_name.get(std.name).mapped[55].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class CsvSharding extends GreyCat.Object {
			...
			public CsvSharding(java.lang.Long id, java.lang.Long column, java.lang.Long modulo) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[56], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[56].map_attributes(new Object[] {id, column, modulo}));
			}
		...
		public static final class XmlReader<T> extends GreyCat.Object {
			...
			public XmlReader(java.lang.String path, java.lang.Long pos) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[57], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[57].map_attributes(new Object[] {path, pos}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Http<T> extends GreyCat.Object {
			...
			public Http() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[58], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[58].map_attributes(new Object[] {}));
			}
		}
		public static final class HttpRequest extends GreyCat.Object {
			...
			public HttpRequest(io.HttpMethod method, java.lang.String url, core.Map<java.lang.String, java.lang.String> headers, java.lang.String body) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[59], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[59].map_attributes(new Object[] {method, url, headers, body}));
			}
		...
		public static final class FileWalker extends GreyCat.Object {
			...
			public FileWalker(java.lang.String path) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[60], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[60].map_attributes(new Object[] {path}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class CsvStatistics extends GreyCat.Object {
			...
			public CsvStatistics(java.lang.Long header_lines, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, core.Array<io.CsvColumnStatistics> columns, java.lang.Long line_count, java.lang.Long fail_count, java.lang.Long file_count) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[61], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[61].map_attributes(new Object[] {header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns, line_count, fail_count, file_count}));
			}
		...
		public static final class HttpMethod extends GreyCat.Enum {
			...
			public static HttpMethod get(java.lang.String key, GreyCat greycat) {
				return (HttpMethod) greycat.libs_by_name.get(std.name).mapped[62].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class Reader<T> extends GreyCat.Object {
			...
			public Reader(java.lang.String path, java.lang.Long pos) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[63], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[63].map_attributes(new Object[] {path, pos}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class CsvReader<T> extends GreyCat.Object {
			...
			public CsvReader(java.lang.String path, java.lang.Long pos, io.CsvFormat format, io.CsvSharding sharding) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[64], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[64].map_attributes(new Object[] {path, pos, format, sharding}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class CsvFormat extends GreyCat.Object {
			...
			public CsvFormat(java.lang.Long header_lines, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, java.lang.Boolean trim, java.lang.String format, core.TimeZone tz, java.lang.Boolean strict, java.lang.Boolean nearest_time) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[65], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[65].map_attributes(new Object[] {header_lines, separator, string_delimiter, decimal_separator, thousands_separator, trim, format, tz, strict, nearest_time}));
			}
			public java.lang.Long header_lines() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class JsonWriter<T> extends GreyCat.Object {
			...
			public JsonWriter(java.lang.String path, java.lang.Boolean append) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[66], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[66].map_attributes(new Object[] {path, append}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Writer<T> extends GreyCat.Object {
			...
			public Writer(java.lang.String path, java.lang.Boolean append) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[67], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[67].map_attributes(new Object[] {path, append}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Csv extends GreyCat.Object {
			...
			public Csv() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[68], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[68].map_attributes(new Object[] {}));
			}
		...
		public static final class GcbWriter<T> extends GreyCat.Object {
			...
			public GcbWriter(java.lang.String path, java.lang.Boolean append) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[69], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[69].map_attributes(new Object[] {path, append}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class CsvWriter<T> extends GreyCat.Object {
			...
			public CsvWriter(java.lang.String path, java.lang.Boolean append, io.CsvFormat format) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[70], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[70].map_attributes(new Object[] {path, append, format}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class CsvAnalysisConfig extends GreyCat.Object {
			...
			public CsvAnalysisConfig(java.lang.Long header_lines, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, java.lang.Long row_limit, java.lang.Long enumerable_limit, java.lang.Long date_check_limit, core.Array<java.lang.String> date_formats) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[71], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[71].map_attributes(new Object[] {header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats}));
			}
			public java.lang.Long header_lines() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class File extends GreyCat.Object {
			...
			public File(java.lang.String path, java.lang.Long size, greycat.gc.core.time last_modification) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[73], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[73].map_attributes(new Object[] {path, size, last_modification}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class SmtpMode extends GreyCat.Enum {
			...
			public static SmtpMode get(java.lang.String key, GreyCat greycat) {
				return (SmtpMode) greycat.libs_by_name.get(std.name).mapped[74].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class GcbReader<T> extends GreyCat.Object {
			...
			public GcbReader(java.lang.String path, java.lang.Long pos) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[75], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[75].map_attributes(new Object[] {path, pos}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Smtp extends GreyCat.Object {
			...
			public Smtp(java.lang.String host, java.lang.Long port, io.SmtpMode mode, io.SmtpAuth authenticate, java.lang.String user, java.lang.String pass) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[76], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[76].map_attributes(new Object[] {host, port, mode, authenticate, user, pass}));
			}
		...
		public static final class Url extends GreyCat.Object {
			...
			public Url(java.lang.String protocol, java.lang.String host, java.lang.Long port, java.lang.String path, core.Map<java.lang.String, java.lang.String> params, java.lang.String hash) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[77], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[77].map_attributes(new Object[] {protocol, host, port, path, params, hash}));
			}
	...
	public static final class runtime {
		public static final class Variable extends GreyCat.Object {
			...
			public Variable(java.lang.String name, java.lang.Object value) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[78], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[78].map_attributes(new Object[] {name, value}));
			}
			public java.lang.String name() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class SecurityEntity extends GreyCat.Object {
			...
			public SecurityEntity(java.lang.Long id, java.lang.String name, java.lang.Boolean activated) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[79], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[79].map_attributes(new Object[] {id, name, activated}));
			}
			public java.lang.Long id() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class DayOfWeek extends GreyCat.Enum {
			...
			public static DayOfWeek get(java.lang.String key, GreyCat greycat) {
				return (DayOfWeek) greycat.libs_by_name.get(std.name).mapped[80].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class ResponseCode extends GreyCat.Enum {
			...
			public static ResponseCode get(java.lang.String key, GreyCat greycat) {
				return (ResponseCode) greycat.libs_by_name.get(std.name).mapped[81].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class RequestBodyObject extends GreyCat.Object {
			...
			public RequestBodyObject(core.Map<java.lang.String, runtime.MediaTypeObject> content, java.lang.Boolean required) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[82], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[82].map_attributes(new Object[] {content, required}));
			}
		...
		public static final class SchemaType extends GreyCat.Enum {
			...
			public static SchemaType get(java.lang.String key, GreyCat greycat) {
				return (SchemaType) greycat.libs_by_name.get(std.name).mapped[83].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class DateTuple extends GreyCat.Object {
			...
			public DateTuple(java.lang.Long day, runtime.Month month) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[84], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[84].map_attributes(new Object[] {day, month}));
			}
			public java.lang.Long day() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class LicenseType extends GreyCat.Enum {
			...
			public static LicenseType get(java.lang.String key, GreyCat greycat) {
				return (LicenseType) greycat.libs_by_name.get(std.name).mapped[85].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class ChildProcessResult extends GreyCat.Object {
			...
			public ChildProcessResult(java.lang.Long code, java.lang.String stdout, java.lang.String stderr) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[86], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[86].map_attributes(new Object[] {code, stdout, stderr}));
			}
		...
		public static final class HeaderObject extends GreyCat.Object {
			...
			public HeaderObject(java.lang.String description, java.lang.Boolean required) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[87], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[87].map_attributes(new Object[] {description, required}));
			}
		...
		public static final class Periodicity extends GreyCat.Object {
			...
			public Periodicity() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[88], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[88].map_attributes(new Object[] {}));
			}
		}
		public static final class FixedPeriodicity extends GreyCat.Object {
			...
			public FixedPeriodicity(greycat.gc.core.duration every) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[89], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[89].map_attributes(new Object[] {every}));
			}
		...
		public static final class ResponseObject extends GreyCat.Object {
			...
			public ResponseObject(java.lang.String description, core.Map<java.lang.String, runtime.HeaderObject> headers, core.Map<java.lang.String, runtime.MediaTypeObject> content) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[90], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[90].map_attributes(new Object[] {description, headers, content}));
			}
			public java.lang.String description() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class UserGroupPolicy extends GreyCat.Object {
			...
			public UserGroupPolicy(java.lang.Long group_id, runtime.UserGroupPolicyType type) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[91], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[91].map_attributes(new Object[] {group_id, type}));
			}
		...
		public static final class LogDataUsage extends GreyCat.Object {
			...
			public LogDataUsage(java.lang.Long read_bytes, java.lang.Long read_hits, java.lang.Long read_wasted, java.lang.Long write_bytes, java.lang.Long write_hits, java.lang.Long cache_bytes, java.lang.Long cache_hits) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[92], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[92].map_attributes(new Object[] {read_bytes, read_hits, read_wasted, write_bytes, write_hits, cache_bytes, cache_hits}));
			}
		...
		public static final class Scheduler extends GreyCat.Object {
			...
			public Scheduler() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[93], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[93].map_attributes(new Object[] {}));
			}
		...
		public static final class UserGroup extends GreyCat.Object {
			...
			public UserGroup(java.lang.Long id, java.lang.String name, java.lang.Boolean activated) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[94], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[94].map_attributes(new Object[] {id, name, activated}));
			}
			public java.lang.Long id() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class SecurityFields extends GreyCat.Object {
			...
			public SecurityFields(java.lang.String email, java.lang.String name, java.lang.String first_name, java.lang.String last_name, core.Map<java.lang.String, java.lang.String> roles, core.Map<java.lang.String, java.lang.String> groups) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[95], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[95].map_attributes(new Object[] {email, name, first_name, last_name, roles, groups}));
			}
		...
		public static final class OpenApiVersion extends GreyCat.Enum {
			...
			public static OpenApiVersion get(java.lang.String key, GreyCat greycat) {
				return (OpenApiVersion) greycat.libs_by_name.get(std.name).mapped[96].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class PathItemObject extends GreyCat.Object {
			...
			public PathItemObject(java.lang.String description, runtime.OperationObject post) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[97], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[97].map_attributes(new Object[] {description, post}));
			}
			public java.lang.String description() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Job<T> extends GreyCat.Object {
			...
			public Job(core.function function, core.Array arguments) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[99], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[99].map_attributes(new Object[] {function, arguments}));
			}
		...
		public static final class LogLevel extends GreyCat.Enum {
			...
			public static LogLevel get(java.lang.String key, GreyCat greycat) {
				return (LogLevel) greycat.libs_by_name.get(std.name).mapped[100].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class UserGroupPolicyType extends GreyCat.Enum {
			...
			public static UserGroupPolicyType get(java.lang.String key, GreyCat greycat) {
				return (UserGroupPolicyType) greycat.libs_by_name.get(std.name).mapped[101].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class Frame extends GreyCat.Object {
			...
			public Frame(java.lang.String module, java.lang.String type, java.lang.String function, java.lang.String src, java.lang.Long line, java.lang.Long column, core.Array<runtime.Variable> scope) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[102], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[102].map_attributes(new Object[] {module, type, function, src, line, column, scope}));
			}
			public java.lang.String module() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class MediaTypeObject extends GreyCat.Object {
			...
			public MediaTypeObject(runtime.SchemaObject schema) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[103], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[103].map_attributes(new Object[] {schema}));
			}
		...
		public static final class Debug extends GreyCat.Object {
			...
			public Debug(java.lang.Long id, core.Array<runtime.Frame> frames, java.lang.Object root) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[105], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[105].map_attributes(new Object[] {id, frames, root}));
			}
			public java.lang.Long id() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Month extends GreyCat.Enum {
			...
			public static Month get(java.lang.String key, GreyCat greycat) {
				return (Month) greycat.libs_by_name.get(std.name).mapped[107].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class TaskStatus extends GreyCat.Enum {
			...
			public static TaskStatus get(java.lang.String key, GreyCat greycat) {
				return (TaskStatus) greycat.libs_by_name.get(std.name).mapped[108].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class UserCredential extends GreyCat.Object {
			...
			public UserCredential(java.lang.Long offset, java.lang.String pass) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[109], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[109].map_attributes(new Object[] {offset, pass}));
			}
		...
		public static final class RuntimeInfo extends GreyCat.Object {
			...
			public RuntimeInfo(java.lang.String version, java.lang.String program_version, java.lang.String arch, core.TimeZone timezone, runtime.License license, java.lang.Long io_threads, java.lang.Long bg_threads, java.lang.Long fg_threads, java.lang.Long mem_total, java.lang.Long mem_worker, java.lang.Long disk_data_bytes) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[111], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[111].map_attributes(new Object[] {version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, disk_data_bytes}));
			}
		...
		public static final class ComponentsObject extends GreyCat.Object {
			...
			public ComponentsObject(core.Map<java.lang.String, runtime.SchemaObject> schemas) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[112], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[112].map_attributes(new Object[] {schemas}));
			}
		...
		public static final class OperationObject extends GreyCat.Object {
			...
			public OperationObject(runtime.RequestBodyObject requestBody, core.Map<java.lang.String, runtime.ResponseObject> responses) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[114], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[114].map_attributes(new Object[] {requestBody, responses}));
			}
			public runtime.RequestBodyObject requestBody() {
				return (runtime.RequestBodyObject) getAttribute(type.generated_offsets[0]);
			}
			public void set_requestBody(runtime.RequestBodyObject v) {
				setAttribute(type.generated_offsets[0], v);
			}
			public core.Map<java.lang.String, runtime.ResponseObject> responses() {
				return (core.Map<java.lang.String, runtime.ResponseObject>) getAttribute(type.generated_offsets[1]);
			}
		...
		public static final class Role extends GreyCat.Object {
			...
			public Role(java.lang.String name, core.Array<java.lang.String> permissions) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[115], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[115].map_attributes(new Object[] {name, permissions}));
			}
			public java.lang.String name() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class InfoObject extends GreyCat.Object {
			...
			public InfoObject(java.lang.String title, java.lang.String version) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[116], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[116].map_attributes(new Object[] {title, version}));
			}
		...
		public static final class License extends GreyCat.Object {
			...
			public License(java.lang.String name, greycat.gc.core.time start, greycat.gc.core.time end, java.lang.String company, java.lang.Long max_memory, java.lang.Long extra_1, java.lang.Long extra_2, runtime.LicenseType type) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[117], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[117].map_attributes(new Object[] {name, start, end, company, max_memory, extra_1, extra_2, type}));
			}
			public java.lang.String name() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class OpenIDConnect extends GreyCat.Object {
			...
			public OpenIDConnect(java.lang.String url, java.lang.String clientId) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[118], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[118].map_attributes(new Object[] {url, clientId}));
			}
			public java.lang.String url() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Permission extends GreyCat.Object {
			...
			public Permission(java.lang.String name, java.lang.String description) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[119], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[119].map_attributes(new Object[] {name, description}));
			}
			public java.lang.String name() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class SchemaObject extends GreyCat.Object {
			...
			public SchemaObject(java.lang.String $ref, runtime.SchemaType type, runtime.SchemaFormat format, java.lang.Boolean nullable, core.Map<java.lang.String, runtime.SchemaObject> properties, core.Array<java.lang.String> required, runtime.SchemaObject items, core.Array<runtime.SchemaObject> oneOf, core.Array<runtime.SchemaObject> allOf, java.lang.Long minItems, java.lang.Long maxItems, core.Array<java.lang.String> enum_, runtime.SchemaObject additionalProperties) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[121], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[121].map_attributes(new Object[] {$ref, type, format, nullable, properties, required, items, oneOf, allOf, minItems, maxItems, enum_, additionalProperties}));
			}
			...
			public runtime.SchemaType type() {
				return (runtime.SchemaType) getAttribute(type.generated_offsets[1]);
			}
			public void set_type(runtime.SchemaType v) {
				setAttribute(type.generated_offsets[1], v);
			}
			public runtime.SchemaFormat format() {
				return (runtime.SchemaFormat) getAttribute(type.generated_offsets[2]);
			}
			...
			public core.Map<java.lang.String, runtime.SchemaObject> properties() {
				return (core.Map<java.lang.String, runtime.SchemaObject>) getAttribute(type.generated_offsets[4]);
			}
			...
			public runtime.SchemaObject items() {
				return (runtime.SchemaObject) getAttribute(type.generated_offsets[6]);
			}
			public void set_items(runtime.SchemaObject v) {
				setAttribute(type.generated_offsets[6], v);
			}
			public core.Array<runtime.SchemaObject> oneOf() {
				return (core.Array<runtime.SchemaObject>) getAttribute(type.generated_offsets[7]);
			}
			...
			public core.Array<java.lang.String> enum_() {
				return (core.Array<java.lang.String>) getAttribute(type.generated_offsets[11]);
			}
			...
			public runtime.SchemaObject additionalProperties() {
				return (runtime.SchemaObject) getAttribute(type.generated_offsets[12]);
			}
		...
		public static final class PeriodicOptions extends GreyCat.Object {
			...
			public PeriodicOptions(java.lang.Boolean activated, greycat.gc.core.time start, greycat.gc.core.duration max_duration) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[122], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[122].map_attributes(new Object[] {activated, start, max_duration}));
			}
			public java.lang.Boolean activated() {
		...
		public static final class DailyPeriodicity extends GreyCat.Object {
			...
			public DailyPeriodicity(java.lang.Long hour, java.lang.Long minute, java.lang.Long second, core.TimeZone timezone) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[123], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[123].map_attributes(new Object[] {hour, minute, second, timezone}));
			}
			public java.lang.Long hour() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Task extends GreyCat.Object {
			...
			public Task(java.lang.Long user_id, java.lang.Long task_id, java.lang.String mod, java.lang.String type, java.lang.String fun, greycat.gc.core.time creation, greycat.gc.core.time start, greycat.gc.core.duration duration, runtime.TaskStatus status, java.lang.Double progress) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[124], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[124].map_attributes(new Object[] {user_id, task_id, mod, type, fun, creation, start, duration, status, progress}));
			}
			public java.lang.Long user_id() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class System extends GreyCat.Object {
			...
			public System() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[125], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[125].map_attributes(new Object[] {}));
			}
		}
		public static final class WeeklyPeriodicity extends GreyCat.Object {
			...
			public WeeklyPeriodicity(core.Array<runtime.DayOfWeek> days, runtime.DailyPeriodicity daily) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[126], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[126].map_attributes(new Object[] {days, daily}));
			}
		...
		public static final class PeriodicTask extends GreyCat.Object {
			...
			public PeriodicTask(core.function function, runtime.Periodicity periodicity, runtime.PeriodicOptions options, java.lang.Boolean is_active, greycat.gc.core.time next_execution, java.lang.Long execution_count) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[127], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[127].map_attributes(new Object[] {function, periodicity, options, is_active, next_execution, execution_count}));
			}
			public core.function function() {
				return (core.function) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class User extends GreyCat.Object {
			...
			public User(java.lang.Long id, java.lang.String name, java.lang.Boolean activated, java.lang.String full_name, java.lang.String email, java.lang.String role, core.Array<runtime.UserGroupPolicy> groups, java.lang.Long groups_flags, java.lang.Boolean external) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[128], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[128].map_attributes(new Object[] {id, name, activated, full_name, email, role, groups, groups_flags, external}));
			}
			public java.lang.Long id() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class OpenApiV3 extends GreyCat.Object {
			...
			public OpenApiV3(runtime.OpenApiVersion openapi, runtime.InfoObject info, core.Map<java.lang.String, runtime.PathItemObject> paths, runtime.ComponentsObject components) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[129], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[129].map_attributes(new Object[] {openapi, info, paths, components}));
			}
		...
		public static final class SchemaFormat extends GreyCat.Enum {
			...
			public static SchemaFormat get(java.lang.String key, GreyCat greycat) {
				return (SchemaFormat) greycat.libs_by_name.get(std.name).mapped[130].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class MergeStrategy extends GreyCat.Enum {
			...
			public MergeStrategy() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[131], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[131].map_attributes(new Object[] {}));
			}
			...
			public static MergeStrategy get(java.lang.String key, GreyCat greycat) {
				return (MergeStrategy) greycat.libs_by_name.get(std.name).mapped[131].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class YearlyPeriodicity extends GreyCat.Object {
			...
			public YearlyPeriodicity(core.Array<runtime.DateTuple> dates, core.TimeZone timezone) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[132], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[132].map_attributes(new Object[] {dates, timezone}));
			}
	...
	public static final class util {
		public static final class ProgressTracker extends GreyCat.Object {
			...
			public ProgressTracker(greycat.gc.core.time start, java.lang.Long total, java.lang.Long counter, greycat.gc.core.duration duration, java.lang.Double progress, java.lang.Double speed, greycat.gc.core.duration remaining) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[133], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[133].map_attributes(new Object[] {start, total, counter, duration, progress, speed, remaining}));
			}
			public greycat.gc.core.time start() {
		...
		public static final class Gaussian<T> extends GreyCat.Object {
			...
			public Gaussian(java.lang.Double sum, java.lang.Double sumsq, java.lang.Long count, T min, T max) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[134], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[134].map_attributes(new Object[] {sum, sumsq, count, min, max}));
			}
		...
		public static final class Random extends GreyCat.Object {
			...
			public Random(java.lang.Long seed, java.lang.Double v) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[135], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[135].map_attributes(new Object[] {seed, v}));
			}
		...
		public static final class SlidingWindow<T> extends GreyCat.Object {
			...
			public SlidingWindow(core.Array<T> values, java.lang.Long span, java.lang.Double sum, java.lang.Double sumsq, core.field field) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[136], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[136].map_attributes(new Object[] {values, span, sum, sumsq, field}));
			}
		...
		public static final class LinearQuantizer<T> extends GreyCat.Object {
			...
			public LinearQuantizer(T min, T max, java.lang.Long bins, java.lang.Boolean open) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[137], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[137].map_attributes(new Object[] {min, max, bins, open}));
			}
			public T min() {
				return (T) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Stack<T> extends GreyCat.Object {
			...
			public Stack(core.Array<T> values) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[138], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[138].map_attributes(new Object[] {values}));
			}
			public core.Array<T> values() {
				return (core.Array<T>) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Histogram<T> extends GreyCat.Object {
			...
			public Histogram(util.Quantizer<T> quantizer, core.Array<java.lang.Long> bins, java.lang.Long nb_rejected, java.lang.Long nb_accepted, T min, T max, java.lang.Double sum, java.lang.Double sumsq) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[139], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[139].map_attributes(new Object[] {quantizer, bins, nb_rejected, nb_accepted, min, max, sum, sumsq}));
			}
		...
		public static final class Queue<T> extends GreyCat.Object {
			...
			public Queue(core.Array<T> values, java.lang.Long capacity) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[140], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[140].map_attributes(new Object[] {values, capacity}));
			}
			public core.Array<T> values() {
				return (core.Array<T>) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class QuantizerSlotBound<T> extends GreyCat.Object {
			...
			public QuantizerSlotBound(T min, T max, T center) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[141], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[141].map_attributes(new Object[] {min, max, center}));
			}
			public T min() {
				return (T) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Quantizer<T> extends GreyCat.Object {
			...
			public Quantizer() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[142], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[142].map_attributes(new Object[] {}));
			}
		}
		public static final class CustomQuantizer<T> extends GreyCat.Object {
			...
			public CustomQuantizer(T min, T max, core.Array<T> step_starts, java.lang.Boolean open) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[143], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[143].map_attributes(new Object[] {min, max, step_starts, open}));
			}
			public T min() {
				return (T) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class GaussianProfileSlot extends GreyCat.Object {
			...
			public GaussianProfileSlot(java.lang.Long sum, java.lang.Long sumsq, java.lang.Long count) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[144], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[144].map_attributes(new Object[] {sum, sumsq, count}));
			}
		...
		public static final class HistogramBin<T> extends GreyCat.Object {
			...
			public HistogramBin(util.QuantizerSlotBound<T> bin, java.lang.Long count, java.lang.Double ratio, java.lang.Long cumulative_count, java.lang.Double cumulative_ratio) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[146], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[146].map_attributes(new Object[] {bin, count, ratio, cumulative_count, cumulative_ratio}));
			}
		...
		public static final class GaussianProfile<T> extends GreyCat.Object {
			...
			public GaussianProfile(util.Quantizer<T> quantizer, core.FloatPrecision precision, core.Table<util.GaussianProfileSlot> bins, java.lang.Double value_min, java.lang.Long nb_rejected) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[147], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[147].map_attributes(new Object[] {quantizer, precision, bins, value_min, nb_rejected}));
			}
			public util.Quantizer<T> quantizer() {
				return (util.Quantizer<T>) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class LogQuantizer<T> extends GreyCat.Object {
			...
			public LogQuantizer(T min, T max, java.lang.Long bins, java.lang.Boolean open) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[149], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[149].map_attributes(new Object[] {min, max, bins, open}));
			}
			public T min() {
				return (T) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class TimeWindow<T> extends GreyCat.Object {
			...
			public TimeWindow(core.Table<core.Tuple<greycat.gc.core.time, T>> values, greycat.gc.core.duration span, java.lang.Double sum, java.lang.Double sumsq, core.field field) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[150], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[150].map_attributes(new Object[] {values, span, sum, sumsq, field}));
			}
		...
		public static final class MultiQuantizer<T> extends GreyCat.Object {
			...
			public MultiQuantizer(core.Array<util.Quantizer<T>> quantizers) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[151], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[151].map_attributes(new Object[] {quantizers}));
			}
		...
		public static final class Assert extends GreyCat.Object {
			...
			public Assert() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[152], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[152].map_attributes(new Object[] {}));
			}
		}
	...
	public static final class std extends GreyCat.Library {
		...
		public void configure(java.util.Map<java.lang.String, GreyCat.Loader> loaders, java.util.Map<java.lang.String, GreyCat.Factory> factories) {
			...
			factories.put(core.Vector.name, core.Vector::new);
			...
			factories.put(core.VectorLeaf.name, core.VectorLeaf::new);
		...
		public void init(GreyCat greycat) {
			...
			mapped[29] = greycat.types_by_name.get(core.Vector.name);
			if(this.mapped[29] != null){
				this.mapped[29].resolveGeneratedOffsets("buffer");
			}
			mapped[30] = greycat.types_by_name.get(core.nodeIndex.name);
			mapped[31] = greycat.types_by_name.get(core.CalendarUnit.name);
			if(this.mapped[31] != null){
				this.mapped[31].resolveGeneratedOffsetWithValues("year", 0L,"month", 1L,"day", 2L,"hour", 3L,"minute", 4L,"second", 5L,"microsecond", 6L);
			}
			mapped[32] = greycat.types_by_name.get(core.Table.name);
			mapped[33] = greycat.types_by_name.get(core.MathConstants.name);
			mapped[34] = greycat.types_by_name.get(core.TensorDistance.name);
			if(this.mapped[34] != null){
				this.mapped[34].resolveGeneratedOffsetWithValues("euclidean", null,"cosine", null);
			}
			mapped[35] = greycat.types_by_name.get(core.duration.name);
			mapped[36] = greycat.types_by_name.get(core.Array.name);
			mapped[37] = greycat.types_by_name.get(core.Tuple.name);
			if(this.mapped[37] != null){
				this.mapped[37].resolveGeneratedOffsets("x","y");
			}
			mapped[38] = greycat.types_by_name.get(core.SortOrder.name);
			if(this.mapped[38] != null){
				this.mapped[38].resolveGeneratedOffsetWithValues("asc", null,"desc", null);
			}
			mapped[39] = greycat.types_by_name.get(core.Map.name);
			mapped[40] = greycat.types_by_name.get(core.nodeGeo.name);
			mapped[41] = greycat.types_by_name.get(core.nodeTimeCursor.name);
			if(this.mapped[41] != null){
				this.mapped[41].resolveGeneratedOffsets("n","req_time");
			}
			mapped[42] = greycat.types_by_name.get(core.t2.name);
			mapped[43] = greycat.types_by_name.get(core.t2f.name);
			mapped[44] = greycat.types_by_name.get(core.SearchResult.name);
			if(this.mapped[44] != null){
				this.mapped[44].resolveGeneratedOffsets("key","value","distance");
			}
			mapped[45] = greycat.types_by_name.get(core.function.name);
			mapped[46] = greycat.types_by_name.get(core.VectorLeaf.name);
			if(this.mapped[46] != null){
				this.mapped[46].resolveGeneratedOffsets("vector","list","i","value");
			}
			mapped[47] = greycat.types_by_name.get(core.NodeInfo.name);
			if(this.mapped[47] != null){
				this.mapped[47].resolveGeneratedOffsets("size","from","to");
			}
			mapped[48] = greycat.types_by_name.get(core.t4.name);
			mapped[49] = greycat.types_by_name.get(io.JsonReader.name);
			if(this.mapped[49] != null){
				this.mapped[49].resolveGeneratedOffsets("path","pos");
			}
			mapped[50] = greycat.types_by_name.get(io.TextReader.name);
			...
			mapped[52] = greycat.types_by_name.get(io.HttpResponse.name);
			if(this.mapped[52] != null){
				this.mapped[52].resolveGeneratedOffsets("status_code","headers","content","error_msg");
			}
			mapped[53] = greycat.types_by_name.get(io.TextWriter.name);
			if(this.mapped[53] != null){
				this.mapped[53].resolveGeneratedOffsets("path","append");
			}
			mapped[54] = greycat.types_by_name.get(io.CsvColumnStatistics.name);
			if(this.mapped[54] != null){
				this.mapped[54].resolveGeneratedOffsets("name","example","null_count","bool_count","int_count","float_count","string_count","date_count","date_format_count","enumerable_count","profile");
			}
			mapped[55] = greycat.types_by_name.get(io.SmtpAuth.name);
			if(this.mapped[55] != null){
				this.mapped[55].resolveGeneratedOffsetWithValues("none", 0L,"plain", 1L,"login", 2L);
			}
			mapped[56] = greycat.types_by_name.get(io.CsvSharding.name);
			if(this.mapped[56] != null){
				this.mapped[56].resolveGeneratedOffsets("id","column","modulo");
			}
			mapped[57] = greycat.types_by_name.get(io.XmlReader.name);
			if(this.mapped[57] != null){
				this.mapped[57].resolveGeneratedOffsets("path","pos");
			}
			mapped[58] = greycat.types_by_name.get(io.Http.name);
			mapped[59] = greycat.types_by_name.get(io.HttpRequest.name);
			if(this.mapped[59] != null){
				this.mapped[59].resolveGeneratedOffsets("method","url","headers","body");
			}
			mapped[60] = greycat.types_by_name.get(io.FileWalker.name);
			if(this.mapped[60] != null){
				this.mapped[60].resolveGeneratedOffsets("path");
			}
			mapped[61] = greycat.types_by_name.get(io.CsvStatistics.name);
			if(this.mapped[61] != null){
				this.mapped[61].resolveGeneratedOffsets("header_lines","separator","string_delimiter","decimal_separator","thousands_separator","columns","line_count","fail_count","file_count");
			}
			mapped[62] = greycat.types_by_name.get(io.HttpMethod.name);
			if(this.mapped[62] != null){
				this.mapped[62].resolveGeneratedOffsetWithValues("GET", null,"HEAD", null,"POST", null,"PUT", null,"DELETE", null,"CONNECT", null,"OPTIONS", null,"TRACE", null,"PATCH", null);
			}
			mapped[63] = greycat.types_by_name.get(io.Reader.name);
			if(this.mapped[63] != null){
				this.mapped[63].resolveGeneratedOffsets("path","pos");
			}
			mapped[64] = greycat.types_by_name.get(io.CsvReader.name);
			if(this.mapped[64] != null){
				this.mapped[64].resolveGeneratedOffsets("path","pos","format","sharding");
			}
			mapped[65] = greycat.types_by_name.get(io.CsvFormat.name);
			if(this.mapped[65] != null){
				this.mapped[65].resolveGeneratedOffsets("header_lines","separator","string_delimiter","decimal_separator","thousands_separator","trim","format","tz","strict","nearest_time");
			}
			mapped[66] = greycat.types_by_name.get(io.JsonWriter.name);
			if(this.mapped[66] != null){
				this.mapped[66].resolveGeneratedOffsets("path","append");
			}
			mapped[67] = greycat.types_by_name.get(io.Writer.name);
			if(this.mapped[67] != null){
				this.mapped[67].resolveGeneratedOffsets("path","append");
			}
			mapped[68] = greycat.types_by_name.get(io.Csv.name);
			mapped[69] = greycat.types_by_name.get(io.GcbWriter.name);
			if(this.mapped[69] != null){
				this.mapped[69].resolveGeneratedOffsets("path","append");
			}
			mapped[70] = greycat.types_by_name.get(io.CsvWriter.name);
			if(this.mapped[70] != null){
				this.mapped[70].resolveGeneratedOffsets("path","append","format");
			}
			mapped[71] = greycat.types_by_name.get(io.CsvAnalysisConfig.name);
			if(this.mapped[71] != null){
				this.mapped[71].resolveGeneratedOffsets("header_lines","separator","string_delimiter","decimal_separator","thousands_separator","row_limit","enumerable_limit","date_check_limit","date_formats");
			}
			mapped[72] = greycat.types_by_name.get(io.Json.name);
			mapped[73] = greycat.types_by_name.get(io.File.name);
			if(this.mapped[73] != null){
				this.mapped[73].resolveGeneratedOffsets("path","size","last_modification");
			}
			mapped[74] = greycat.types_by_name.get(io.SmtpMode.name);
			if(this.mapped[74] != null){
				this.mapped[74].resolveGeneratedOffsetWithValues("plain", 0L,"ssl_tls", 1L,"starttls", 2L);
			}
			mapped[75] = greycat.types_by_name.get(io.GcbReader.name);
			if(this.mapped[75] != null){
				this.mapped[75].resolveGeneratedOffsets("path","pos");
			}
			mapped[76] = greycat.types_by_name.get(io.Smtp.name);
			if(this.mapped[76] != null){
				this.mapped[76].resolveGeneratedOffsets("host","port","mode","authenticate","user","pass");
			}
			mapped[77] = greycat.types_by_name.get(io.Url.name);
			if(this.mapped[77] != null){
				this.mapped[77].resolveGeneratedOffsets("protocol","host","port","path","params","hash");
			}
			mapped[78] = greycat.types_by_name.get(runtime.Variable.name);
			if(this.mapped[78] != null){
				this.mapped[78].resolveGeneratedOffsets("name","value");
			}
			mapped[79] = greycat.types_by_name.get(runtime.SecurityEntity.name);
			if(this.mapped[79] != null){
				this.mapped[79].resolveGeneratedOffsets("id","name","activated");
			}
			mapped[80] = greycat.types_by_name.get(runtime.DayOfWeek.name);
			if(this.mapped[80] != null){
				this.mapped[80].resolveGeneratedOffsetWithValues("Mon", 0L,"Tue", 1L,"Wed", 2L,"Thu", 3L,"Fri", 4L,"Sat", 5L,"Sun", 6L);
			}
			mapped[81] = greycat.types_by_name.get(runtime.ResponseCode.name);
			if(this.mapped[81] != null){
				this.mapped[81].resolveGeneratedOffsetWithValues("200", null,"400", null,"404", null);
			}
			mapped[82] = greycat.types_by_name.get(runtime.RequestBodyObject.name);
			if(this.mapped[82] != null){
				this.mapped[82].resolveGeneratedOffsets("content","required");
			}
			mapped[83] = greycat.types_by_name.get(runtime.SchemaType.name);
			if(this.mapped[83] != null){
				this.mapped[83].resolveGeneratedOffsetWithValues("string", null,"number", null,"integer", null,"boolean", null,"object", null,"array", null);
			}
			mapped[84] = greycat.types_by_name.get(runtime.DateTuple.name);
			if(this.mapped[84] != null){
				this.mapped[84].resolveGeneratedOffsets("day","month");
			}
			mapped[85] = greycat.types_by_name.get(runtime.LicenseType.name);
			if(this.mapped[85] != null){
				this.mapped[85].resolveGeneratedOffsetWithValues("community", null,"enterprise", null,"testing", null);
			}
			mapped[86] = greycat.types_by_name.get(runtime.ChildProcessResult.name);
			if(this.mapped[86] != null){
				this.mapped[86].resolveGeneratedOffsets("code","stdout","stderr");
			}
			mapped[87] = greycat.types_by_name.get(runtime.HeaderObject.name);
			if(this.mapped[87] != null){
				this.mapped[87].resolveGeneratedOffsets("description","required");
			}
			mapped[88] = greycat.types_by_name.get(runtime.Periodicity.name);
			mapped[89] = greycat.types_by_name.get(runtime.FixedPeriodicity.name);
			if(this.mapped[89] != null){
				this.mapped[89].resolveGeneratedOffsets("every");
			}
			mapped[90] = greycat.types_by_name.get(runtime.ResponseObject.name);
			if(this.mapped[90] != null){
				this.mapped[90].resolveGeneratedOffsets("description","headers","content");
			}
			mapped[91] = greycat.types_by_name.get(runtime.UserGroupPolicy.name);
			if(this.mapped[91] != null){
				this.mapped[91].resolveGeneratedOffsets("group_id","type");
			}
			mapped[92] = greycat.types_by_name.get(runtime.LogDataUsage.name);
			if(this.mapped[92] != null){
				this.mapped[92].resolveGeneratedOffsets("read_bytes","read_hits","read_wasted","write_bytes","write_hits","cache_bytes","cache_hits");
			}
			mapped[93] = greycat.types_by_name.get(runtime.Scheduler.name);
			mapped[94] = greycat.types_by_name.get(runtime.UserGroup.name);
			if(this.mapped[94] != null){
				this.mapped[94].resolveGeneratedOffsets("id","name","activated");
			}
			mapped[95] = greycat.types_by_name.get(runtime.SecurityFields.name);
			if(this.mapped[95] != null){
				this.mapped[95].resolveGeneratedOffsets("email","name","first_name","last_name","roles","groups");
			}
			mapped[96] = greycat.types_by_name.get(runtime.OpenApiVersion.name);
			if(this.mapped[96] != null){
				this.mapped[96].resolveGeneratedOffsetWithValues("3.0.4", null);
			}
			mapped[97] = greycat.types_by_name.get(runtime.PathItemObject.name);
			if(this.mapped[97] != null){
				this.mapped[97].resolveGeneratedOffsets("description","post");
			}
			...
			mapped[99] = greycat.types_by_name.get(runtime.Job.name);
			if(this.mapped[99] != null){
				this.mapped[99].resolveGeneratedOffsets("function","arguments");
			}
			mapped[100] = greycat.types_by_name.get(runtime.LogLevel.name);
			if(this.mapped[100] != null){
				this.mapped[100].resolveGeneratedOffsetWithValues("error", null,"warn", null,"info", null,"perf", null,"trace", null);
			}
			mapped[101] = greycat.types_by_name.get(runtime.UserGroupPolicyType.name);
			if(this.mapped[101] != null){
				this.mapped[101].resolveGeneratedOffsetWithValues("read", null,"write", null,"execute", null);
			}
			mapped[102] = greycat.types_by_name.get(runtime.Frame.name);
			if(this.mapped[102] != null){
				this.mapped[102].resolveGeneratedOffsets("module","type","function","src","line","column","scope");
			}
			mapped[103] = greycat.types_by_name.get(runtime.MediaTypeObject.name);
			if(this.mapped[103] != null){
				this.mapped[103].resolveGeneratedOffsets("schema");
			}
			mapped[104] = greycat.types_by_name.get(runtime.OpenApi.name);
			mapped[105] = greycat.types_by_name.get(runtime.Debug.name);
			if(this.mapped[105] != null){
				this.mapped[105].resolveGeneratedOffsets("id","frames","root");
			}
			...
			mapped[107] = greycat.types_by_name.get(runtime.Month.name);
			if(this.mapped[107] != null){
				this.mapped[107].resolveGeneratedOffsetWithValues("Jan", 0L,"Feb", 1L,"Mar", 2L,"Apr", 3L,"May", 4L,"Jun", 5L,"Jul", 6L,"Aug", 7L,"Sep", 8L,"Oct", 9L,"Nov", 10L,"Dec", 11L);
			}
			mapped[108] = greycat.types_by_name.get(runtime.TaskStatus.name);
			if(this.mapped[108] != null){
				this.mapped[108].resolveGeneratedOffsetWithValues("empty", null,"waiting", null,"running", null,"await", null,"cancelled", null,"error", null,"ended", null,"ended_with_errors", null);
			}
			mapped[109] = greycat.types_by_name.get(runtime.UserCredential.name);
			if(this.mapped[109] != null){
				this.mapped[109].resolveGeneratedOffsets("offset","pass");
			}
			...
			mapped[111] = greycat.types_by_name.get(runtime.RuntimeInfo.name);
			if(this.mapped[111] != null){
				this.mapped[111].resolveGeneratedOffsets("version","program_version","arch","timezone","license","io_threads","bg_threads","fg_threads","mem_total","mem_worker","disk_data_bytes");
			}
			mapped[112] = greycat.types_by_name.get(runtime.ComponentsObject.name);
			if(this.mapped[112] != null){
				this.mapped[112].resolveGeneratedOffsets("schemas");
			}
			mapped[113] = greycat.types_by_name.get(runtime.MonthlyPeriodicity.name);
			if(this.mapped[113] != null){
				this.mapped[113].resolveGeneratedOffsets("days","daily");
			}
			mapped[114] = greycat.types_by_name.get(runtime.OperationObject.name);
			if(this.mapped[114] != null){
				this.mapped[114].resolveGeneratedOffsets("requestBody","responses");
			}
			mapped[115] = greycat.types_by_name.get(runtime.Role.name);
			if(this.mapped[115] != null){
				this.mapped[115].resolveGeneratedOffsets("name","permissions");
			}
			mapped[116] = greycat.types_by_name.get(runtime.InfoObject.name);
			if(this.mapped[116] != null){
				this.mapped[116].resolveGeneratedOffsets("title","version");
			}
			mapped[117] = greycat.types_by_name.get(runtime.License.name);
			if(this.mapped[117] != null){
				this.mapped[117].resolveGeneratedOffsets("name","start","end","company","max_memory","extra_1","extra_2","type");
			}
			mapped[118] = greycat.types_by_name.get(runtime.OpenIDConnect.name);
			if(this.mapped[118] != null){
				this.mapped[118].resolveGeneratedOffsets("url","clientId");
			}
			mapped[119] = greycat.types_by_name.get(runtime.Permission.name);
			if(this.mapped[119] != null){
				this.mapped[119].resolveGeneratedOffsets("name","description");
			}
			mapped[120] = greycat.types_by_name.get(runtime.Runtime.name);
			mapped[121] = greycat.types_by_name.get(runtime.SchemaObject.name);
			if(this.mapped[121] != null){
				this.mapped[121].resolveGeneratedOffsets("$ref","type","format","nullable","properties","required","items","oneOf","allOf","minItems","maxItems","enum","additionalProperties");
			}
			mapped[122] = greycat.types_by_name.get(runtime.PeriodicOptions.name);
			if(this.mapped[122] != null){
				this.mapped[122].resolveGeneratedOffsets("activated","start","max_duration");
			}
			mapped[123] = greycat.types_by_name.get(runtime.DailyPeriodicity.name);
			if(this.mapped[123] != null){
				this.mapped[123].resolveGeneratedOffsets("hour","minute","second","timezone");
			}
			mapped[124] = greycat.types_by_name.get(runtime.Task.name);
			if(this.mapped[124] != null){
				this.mapped[124].resolveGeneratedOffsets("user_id","task_id","mod","type","fun","creation","start","duration","status","progress");
			}
			mapped[125] = greycat.types_by_name.get(runtime.System.name);
			mapped[126] = greycat.types_by_name.get(runtime.WeeklyPeriodicity.name);
			if(this.mapped[126] != null){
				this.mapped[126].resolveGeneratedOffsets("days","daily");
			}
			mapped[127] = greycat.types_by_name.get(runtime.PeriodicTask.name);
			if(this.mapped[127] != null){
				this.mapped[127].resolveGeneratedOffsets("function","periodicity","options","is_active","next_execution","execution_count");
			}
			mapped[128] = greycat.types_by_name.get(runtime.User.name);
			if(this.mapped[128] != null){
				this.mapped[128].resolveGeneratedOffsets("id","name","activated","full_name","email","role","groups","groups_flags","external");
			}
			mapped[129] = greycat.types_by_name.get(runtime.OpenApiV3.name);
			if(this.mapped[129] != null){
				this.mapped[129].resolveGeneratedOffsets("openapi","info","paths","components");
			}
			mapped[130] = greycat.types_by_name.get(runtime.SchemaFormat.name);
			if(this.mapped[130] != null){
				this.mapped[130].resolveGeneratedOffsetWithValues("int32", null,"int64", null,"float", null,"double", null,"byte", null,"binary", null,"date", null,"date-time", null,"password", null);
			}
			mapped[131] = greycat.types_by_name.get(runtime.MergeStrategy.name);
			if(this.mapped[131] != null){
				this.mapped[131].resolveGeneratedOffsetWithValues("strict", null,"first_wins", null,"last_wins", null);
			}
			mapped[132] = greycat.types_by_name.get(runtime.YearlyPeriodicity.name);
			if(this.mapped[132] != null){
				this.mapped[132].resolveGeneratedOffsets("dates","timezone");
			}
			mapped[133] = greycat.types_by_name.get(util.ProgressTracker.name);
			if(this.mapped[133] != null){
				this.mapped[133].resolveGeneratedOffsets("start","total","counter","duration","progress","speed","remaining");
			}
			mapped[134] = greycat.types_by_name.get(util.Gaussian.name);
			if(this.mapped[134] != null){
				this.mapped[134].resolveGeneratedOffsets("sum","sumsq","count","min","max");
			}
			mapped[135] = greycat.types_by_name.get(util.Random.name);
			if(this.mapped[135] != null){
				this.mapped[135].resolveGeneratedOffsets("seed","v");
			}
			mapped[136] = greycat.types_by_name.get(util.SlidingWindow.name);
			if(this.mapped[136] != null){
				this.mapped[136].resolveGeneratedOffsets("values","span","sum","sumsq","field");
			}
			mapped[137] = greycat.types_by_name.get(util.LinearQuantizer.name);
			if(this.mapped[137] != null){
				this.mapped[137].resolveGeneratedOffsets("min","max","bins","open");
			}
			mapped[138] = greycat.types_by_name.get(util.Stack.name);
			if(this.mapped[138] != null){
				this.mapped[138].resolveGeneratedOffsets("values");
			}
			mapped[139] = greycat.types_by_name.get(util.Histogram.name);
			if(this.mapped[139] != null){
				this.mapped[139].resolveGeneratedOffsets("quantizer","bins","nb_rejected","nb_accepted","min","max","sum","sumsq");
			}
			mapped[140] = greycat.types_by_name.get(util.Queue.name);
			if(this.mapped[140] != null){
				this.mapped[140].resolveGeneratedOffsets("values","capacity");
			}
			mapped[141] = greycat.types_by_name.get(util.QuantizerSlotBound.name);
			if(this.mapped[141] != null){
				this.mapped[141].resolveGeneratedOffsets("min","max","center");
			}
			mapped[142] = greycat.types_by_name.get(util.Quantizer.name);
			mapped[143] = greycat.types_by_name.get(util.CustomQuantizer.name);
			if(this.mapped[143] != null){
				this.mapped[143].resolveGeneratedOffsets("min","max","step_starts","open");
			}
			mapped[144] = greycat.types_by_name.get(util.GaussianProfileSlot.name);
			if(this.mapped[144] != null){
				this.mapped[144].resolveGeneratedOffsets("sum","sumsq","count");
			}
			mapped[145] = greycat.types_by_name.get(util.Crypto.name);
			mapped[146] = greycat.types_by_name.get(util.HistogramBin.name);
			if(this.mapped[146] != null){
				this.mapped[146].resolveGeneratedOffsets("bin","count","ratio","cumulative_count","cumulative_ratio");
			}
			mapped[147] = greycat.types_by_name.get(util.GaussianProfile.name);
			if(this.mapped[147] != null){
				this.mapped[147].resolveGeneratedOffsets("quantizer","precision","bins","value_min","nb_rejected");
			}
			mapped[148] = greycat.types_by_name.get(util.Plot.name);
			mapped[149] = greycat.types_by_name.get(util.LogQuantizer.name);
			if(this.mapped[149] != null){
				this.mapped[149].resolveGeneratedOffsets("min","max","bins","open");
			}
			mapped[150] = greycat.types_by_name.get(util.TimeWindow.name);
			if(this.mapped[150] != null){
				this.mapped[150].resolveGeneratedOffsets("values","span","sum","sumsq","field");
			}
			mapped[151] = greycat.types_by_name.get(util.MultiQuantizer.name);
			if(this.mapped[151] != null){
				this.mapped[151].resolveGeneratedOffsets("quantizers");
			}
			mapped[152] = greycat.types_by_name.get(util.Assert.name);
			mapped[153] = greycat.types_by_name.get(util.HistogramStats.name);
			if(this.mapped[153] != null){
				this.mapped[153].resolveGeneratedOffsets("min","max","whisker_low","whisker_high","percentile1","percentile5","percentile10","percentile20","percentile25","percentile50","percentile75","percentile80","percentile90","percentile95","percentile99","sum","avg","std","size");
			}
		}
	}
}
