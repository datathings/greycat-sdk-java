...
public final class gc {
	public static final class core {
		...
		public static final class CalendarUnit extends GreyCat.Enum {
			...
			public CalendarUnit() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[1], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[1].map_attributes(new Object[] {}));
			}
			...
			public static CalendarUnit get(java.lang.String key, GreyCat greycat) {
				return (CalendarUnit) greycat.libs_by_name.get(std.name).mapped[1].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class TableColumnMapping extends GreyCat.Object {
			...
			public TableColumnMapping(java.lang.Long column, core.Array<java.lang.Object> extractors) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[2], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[2].map_attributes(new Object[] {column, extractors}));
			}
		...
		public static final class nodeIndexBucket<K,V> extends GreyCat.Object {
			...
			public nodeIndexBucket(K key, V value, core.nodeIndexBucket<K, V> next) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[5], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[5].map_attributes(new Object[] {key, value, next}));
			}
			public K key() {
		...
		public static final class TensorType extends GreyCat.Enum {
			...
			public TensorType() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[7], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[7].map_attributes(new Object[] {}));
			}
			...
			public static TensorType get(java.lang.String key, GreyCat greycat) {
				return (TensorType) greycat.libs_by_name.get(std.name).mapped[7].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class SortOrder extends GreyCat.Enum {
			...
			public static SortOrder get(java.lang.String key, GreyCat greycat) {
				return (SortOrder) greycat.libs_by_name.get(std.name).mapped[13].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class TimeZone extends GreyCat.Enum {
			...
			public static TimeZone get(java.lang.String key, GreyCat greycat) {
				return (TimeZone) greycat.libs_by_name.get(std.name).mapped[14].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class SamplingMode extends GreyCat.Enum {
			...
			public static SamplingMode get(java.lang.String key, GreyCat greycat) {
				return (SamplingMode) greycat.libs_by_name.get(std.name).mapped[16].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class GeoBox extends GreyCat.Object {
			...
			public GeoBox(greycat.gc.core.geo sw, greycat.gc.core.geo ne) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[19], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[19].map_attributes(new Object[] {sw, ne}));
			}
		...
		public static final class DurationUnit extends GreyCat.Enum {
			...
			public static DurationUnit get(java.lang.String key, GreyCat greycat) {
				return (DurationUnit) greycat.libs_by_name.get(std.name).mapped[24].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class Date extends GreyCat.Object {
			...
			public Date(java.lang.Long year, java.lang.Long month, java.lang.Long day, java.lang.Long hour, java.lang.Long minute, java.lang.Long second, java.lang.Long microsecond) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[31], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[31].map_attributes(new Object[] {year, month, day, hour, minute, second, microsecond}));
			}
		...
		public static final class Tuple<T,U> extends GreyCat.Object {
			...
			public Tuple(T x, U y) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[33], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[33].map_attributes(new Object[] {x, y}));
			}
			public T x() {
		...
		public static final class GeoCircle extends GreyCat.Object {
			...
			public GeoCircle(greycat.gc.core.geo center, java.lang.Double radius) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[35], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[35].map_attributes(new Object[] {center, radius}));
			}
		...
		public static final class GeoPoly extends GreyCat.Object {
			...
			public GeoPoly(core.Array<greycat.gc.core.geo> points) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[37], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[37].map_attributes(new Object[] {points}));
			}
		...
		public static final class nodeTimeCursor<T> extends GreyCat.Object {
			...
			public nodeTimeCursor(greycat.gc.core.nodeTime<T> n, greycat.gc.core.time req_time) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[38], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[38].map_attributes(new Object[] {n, req_time}));
			}
		...
		public static final class Error extends GreyCat.Object {
			...
			public Error(java.lang.String message, core.Array<core.ErrorFrame> stack) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[41], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[41].map_attributes(new Object[] {message, stack}));
			}
	...
	public static final class io {
		public static final class HttpMethod extends GreyCat.Enum {
			...
			public static HttpMethod get(java.lang.String key, GreyCat greycat) {
				return (HttpMethod) greycat.libs_by_name.get(std.name).mapped[44].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class CsvSharding extends GreyCat.Object {
			...
			public CsvSharding(java.lang.Long id, java.lang.Long column, java.lang.Long modulo) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[46], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[46].map_attributes(new Object[] {id, column, modulo}));
			}
		...
		public static final class CsvStatistics extends GreyCat.Object {
			...
			public CsvStatistics(java.lang.Long header_lines, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, core.Array<io.CsvColumnStatistics> columns, java.lang.Long line_count, java.lang.Long fail_count, java.lang.Long file_count) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[47], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[47].map_attributes(new Object[] {header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns, line_count, fail_count, file_count}));
			}
		...
		public static final class CsvFormat extends GreyCat.Object {
			...
			public CsvFormat(java.lang.Long header_lines, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, java.lang.Boolean trim, java.lang.String format, core.TimeZone tz, java.lang.Boolean strict, java.lang.Boolean nearest_time) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[48], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[48].map_attributes(new Object[] {header_lines, separator, string_delimiter, decimal_separator, thousands_separator, trim, format, tz, strict, nearest_time}));
			}
			public java.lang.Long header_lines() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class HttpResponse<T> extends GreyCat.Object {
			...
			public HttpResponse(java.lang.Long status_code, core.Map<java.lang.String, java.lang.String> headers, T content, java.lang.String error_msg) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[49], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[49].map_attributes(new Object[] {status_code, headers, content, error_msg}));
			}
		...
		public static final class SmtpAuth extends GreyCat.Enum {
			...
			public SmtpAuth() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[50], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[50].map_attributes(new Object[] {}));
			}
			...
			public static SmtpAuth get(java.lang.String key, GreyCat greycat) {
				return (SmtpAuth) greycat.libs_by_name.get(std.name).mapped[50].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class Reader<T> extends GreyCat.Object {
			...
			public Reader(java.lang.String path, java.lang.Long pos) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[56], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[56].map_attributes(new Object[] {path, pos}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Email extends GreyCat.Object {
			...
			public Email(java.lang.String from, java.lang.String subject, java.lang.String body, java.lang.Boolean body_is_html, core.Array<java.lang.String> to, core.Array<java.lang.String> cc, core.Array<java.lang.String> bcc) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[57], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[57].map_attributes(new Object[] {from, subject, body, body_is_html, to, cc, bcc}));
			}
		...
		public static final class Url extends GreyCat.Object {
			...
			public Url(java.lang.String protocol, java.lang.String host, java.lang.Long port, java.lang.String path, core.Map<java.lang.String, java.lang.String> params, java.lang.String hash) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[58], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[58].map_attributes(new Object[] {protocol, host, port, path, params, hash}));
			}
		...
		public static final class CsvReader<T> extends GreyCat.Object {
			...
			public CsvReader(java.lang.String path, java.lang.Long pos, io.CsvFormat format, io.CsvSharding sharding) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[60], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[60].map_attributes(new Object[] {path, pos, format, sharding}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class CsvWriter<T> extends GreyCat.Object {
			...
			public CsvWriter(java.lang.String path, java.lang.Boolean append, io.CsvFormat format) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[62], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[62].map_attributes(new Object[] {path, append, format}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class GcbWriter<T> extends GreyCat.Object {
			...
			public GcbWriter(java.lang.String path, java.lang.Boolean append) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[65], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[65].map_attributes(new Object[] {path, append}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class CsvAnalysisConfig extends GreyCat.Object {
			...
			public CsvAnalysisConfig(java.lang.Long header_lines, java.lang.Character separator, java.lang.Character string_delimiter, java.lang.Character decimal_separator, java.lang.Character thousands_separator, java.lang.Long row_limit, java.lang.Long enumerable_limit, java.lang.Long date_check_limit, core.Array<java.lang.String> date_formats) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[67], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[67].map_attributes(new Object[] {header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats}));
			}
			public java.lang.Long header_lines() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Smtp extends GreyCat.Object {
			...
			public Smtp(java.lang.String host, java.lang.Long port, io.SmtpMode mode, io.SmtpAuth authenticate, java.lang.String user, java.lang.String pass) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[68], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[68].map_attributes(new Object[] {host, port, mode, authenticate, user, pass}));
			}
			public java.lang.String host() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class GcbReader<T> extends GreyCat.Object {
			...
			public GcbReader(java.lang.String path, java.lang.Long pos) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[69], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[69].map_attributes(new Object[] {path, pos}));
			}
			public java.lang.String path() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class SmtpMode extends GreyCat.Enum {
			...
			public static SmtpMode get(java.lang.String key, GreyCat greycat) {
				return (SmtpMode) greycat.libs_by_name.get(std.name).mapped[72].enum_values[indicesByValues.get(key)];
			}
		}
	}
	public static final class runtime {
		public static final class Frame extends GreyCat.Object {
			...
			public Frame(java.lang.String module, java.lang.String type, java.lang.String function, java.lang.String src, java.lang.Long line, java.lang.Long column, core.Array<runtime.Variable> scope) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[73], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[73].map_attributes(new Object[] {module, type, function, src, line, column, scope}));
			}
			public java.lang.String module() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Permission extends GreyCat.Object {
			...
			public Permission(java.lang.String name, java.lang.String description) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[75], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[75].map_attributes(new Object[] {name, description}));
			}
			public java.lang.String name() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class UserCredential extends GreyCat.Object {
			...
			public UserCredential(java.lang.Long offset, java.lang.String pass) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[76], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[76].map_attributes(new Object[] {offset, pass}));
			}
		...
		public static final class User extends GreyCat.Object {
			...
			public User(java.lang.Long id, java.lang.String name, java.lang.Boolean activated, java.lang.String full_name, java.lang.String email, java.lang.String role, core.Array<runtime.UserGroupPolicy> groups, java.lang.Long groups_flags, java.lang.Boolean external) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[77], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[77].map_attributes(new Object[] {id, name, activated, full_name, email, role, groups, groups_flags, external}));
			}
			public java.lang.Long id() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class LogDataUsage extends GreyCat.Object {
			...
			public LogDataUsage(java.lang.Long read_bytes, java.lang.Long read_hits, java.lang.Long read_wasted, java.lang.Long write_bytes, java.lang.Long write_hits, java.lang.Long cache_bytes, java.lang.Long cache_hits) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[78], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[78].map_attributes(new Object[] {read_bytes, read_hits, read_wasted, write_bytes, write_hits, cache_bytes, cache_hits}));
			}
		...
		public static final class MonthlyPeriodicity extends GreyCat.Object {
			...
			public MonthlyPeriodicity(core.Array<java.lang.Long> days, runtime.DailyPeriodicity daily) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[79], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[79].map_attributes(new Object[] {days, daily}));
			}
		...
		public static final class YearlyPeriodicity extends GreyCat.Object {
			...
			public YearlyPeriodicity(core.Array<runtime.DateTuple> dates, core.TimeZone timezone) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[81], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[81].map_attributes(new Object[] {dates, timezone}));
			}
		...
		public static final class RuntimeInfo extends GreyCat.Object {
			...
			public RuntimeInfo(java.lang.String version, java.lang.String program_version, java.lang.String arch, core.TimeZone timezone, runtime.License license, java.lang.Long io_threads, java.lang.Long bg_threads, java.lang.Long fg_threads, java.lang.Long mem_total, java.lang.Long mem_worker, java.lang.Long disk_data_bytes) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[82], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[82].map_attributes(new Object[] {version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, disk_data_bytes}));
			}
		...
		public static final class Task extends GreyCat.Object {
			...
			public Task(java.lang.Long user_id, java.lang.Long task_id, java.lang.String mod, java.lang.String type, java.lang.String fun, greycat.gc.core.time creation, greycat.gc.core.time start, greycat.gc.core.duration duration, runtime.TaskStatus status, java.lang.Double progress) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[84], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[84].map_attributes(new Object[] {user_id, task_id, mod, type, fun, creation, start, duration, status, progress}));
			}
		...
		public static final class DateTuple extends GreyCat.Object {
			...
			public DateTuple(java.lang.Long day, runtime.Month month) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[85], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[85].map_attributes(new Object[] {day, month}));
			}
			public java.lang.Long day() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class FixedPeriodicity extends GreyCat.Object {
			...
			public FixedPeriodicity(greycat.gc.core.duration every) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[87], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[87].map_attributes(new Object[] {every}));
			}
		...
		public static final class Variable extends GreyCat.Object {
			...
			public Variable(java.lang.String name, java.lang.Object value) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[88], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[88].map_attributes(new Object[] {name, value}));
			}
			public java.lang.String name() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class UserGroup extends GreyCat.Object {
			...
			public UserGroup(java.lang.Long id, java.lang.String name, java.lang.Boolean activated) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[89], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[89].map_attributes(new Object[] {id, name, activated}));
			}
			public java.lang.Long id() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class License extends GreyCat.Object {
			...
			public License(java.lang.String name, greycat.gc.core.time start, greycat.gc.core.time end, java.lang.String company, java.lang.Long max_memory, java.lang.Long extra_1, java.lang.Long extra_2, runtime.LicenseType type) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[90], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[90].map_attributes(new Object[] {name, start, end, company, max_memory, extra_1, extra_2, type}));
			}
			public java.lang.String name() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class PeriodicOptions extends GreyCat.Object {
			...
			public PeriodicOptions(java.lang.Boolean activated, greycat.gc.core.time start, greycat.gc.core.duration max_duration) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[91], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[91].map_attributes(new Object[] {activated, start, max_duration}));
			}
			public java.lang.Boolean activated() {
		...
		public static final class Month extends GreyCat.Enum {
			...
			public static Month get(java.lang.String key, GreyCat greycat) {
				return (Month) greycat.libs_by_name.get(std.name).mapped[92].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class Runtime extends GreyCat.Object {
			...
			public static java.lang.Object openapi() throws java.io.IOException {
				return openapi(GreyCat.DEFAULT);
			}

			public static java.lang.Object openapi(GreyCat greycat) throws java.io.IOException {
				return greycat.call("runtime::Runtime::openapi");
			}
		...
		public static final class PeriodicTask extends GreyCat.Object {
			...
			public PeriodicTask(core.function function, runtime.Periodicity periodicity, runtime.PeriodicOptions options, java.lang.Boolean is_active, greycat.gc.core.time next_execution, java.lang.Long execution_count) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[96], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[96].map_attributes(new Object[] {function, periodicity, options, is_active, next_execution, execution_count}));
			}
		...
		public static final class OpenIDConnect extends GreyCat.Object {
			...
			public OpenIDConnect(java.lang.String url, java.lang.String clientId) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[97], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[97].map_attributes(new Object[] {url, clientId}));
			}
			public java.lang.String url() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class LogLevel extends GreyCat.Enum {
			...
			public static LogLevel get(java.lang.String key, GreyCat greycat) {
				return (LogLevel) greycat.libs_by_name.get(std.name).mapped[98].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class Log extends GreyCat.Object {
			...
			public Log(runtime.LogLevel level, greycat.gc.core.time time, java.lang.Long user_id, java.lang.Long id, java.lang.Long id2, core.function src, java.lang.Object data) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[99], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[99].map_attributes(new Object[] {level, time, user_id, id, id2, src, data}));
			}
		...
		public static final class DayOfWeek extends GreyCat.Enum {
			...
			public static DayOfWeek get(java.lang.String key, GreyCat greycat) {
				return (DayOfWeek) greycat.libs_by_name.get(std.name).mapped[100].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class MergeStrategy extends GreyCat.Enum {
			...
			public static MergeStrategy get(java.lang.String key, GreyCat greycat) {
				return (MergeStrategy) greycat.libs_by_name.get(std.name).mapped[101].enum_values[indicesByValues.get(key)];
			}
		}
		public static final class Debug extends GreyCat.Object {
			...
			public Debug(java.lang.Long id, core.Array<runtime.Frame> frames, java.lang.Object root) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[102], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[102].map_attributes(new Object[] {id, frames, root}));
			}
			public java.lang.Long id() {
				return (java.lang.Long) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class SecurityFields extends GreyCat.Object {
			...
			public SecurityFields(java.lang.String email, java.lang.String name, java.lang.String first_name, java.lang.String last_name, core.Map<java.lang.String, java.lang.String> roles, core.Map<java.lang.String, java.lang.String> groups) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[104], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[104].map_attributes(new Object[] {email, name, first_name, last_name, roles, groups}));
			}
			public java.lang.String email() {
				return (java.lang.String) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class SecurityPolicy extends GreyCat.Object {
			...
			public SecurityPolicy(core.Array<runtime.SecurityEntity> entities, core.Map<java.lang.String, runtime.UserCredential> credentials, runtime.SecurityFields fields, core.Map<java.lang.String, java.lang.String> keys, greycat.gc.core.time keys_last_refresh) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[105], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[105].map_attributes(new Object[] {entities, credentials, fields, keys, keys_last_refresh}));
			}
		...
		public static final class TaskStatus extends GreyCat.Enum {
			...
			public static TaskStatus get(java.lang.String key, GreyCat greycat) {
				return (TaskStatus) greycat.libs_by_name.get(std.name).mapped[106].enum_values[indicesByValues.get(key)];
			}
		}
		...
		public static final class Job<T> extends GreyCat.Object {
			...
			public Job(core.function function, core.Array arguments) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[108], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[108].map_attributes(new Object[] {function, arguments}));
			}
			public core.function function() {
				return (core.function) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class LicenseType extends GreyCat.Enum {
			...
			public static LicenseType get(java.lang.String key, GreyCat greycat) {
				return (LicenseType) greycat.libs_by_name.get(std.name).mapped[109].enum_values[indicesByValues.get(key)];
			}
		}
	...
	public static final class util {
		public static final class GaussianProfile<T> extends GreyCat.Object {
			...
			public GaussianProfile(util.Quantizer<T> quantizer, core.FloatPrecision precision, core.Table<util.GaussianProfileSlot> bins, java.lang.Double value_min, java.lang.Long nb_rejected) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[111], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[111].map_attributes(new Object[] {quantizer, precision, bins, value_min, nb_rejected}));
			}
		...
		public static final class MultiQuantizer<T> extends GreyCat.Object {
			...
			public MultiQuantizer(core.Array<util.Quantizer<T>> quantizers) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[112], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[112].map_attributes(new Object[] {quantizers}));
			}
		...
		public static final class SlidingWindow<T> extends GreyCat.Object {
			...
			public SlidingWindow(core.Array<T> values, java.lang.Long span, java.lang.Double sum, java.lang.Double sumsq, core.field field) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[114], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[114].map_attributes(new Object[] {values, span, sum, sumsq, field}));
			}
		...
		public static final class HistogramBin<T> extends GreyCat.Object {
			...
			public HistogramBin(util.QuantizerSlotBound<T> bin, java.lang.Long count, java.lang.Double ratio, java.lang.Long cumulative_count, java.lang.Double cumulative_ratio) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[115], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[115].map_attributes(new Object[] {bin, count, ratio, cumulative_count, cumulative_ratio}));
			}
		...
		public static final class GaussianProfileSlot extends GreyCat.Object {
			...
			public GaussianProfileSlot(java.lang.Long sum, java.lang.Long sumsq, java.lang.Long count) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[116], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[116].map_attributes(new Object[] {sum, sumsq, count}));
			}
		...
		public static final class TimeWindow<T> extends GreyCat.Object {
			...
			public TimeWindow(core.Table<core.Tuple<greycat.gc.core.time, T>> values, greycat.gc.core.duration span, java.lang.Double sum, java.lang.Double sumsq, core.field field) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[117], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[117].map_attributes(new Object[] {values, span, sum, sumsq, field}));
			}
		...
		public static final class Quantizer<T> extends GreyCat.Object {
			...
			public Quantizer() {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[118], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[118].map_attributes(new Object[] {}));
			}
		}
		public static final class Histogram<T> extends GreyCat.Object {
			...
			public Histogram(util.Quantizer<T> quantizer, core.Array<java.lang.Long> bins, java.lang.Long nb_rejected, java.lang.Long nb_accepted, T min, T max, java.lang.Double sum, java.lang.Double sumsq) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[119], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[119].map_attributes(new Object[] {quantizer, bins, nb_rejected, nb_accepted, min, max, sum, sumsq}));
			}
			public util.Quantizer<T> quantizer() {
				return (util.Quantizer<T>) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Gaussian<T> extends GreyCat.Object {
			...
			public Gaussian(java.lang.Double sum, java.lang.Double sumsq, java.lang.Long count, T min, T max) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[120], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[120].map_attributes(new Object[] {sum, sumsq, count, min, max}));
			}
			public java.lang.Double sum() {
		...
		public static final class CustomQuantizer<T> extends GreyCat.Object {
			...
			public CustomQuantizer(T min, T max, core.Array<T> step_starts, java.lang.Boolean open) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[123], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[123].map_attributes(new Object[] {min, max, step_starts, open}));
			}
			public T min() {
				return (T) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Random extends GreyCat.Object {
			...
			public Random(java.lang.Long seed, java.lang.Double v) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[124], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[124].map_attributes(new Object[] {seed, v}));
			}
		...
		public static final class LogQuantizer<T> extends GreyCat.Object {
			...
			public LogQuantizer(T min, T max, java.lang.Long bins, java.lang.Boolean open) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[125], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[125].map_attributes(new Object[] {min, max, bins, open}));
			}
			public T min() {
				return (T) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class ProgressTracker extends GreyCat.Object {
			...
			public ProgressTracker(greycat.gc.core.time start, java.lang.Long total, java.lang.Long counter, greycat.gc.core.duration duration, java.lang.Double progress, java.lang.Double speed, greycat.gc.core.duration remaining) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[126], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[126].map_attributes(new Object[] {start, total, counter, duration, progress, speed, remaining}));
			}
			public greycat.gc.core.time start() {
		...
		public static final class LinearQuantizer<T> extends GreyCat.Object {
			...
			public LinearQuantizer(T min, T max, java.lang.Long bins, java.lang.Boolean open) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[127], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[127].map_attributes(new Object[] {min, max, bins, open}));
			}
			public T min() {
				return (T) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Queue<T> extends GreyCat.Object {
			...
			public Queue(core.Array<T> values, java.lang.Long capacity) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[128], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[128].map_attributes(new Object[] {values, capacity}));
			}
			public core.Array<T> values() {
				return (core.Array<T>) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class QuantizerSlotBound<T> extends GreyCat.Object {
			...
			public QuantizerSlotBound(T min, T max, T center) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[130], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[130].map_attributes(new Object[] {min, max, center}));
			}
			public T min() {
				return (T) getAttribute(type.generated_offsets[0]);
			}
		...
		public static final class Stack<T> extends GreyCat.Object {
			...
			public Stack(core.Array<T> values) {
				super(GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[131], GreyCat.DEFAULT.libs_by_name.get(gc.std.name).mapped[131].map_attributes(new Object[] {values}));
			}
			public core.Array<T> values() {
				return (core.Array<T>) getAttribute(type.generated_offsets[0]);
			}
	...
	public static final class std extends GreyCat.Library {
		...
		public void init(GreyCat greycat) {
			mapped = new GreyCat.Type[132];
			mapped[0] = greycat.types_by_name.get(core.t2.name);
			mapped[1] = greycat.types_by_name.get(core.CalendarUnit.name);
			if(this.mapped[1] != null){
				this.mapped[1].resolveGeneratedOffsetWithValues("year", 0L,"month", 1L,"day", 2L,"hour", 3L,"minute", 4L,"second", 5L,"microsecond", 6L);
			}
			mapped[2] = greycat.types_by_name.get(core.TableColumnMapping.name);
			if(this.mapped[2] != null){
				this.mapped[2].resolveGeneratedOffsets("column","extractors");
			}
			mapped[3] = greycat.types_by_name.get(core.t2f.name);
			mapped[4] = greycat.types_by_name.get(core.nodeTime.name);
			mapped[5] = greycat.types_by_name.get(core.nodeIndexBucket.name);
			if(this.mapped[5] != null){
				this.mapped[5].resolveGeneratedOffsets("key","value","next");
			}
			mapped[6] = greycat.types_by_name.get(core.String.name);
			mapped[7] = greycat.types_by_name.get(core.TensorType.name);
			if(this.mapped[7] != null){
				this.mapped[7].resolveGeneratedOffsetWithValues("i32", 4L,"i64", 8L,"f32", 4L,"f64", 8L,"c64", 8L,"c128", 16L);
			}
			mapped[8] = greycat.types_by_name.get(core.t4.name);
			...
			mapped[19] = greycat.types_by_name.get(core.GeoBox.name);
			if(this.mapped[19] != null){
				this.mapped[19].resolveGeneratedOffsets("sw","ne");
			}
			...
			if(this.mapped[24] != null){
				this.mapped[24].resolveGeneratedOffsetWithValues("microseconds", 1L,"milliseconds", 1000L,"seconds", 1000000L,"minutes", 60000000L,"hours", 3600000000L,"days", 86400000000L);
			}
			...
			mapped[29] = greycat.types_by_name.get(core.duration.name);
			mapped[30] = greycat.types_by_name.get(core.Map.name);
			mapped[31] = greycat.types_by_name.get(core.Date.name);
			if(this.mapped[31] != null){
				this.mapped[31].resolveGeneratedOffsets("year","month","day","hour","minute","second","microsecond");
			}
			mapped[32] = greycat.types_by_name.get(core.Array.name);
			mapped[33] = greycat.types_by_name.get(core.Tuple.name);
			if(this.mapped[33] != null){
				this.mapped[33].resolveGeneratedOffsets("x","y");
			}
			mapped[34] = greycat.types_by_name.get(core.t3f.name);
			mapped[35] = greycat.types_by_name.get(core.GeoCircle.name);
			if(this.mapped[35] != null){
				this.mapped[35].resolveGeneratedOffsets("center","radius");
			}
			mapped[36] = greycat.types_by_name.get(core.str.name);
			mapped[37] = greycat.types_by_name.get(core.GeoPoly.name);
			if(this.mapped[37] != null){
				this.mapped[37].resolveGeneratedOffsets("points");
			}
			mapped[38] = greycat.types_by_name.get(core.nodeTimeCursor.name);
			if(this.mapped[38] != null){
				this.mapped[38].resolveGeneratedOffsets("n","req_time");
			}
			mapped[39] = greycat.types_by_name.get(core.t3.name);
			mapped[40] = greycat.types_by_name.get(core.nodeGeo.name);
			mapped[41] = greycat.types_by_name.get(core.Error.name);
			if(this.mapped[41] != null){
				this.mapped[41].resolveGeneratedOffsets("message","stack");
			}
			...
			mapped[44] = greycat.types_by_name.get(io.HttpMethod.name);
			if(this.mapped[44] != null){
				this.mapped[44].resolveGeneratedOffsetWithValues("GET", null,"HEAD", null,"POST", null,"PUT", null,"DELETE", null,"CONNECT", null,"OPTIONS", null,"TRACE", null,"PATCH", null);
			}
			mapped[45] = greycat.types_by_name.get(io.Csv.name);
			...
			mapped[47] = greycat.types_by_name.get(io.CsvStatistics.name);
			if(this.mapped[47] != null){
				this.mapped[47].resolveGeneratedOffsets("header_lines","separator","string_delimiter","decimal_separator","thousands_separator","columns","line_count","fail_count","file_count");
			}
			mapped[48] = greycat.types_by_name.get(io.CsvFormat.name);
			if(this.mapped[48] != null){
				this.mapped[48].resolveGeneratedOffsets("header_lines","separator","string_delimiter","decimal_separator","thousands_separator","trim","format","tz","strict","nearest_time");
			}
			mapped[49] = greycat.types_by_name.get(io.HttpResponse.name);
			if(this.mapped[49] != null){
				this.mapped[49].resolveGeneratedOffsets("status_code","headers","content","error_msg");
			}
			mapped[50] = greycat.types_by_name.get(io.SmtpAuth.name);
			if(this.mapped[50] != null){
				this.mapped[50].resolveGeneratedOffsetWithValues("none", 0L,"plain", 1L,"login", 2L);
			}
			...
			mapped[53] = greycat.types_by_name.get(io.Http.name);
			...
			mapped[56] = greycat.types_by_name.get(io.Reader.name);
			if(this.mapped[56] != null){
				this.mapped[56].resolveGeneratedOffsets("path","pos");
			}
			mapped[57] = greycat.types_by_name.get(io.Email.name);
			if(this.mapped[57] != null){
				this.mapped[57].resolveGeneratedOffsets("from","subject","body","body_is_html","to","cc","bcc");
			}
			mapped[58] = greycat.types_by_name.get(io.Url.name);
			if(this.mapped[58] != null){
				this.mapped[58].resolveGeneratedOffsets("protocol","host","port","path","params","hash");
			}
			mapped[59] = greycat.types_by_name.get(io.XmlReader.name);
			if(this.mapped[59] != null){
				this.mapped[59].resolveGeneratedOffsets("path","pos");
			}
			mapped[60] = greycat.types_by_name.get(io.CsvReader.name);
			if(this.mapped[60] != null){
				this.mapped[60].resolveGeneratedOffsets("path","pos","format","sharding");
			}
			...
			mapped[62] = greycat.types_by_name.get(io.CsvWriter.name);
			if(this.mapped[62] != null){
				this.mapped[62].resolveGeneratedOffsets("path","append","format");
			}
			mapped[63] = greycat.types_by_name.get(io.TextReader.name);
			if(this.mapped[63] != null){
				this.mapped[63].resolveGeneratedOffsets("path","pos");
			}
			mapped[64] = greycat.types_by_name.get(io.JsonWriter.name);
			if(this.mapped[64] != null){
				this.mapped[64].resolveGeneratedOffsets("path","append");
			}
			mapped[65] = greycat.types_by_name.get(io.GcbWriter.name);
			if(this.mapped[65] != null){
				this.mapped[65].resolveGeneratedOffsets("path","append");
			}
			mapped[66] = greycat.types_by_name.get(io.Writer.name);
			...
			mapped[69] = greycat.types_by_name.get(io.GcbReader.name);
			if(this.mapped[69] != null){
				this.mapped[69].resolveGeneratedOffsets("path","pos");
			}
			...
			mapped[71] = greycat.types_by_name.get(io.TextWriter.name);
			if(this.mapped[71] != null){
				this.mapped[71].resolveGeneratedOffsets("path","append");
			}
			mapped[72] = greycat.types_by_name.get(io.SmtpMode.name);
			if(this.mapped[72] != null){
				this.mapped[72].resolveGeneratedOffsetWithValues("plain", 0L,"ssl_tls", 1L,"starttls", 2L);
			}
			mapped[73] = greycat.types_by_name.get(runtime.Frame.name);
			if(this.mapped[73] != null){
				this.mapped[73].resolveGeneratedOffsets("module","type","function","src","line","column","scope");
			}
			mapped[74] = greycat.types_by_name.get(runtime.System.name);
			mapped[75] = greycat.types_by_name.get(runtime.Permission.name);
			if(this.mapped[75] != null){
				this.mapped[75].resolveGeneratedOffsets("name","description");
			}
			mapped[76] = greycat.types_by_name.get(runtime.UserCredential.name);
			if(this.mapped[76] != null){
				this.mapped[76].resolveGeneratedOffsets("offset","pass");
			}
			mapped[77] = greycat.types_by_name.get(runtime.User.name);
			if(this.mapped[77] != null){
				this.mapped[77].resolveGeneratedOffsets("id","name","activated","full_name","email","role","groups","groups_flags","external");
			}
			mapped[78] = greycat.types_by_name.get(runtime.LogDataUsage.name);
			if(this.mapped[78] != null){
				this.mapped[78].resolveGeneratedOffsets("read_bytes","read_hits","read_wasted","write_bytes","write_hits","cache_bytes","cache_hits");
			}
			mapped[79] = greycat.types_by_name.get(runtime.MonthlyPeriodicity.name);
			if(this.mapped[79] != null){
				this.mapped[79].resolveGeneratedOffsets("days","daily");
			}
			mapped[80] = greycat.types_by_name.get(runtime.WeeklyPeriodicity.name);
			if(this.mapped[80] != null){
				this.mapped[80].resolveGeneratedOffsets("days","daily");
			}
			mapped[81] = greycat.types_by_name.get(runtime.YearlyPeriodicity.name);
			if(this.mapped[81] != null){
				this.mapped[81].resolveGeneratedOffsets("dates","timezone");
			}
			mapped[82] = greycat.types_by_name.get(runtime.RuntimeInfo.name);
			if(this.mapped[82] != null){
				this.mapped[82].resolveGeneratedOffsets("version","program_version","arch","timezone","license","io_threads","bg_threads","fg_threads","mem_total","mem_worker","disk_data_bytes");
			}
			mapped[83] = greycat.types_by_name.get(runtime.Scheduler.name);
			mapped[84] = greycat.types_by_name.get(runtime.Task.name);
			if(this.mapped[84] != null){
				this.mapped[84].resolveGeneratedOffsets("user_id","task_id","mod","type","fun","creation","start","duration","status","progress");
			}
			mapped[85] = greycat.types_by_name.get(runtime.DateTuple.name);
			if(this.mapped[85] != null){
				this.mapped[85].resolveGeneratedOffsets("day","month");
			}
			...
			mapped[87] = greycat.types_by_name.get(runtime.FixedPeriodicity.name);
			if(this.mapped[87] != null){
				this.mapped[87].resolveGeneratedOffsets("every");
			}
			mapped[88] = greycat.types_by_name.get(runtime.Variable.name);
			if(this.mapped[88] != null){
				this.mapped[88].resolveGeneratedOffsets("name","value");
			}
			mapped[89] = greycat.types_by_name.get(runtime.UserGroup.name);
			if(this.mapped[89] != null){
				this.mapped[89].resolveGeneratedOffsets("id","name","activated");
			}
			mapped[90] = greycat.types_by_name.get(runtime.License.name);
			if(this.mapped[90] != null){
				this.mapped[90].resolveGeneratedOffsets("name","start","end","company","max_memory","extra_1","extra_2","type");
			}
			mapped[91] = greycat.types_by_name.get(runtime.PeriodicOptions.name);
			if(this.mapped[91] != null){
				this.mapped[91].resolveGeneratedOffsets("activated","start","max_duration");
			}
			mapped[92] = greycat.types_by_name.get(runtime.Month.name);
			if(this.mapped[92] != null){
				this.mapped[92].resolveGeneratedOffsetWithValues("Jan", 0L,"Feb", 1L,"Mar", 2L,"Apr", 3L,"May", 4L,"Jun", 5L,"Jul", 6L,"Aug", 7L,"Sep", 8L,"Oct", 9L,"Nov", 10L,"Dec", 11L);
			}
			...
			mapped[94] = greycat.types_by_name.get(runtime.Runtime.name);
			...
			mapped[96] = greycat.types_by_name.get(runtime.PeriodicTask.name);
			if(this.mapped[96] != null){
				this.mapped[96].resolveGeneratedOffsets("function","periodicity","options","is_active","next_execution","execution_count");
			}
			mapped[97] = greycat.types_by_name.get(runtime.OpenIDConnect.name);
			if(this.mapped[97] != null){
				this.mapped[97].resolveGeneratedOffsets("url","clientId");
			}
			mapped[98] = greycat.types_by_name.get(runtime.LogLevel.name);
			if(this.mapped[98] != null){
				this.mapped[98].resolveGeneratedOffsetWithValues("error", null,"warn", null,"info", null,"perf", null,"trace", null);
			}
			mapped[99] = greycat.types_by_name.get(runtime.Log.name);
			if(this.mapped[99] != null){
				this.mapped[99].resolveGeneratedOffsets("level","time","user_id","id","id2","src","data");
			}
			mapped[100] = greycat.types_by_name.get(runtime.DayOfWeek.name);
			if(this.mapped[100] != null){
				this.mapped[100].resolveGeneratedOffsetWithValues("Mon", 0L,"Tue", 1L,"Wed", 2L,"Thu", 3L,"Fri", 4L,"Sat", 5L,"Sun", 6L);
			}
			mapped[101] = greycat.types_by_name.get(runtime.MergeStrategy.name);
			if(this.mapped[101] != null){
				this.mapped[101].resolveGeneratedOffsetWithValues("strict", null,"first_wins", null,"last_wins", null);
			}
			mapped[102] = greycat.types_by_name.get(runtime.Debug.name);
			if(this.mapped[102] != null){
				this.mapped[102].resolveGeneratedOffsets("id","frames","root");
			}
			mapped[103] = greycat.types_by_name.get(runtime.Periodicity.name);
			mapped[104] = greycat.types_by_name.get(runtime.SecurityFields.name);
			if(this.mapped[104] != null){
				this.mapped[104].resolveGeneratedOffsets("email","name","first_name","last_name","roles","groups");
			}
			mapped[105] = greycat.types_by_name.get(runtime.SecurityPolicy.name);
			if(this.mapped[105] != null){
				this.mapped[105].resolveGeneratedOffsets("entities","credentials","fields","keys","keys_last_refresh");
			}
			mapped[106] = greycat.types_by_name.get(runtime.TaskStatus.name);
			if(this.mapped[106] != null){
				this.mapped[106].resolveGeneratedOffsetWithValues("empty", null,"waiting", null,"running", null,"await", null,"cancelled", null,"error", null,"ended", null,"ended_with_errors", null);
			}
			...
			mapped[108] = greycat.types_by_name.get(runtime.Job.name);
			if(this.mapped[108] != null){
				this.mapped[108].resolveGeneratedOffsets("function","arguments");
			}
			mapped[109] = greycat.types_by_name.get(runtime.LicenseType.name);
			if(this.mapped[109] != null){
				this.mapped[109].resolveGeneratedOffsetWithValues("community", null,"enterprise", null,"testing", null);
			}
			...
			mapped[111] = greycat.types_by_name.get(util.GaussianProfile.name);
			if(this.mapped[111] != null){
				this.mapped[111].resolveGeneratedOffsets("quantizer","precision","bins","value_min","nb_rejected");
			}
			mapped[112] = greycat.types_by_name.get(util.MultiQuantizer.name);
			if(this.mapped[112] != null){
				this.mapped[112].resolveGeneratedOffsets("quantizers");
			}
			mapped[113] = greycat.types_by_name.get(util.Crypto.name);
			mapped[114] = greycat.types_by_name.get(util.SlidingWindow.name);
			if(this.mapped[114] != null){
				this.mapped[114].resolveGeneratedOffsets("values","span","sum","sumsq","field");
			}
			mapped[115] = greycat.types_by_name.get(util.HistogramBin.name);
			if(this.mapped[115] != null){
				this.mapped[115].resolveGeneratedOffsets("bin","count","ratio","cumulative_count","cumulative_ratio");
			}
			mapped[116] = greycat.types_by_name.get(util.GaussianProfileSlot.name);
			if(this.mapped[116] != null){
				this.mapped[116].resolveGeneratedOffsets("sum","sumsq","count");
			}
			mapped[117] = greycat.types_by_name.get(util.TimeWindow.name);
			if(this.mapped[117] != null){
				this.mapped[117].resolveGeneratedOffsets("values","span","sum","sumsq","field");
			}
			mapped[118] = greycat.types_by_name.get(util.Quantizer.name);
			mapped[119] = greycat.types_by_name.get(util.Histogram.name);
			if(this.mapped[119] != null){
				this.mapped[119].resolveGeneratedOffsets("quantizer","bins","nb_rejected","nb_accepted","min","max","sum","sumsq");
			}
			mapped[120] = greycat.types_by_name.get(util.Gaussian.name);
			if(this.mapped[120] != null){
				this.mapped[120].resolveGeneratedOffsets("sum","sumsq","count","min","max");
			}
			mapped[121] = greycat.types_by_name.get(util.HistogramStats.name);
			if(this.mapped[121] != null){
				this.mapped[121].resolveGeneratedOffsets("min","max","whisker_low","whisker_high","percentile1","percentile5","percentile10","percentile20","percentile25","percentile50","percentile75","percentile80","percentile90","percentile95","percentile99","sum","avg","std","size");
			}
			mapped[122] = greycat.types_by_name.get(util.Plot.name);
			mapped[123] = greycat.types_by_name.get(util.CustomQuantizer.name);
			if(this.mapped[123] != null){
				this.mapped[123].resolveGeneratedOffsets("min","max","step_starts","open");
			}
			mapped[124] = greycat.types_by_name.get(util.Random.name);
			if(this.mapped[124] != null){
				this.mapped[124].resolveGeneratedOffsets("seed","v");
			}
			mapped[125] = greycat.types_by_name.get(util.LogQuantizer.name);
			if(this.mapped[125] != null){
				this.mapped[125].resolveGeneratedOffsets("min","max","bins","open");
			}
			mapped[126] = greycat.types_by_name.get(util.ProgressTracker.name);
			if(this.mapped[126] != null){
				this.mapped[126].resolveGeneratedOffsets("start","total","counter","duration","progress","speed","remaining");
			}
			mapped[127] = greycat.types_by_name.get(util.LinearQuantizer.name);
			if(this.mapped[127] != null){
				this.mapped[127].resolveGeneratedOffsets("min","max","bins","open");
			}
			mapped[128] = greycat.types_by_name.get(util.Queue.name);
			if(this.mapped[128] != null){
				this.mapped[128].resolveGeneratedOffsets("values","capacity");
			}
			mapped[129] = greycat.types_by_name.get(util.Assert.name);
			mapped[130] = greycat.types_by_name.get(util.QuantizerSlotBound.name);
			if(this.mapped[130] != null){
				this.mapped[130].resolveGeneratedOffsets("min","max","center");
			}
			mapped[131] = greycat.types_by_name.get(util.Stack.name);
			if(this.mapped[131] != null){
				this.mapped[131].resolveGeneratedOffsets("values");
			}
		}
	}
}
